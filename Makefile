...
TEST_TARGETS := test-parser test-css-grammar-parser test-css-grammar-parser-snapshot test-ppx-native test-ppx-snapshot-reason test-css-support test-runtime test-murmur2 test-css-spec-parser test-string-interpolation
