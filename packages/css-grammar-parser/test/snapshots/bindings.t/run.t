  ...
  let rec _legacy_gradient:
    ...
    (
      Css_grammar_parser__Rule.data(Types._legacy_gradient),
      list(Styled_ppx_css_parser.Tokens.t),
    ) =
    tokens =>
      Combinator.xor(
  ...
  and _legacy_linear_gradient:
    list(Styled_ppx_css_parser.Tokens.t) =>
    (
      Css_grammar_parser__Rule.data(Types._legacy_linear_gradient),
      list(Styled_ppx_css_parser.Tokens.t),
    ) =
    tokens =>
      Combinator.xor(
  ...
  and property_height:
    list(Styled_ppx_css_parser.Tokens.t) =>
    (
      Css_grammar_parser__Rule.data(Types.property_height),
      list(Styled_ppx_css_parser.Tokens.t),
    ) =
    tokens =>
      Combinator.xor(
