...
let data_monad_tests: list(Alcotest.test_case(unit)) = [
  ...
  test_case("all with error in the beginning", `Quick, _ => {
    let rule4 = return(Ok(4));
    let rule5 = return(Ok(5));
    let rule_err = return(Error(["Missing COMMA"]));
    let rule = Match.all([rule_err, rule4, rule5]);
  ...
  test_case("all with error in the end", `Quick, _ => {
    let rule4 = return(Ok(4));
    let rule5 = return(Ok(5));
    let rule_err = return(Error(["Missing COMMA"]));
  ...
  test_case("all with multiple errors", `Quick, _ => {
    let rule4 = return(Ok(4));
    let rule5 = return(Ok(5));
    let rule_err = return(Error(["Missing COMMA"]));
  ...
  test_case("bind_shortest", `Quick, _ => {
    let comma =
      fun
  ...
  test_case("bind_longest", `Quick, _ => {
    let comma =
      fun
...
let rule_tests: list(Alcotest.test_case(unit)) = [
  test_case("Rule using Pattern.expect", `Quick, _ => {
  ...
  test_case("Rule using Pattern.next", `Quick, _ => {
    let right_input = [
      CDO,
      IDENT("its"),
      IDENT("a"),
...
let tests = List.concat([data_monad_tests, rule_tests, pattern_helpers_test, rule_tests]);
