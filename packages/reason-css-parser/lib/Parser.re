...
and function_minmax = [%value.rec "minmax( [ <length> | <percentage> | 'min-content' | 'max-content' | 'auto' ] ',' [ <length> | <percentage> | <'flex'> | 'min-content' | 'max-content' | 'auto' ] )"]
...
and property_orientation = [%value.rec "'portrait' | 'landscape'"]
...
and property_overflow_inline = [%value.rec "'visible' | 'hidden' | 'clip' | 'scroll' | 'auto'"]
...
and track_breadth = [%value.rec "<length-percentage> | <'flex'> | 'min-content' | 'max-content' | 'auto'"]
