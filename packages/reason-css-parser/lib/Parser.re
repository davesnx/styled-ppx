...
and function_perspective = [%value.rec "perspective( <extended-length> )"]
...
and property_height = [%value.rec "'auto' | <extended-length> | <extended-percentage> | 'min-content' | 'max-content' | fit-content( <extended-length> | <extended-percentage> )"]
...
and property_max_height = [%value.rec "'auto' | <extended-length> | <extended-percentage> | 'min-content' | 'max-content' | fit-content( <extended-length> | <extended-percentage> )"]
and property_max_inline_size = [%value.rec "<'max-width'>"]
and property_max_lines = [%value.rec "'none' | <integer>"]
and property_max_width = [%value.rec "<extended-length> | <extended-percentage> | 'none' | 'max-content' | 'min-content' | fit-content( <extended-length> | <extended-percentage> ) | 'fill-available' | <-non-standard-width>"]
and property_min_block_size = [%value.rec "<'min-width'>"]
and property_min_height = [%value.rec "'auto' | <extended-length> | <extended-percentage> | 'min-content' | 'max-content' | fit-content( <extended-length> | <extended-percentage> )"]
and property_min_inline_size = [%value.rec "<'min-width'>"]
and property_min_width = [%value.rec "<extended-length> | <extended-percentage> | 'auto' | 'max-content' | 'min-content' | fit-content( <extended-length> | <extended-percentage> ) | 'fill-available' | <-non-standard-width>"]
...
and property_width = [%value.rec "'auto' | <extended-length> | <extended-percentage> | 'min-content' | 'max-content' | fit-content( <extended-length> | <extended-percentage> )"]
...
and extended_length = [%value.rec "<length> | <calc()>"]
and extended_frequency = [%value.rec "<frequency> | <calc()>"]
and extended_angle = [%value.rec "<angle> | <calc()>"]
and extended_time = [%value.rec "<time> | <calc()>"]
and extended_percentage = [%value.rec "<percentage> | <calc()>"]
...
and track_minmax = [%value.rec "minmax( <track-breadth> ',' <track-breadth> ) | 'auto' | <track-breadth> | fit-content( <extended-length> | <extended-percentage> )"]
and track_repeat = [%value.rec "repeat( <positive-integer> ',' [ [ <line-names> ]? <track-size> ]+ [ <line-names> ]? )"]
and track_size = [%value.rec "<track-breadth> | minmax( <inflexible-breadth> ',' <track-breadth> ) | fit-content( <extended-length> | <extended-percentage> )"]
