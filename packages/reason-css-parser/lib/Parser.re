...
and length_percentage_legacy = [%value.rec "<length-legacy> | <percentage>"]
...
and property_border_radius = [%value.rec "[ <length-percentage-legacy> ]{1,4} [ '/' [ <length-percentage-legacy> ]{1,4} ]?"]
