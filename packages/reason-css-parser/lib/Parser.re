...
and one_bg_size = [%value.rec "[ <extended-length> | <extended-percentage> | 'auto' ]{1,2}"]
...
and property_box_shadow = [%value.rec "'none' | <interpolation> | [ <shadow> ]#"]
...
and property_font_family = [%value.rec "[ <family-name> | <generic-family> | <interpolation>]#"]
...
and property_font_weight = [%value.rec "<font-weight-absolute> | 'bolder' | 'lighter' | <interpolation>"]
...
and property_height = [%value.rec "'auto' | <extended-length> | <extended-percentage> | 'min-content' | 'max-content' | 'fit-content' | fit-content( <extended-length> | <extended-percentage> ) | <calc()>"]
...
and property_max_height = [%value.rec "'auto' | <extended-length> | <extended-percentage> | 'min-content' | 'max-content' | 'fit-content' | fit-content( <extended-length> | <extended-percentage> ) | <calc()>"]
and property_max_inline_size = [%value.rec "<'max-width'>"]
and property_max_lines = [%value.rec "'none' | <integer>"]
and property_max_width = [%value.rec "<extended-length> | <extended-percentage> | 'none' | 'max-content' | 'min-content' | 'fit-content' | fit-content( <extended-length> | <extended-percentage> ) | 'fill-available' | <-non-standard-width> | <calc()>"]
...
and property_text_shadow = [%value.rec "'none' | <interpolation> | [ <shadow-t> ]#"]
...
and property_width = [%value.rec "'auto' | <extended-length> | <extended-percentage> | 'min-content' | 'max-content' | 'fit-content' | fit-content( <extended-length> | <extended-percentage> ) | <calc()>"]
...
and single_transition_property = [%value.rec "'all' | <custom-ident> | <interpolation>"]
