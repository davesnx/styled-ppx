  ...
  module Display =
    struct
      ...
      let extract_interpolations (value : t) =
        (match value with | `Interpolation names -> names | _ -> [] : string
                                                                      list)
      let runtime_module = ((module Css_types.Display) : (module RUNTIME_TYPE))
      let (runtime_module_path : string) = "Css_types.Display"
    end
