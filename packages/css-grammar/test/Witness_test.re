...
let test_witness_to_name_property = () => {
  ...
  let name =
    Css_grammar.Types.witness_to_name(Css_grammar.Types.W_property_display);
  Alcotest.(
    check(
      string,
      "property witness returns prefixed name",
      "property_display",
      name,
    )
  );
...
let test_witness_to_name_value = () => {
  ...
  Alcotest.(
    check(string, "value witness returns unprefixed name", "color", name)
  );
};
...
let test_witness_eq_same = () => {
  ...
  Alcotest.(
    check(
      bool,
      "same witness equals itself",
      true,
      Option.is_some(eq_result),
    )
  );
};
...
let test_witness_eq_different = () => {
  ...
  Alcotest.(
    check(
      bool,
      "different witnesses are not equal",
      true,
      Option.is_none(eq_result),
    )
  );
};
...
let test_name_to_packed_witness_property = () => {
  ...
  let witness_opt =
    Css_grammar.Types.name_to_packed_witness("property_display");
  Alcotest.(
    check(
      bool,
      "property name resolves to witness",
      true,
      Option.is_some(witness_opt),
    )
  );
};
...
let test_name_to_packed_witness_value = () => {
  ...
  Alcotest.(
    check(
      bool,
      "value name resolves to witness",
      true,
      Option.is_some(witness_opt),
    )
  );
...
let test_name_to_packed_witness_unknown = () => {
  ...
  let witness_opt =
    Css_grammar.Types.name_to_packed_witness("unknown-property");
  Alcotest.(
    check(
      bool,
      "unknown name returns None",
      true,
      Option.is_none(witness_opt),
    )
  );
};
  ...
  (
    ...
    [
      Alcotest.test_case(
        "property name",
        `Quick,
        test_name_to_packed_witness_property,
      ),
    ],
  ),
  (
    ...
    [
      Alcotest.test_case(
        "value name",
        `Quick,
        test_name_to_packed_witness_value,
      ),
    ],
  ),
  (
    ...
    [
      Alcotest.test_case(
        "unknown name",
        `Quick,
        test_name_to_packed_witness_unknown,
      ),
    ],
  ),
  (
