...
let legacy_linear_gradient_arguments_runtime_module_path =
  Some [%module_path Css_types.LegacyLinearGradientArguments]

let legacy_radial_gradient_shape : legacy_radial_gradient_shape Rule.rule =
  [%spec "'circle' | 'ellipse'"]

let legacy_radial_gradient_shape_runtime_module_path =
  Some [%module_path Css_types.LegacyRadialGradientShape]
...
let legacy_radial_gradient_size_runtime_module_path =
  Some [%module_path Css_types.LegacyRadialGradientSize]
...
let legacy_radial_gradient_arguments_runtime_module_path =
  Some [%module_path Css_types.LegacyRadialGradientArguments]
...
let legacy_linear_gradient_runtime_module_path =
  Some [%module_path Css_types.LegacyLinearGradient]
...
let legacy_radial_gradient_runtime_module_path =
  Some [%module_path Css_types.LegacyRadialGradient]
...
let legacy_repeating_linear_gradient_runtime_module_path =
  Some [%module_path Css_types.LegacyRepeatingLinearGradient]
...
let legacy_repeating_radial_gradient_runtime_module_path =
  Some [%module_path Css_types.LegacyRepeatingRadialGradient]
...
let non_standard_image_rendering_runtime_module_path =
  Some [%module_path Css_types.NonStandardImageRendering]
...
let non_standard_overflow_runtime_module_path =
  Some [%module_path Css_types.NonStandardOverflow]
...
let webkit_gradient_color_stop_runtime_module_path =
  Some [%module_path Css_types.WebkitGradientColorStop]
...
let webkit_gradient_point_runtime_module_path =
  Some [%module_path Css_types.WebkitGradientPoint]

let webkit_gradient_radius : webkit_gradient_radius Rule.rule =
  [%spec "<extended-length> | <extended-percentage>"]

let webkit_gradient_radius_runtime_module_path =
  Some [%module_path Css_types.WebkitGradientRadius]

let webkit_gradient_type : webkit_gradient_type Rule.rule =
  [%spec "'linear' | 'radial'"]

let webkit_gradient_type_runtime_module_path =
  Some [%module_path Css_types.WebkitGradientType]

let webkit_mask_box_repeat : webkit_mask_box_repeat Rule.rule =
  [%spec "'repeat' | 'stretch' | 'round'"]

let webkit_mask_box_repeat_runtime_module_path =
  Some [%module_path Css_types.WebkitMaskBoxRepeat]
...
let webkit_mask_clip_style_runtime_module_path =
  Some [%module_path Css_types.WebkitMaskClipStyle]
...
let alpha_value_runtime_module_path = Some [%module_path Css_types.AlphaValue]
...
let angular_color_stop_list_runtime_module_path =
  Some [%module_path Css_types.AngularColorStopList]

let animateable_feature : animateable_feature Rule.rule =
  [%spec "'scroll-position' | 'contents' | <custom-ident>"]

let animateable_feature_runtime_module_path =
  Some [%module_path Css_types.AnimateableFeature]
...
let auto_repeat_runtime_module_path = Some [%module_path Css_types.AutoRepeat]
...
let basic_shape_runtime_module_path = Some [%module_path Css_types.BasicShape]
let bg_image : bg_image Rule.rule = [%spec "'none' | <image>"]
let bg_image_runtime_module_path = Some [%module_path Css_types.BgImage]
...
let bg_layer_runtime_module_path = Some [%module_path Css_types.BgLayer]
...
let bg_position_runtime_module_path = Some [%module_path Css_types.BgPosition]
...
let one_bg_size_runtime_module_path = Some [%module_path Css_types.OneBgSize]
let bg_size : bg_size Rule.rule = [%spec "<one-bg-size> | 'cover' | 'contain'"]
let bg_size_runtime_module_path = Some [%module_path Css_types.BgSize]
...
let blend_mode_runtime_module_path = Some [%module_path Css_types.BlendMode]
...
let box_runtime_module_path = Some [%module_path Css_types.Box]

let calc_product : calc_product Rule.rule =
  [%spec "<calc-value> [ '*' <calc-value> | '/' <number> ]*"]

let calc_product_runtime_module_path = Some [%module_path Css_types.CalcProduct]

let dimension : dimension Rule.rule =
  [%spec
    "<extended-length> | <extended-time> | <extended-frequency> | <resolution>"]

let dimension_runtime_module_path = Some [%module_path Css_types.Dimension]

let calc_sum : calc_sum Rule.rule =
  [%spec "<calc-product> [ [ '+' | '-' ] <calc-product> ]*"]

let calc_sum_runtime_module_path = Some [%module_path Css_types.CalcSum]
...
let color_runtime_module_path = Some [%module_path Css_types.Color]

let color_stop : color_stop Rule.rule =
  [%spec "<color-stop-length> | <color-stop-angle>"]

let color_stop_runtime_module_path = Some [%module_path Css_types.ColorStop]
...
let hue_interpolation_method_runtime_module_path =
  Some [%module_path Css_types.HueInterpolationMethod]
...
let rectangular_color_space_runtime_module_path =
  Some [%module_path Css_types.RectangularColorSpace]
...
let color_interpolation_method_runtime_module_path =
  Some [%module_path Css_types.ColorInterpolationMethod]
...
let combinator_runtime_module_path = Some [%module_path Css_types.Combinator]
...
let compat_auto_runtime_module_path = Some [%module_path Css_types.CompatAuto]
...
let complex_selector_list_runtime_module_path =
  Some [%module_path Css_types.ComplexSelectorList]
...
let compositing_operator_runtime_module_path =
  Some [%module_path Css_types.CompositingOperator]
...
let compound_selector_list_runtime_module_path =
  Some [%module_path Css_types.CompoundSelectorList]

let content_distribution : content_distribution Rule.rule =
  [%spec "'space-between' | 'space-around' | 'space-evenly' | 'stretch'"]

let content_distribution_runtime_module_path =
  Some [%module_path Css_types.ContentDistribution]
...
let content_list_runtime_module_path = Some [%module_path Css_types.ContentList]
...
let content_replacement_runtime_module_path =
  Some [%module_path Css_types.ContentReplacement]

let contextual_alt_values : contextual_alt_values Rule.rule =
  [%spec "'contextual' | 'no-contextual'"]

let contextual_alt_values_runtime_module_path =
  Some [%module_path Css_types.ContextualAltValues]
...
let cubic_bezier_timing_function_runtime_module_path =
  Some [%module_path Css_types.CubicBezierTimingFunction]

let declaration : declaration Rule.rule =
  [%spec "<ident-token> ':' [ <declaration-value> ]? [ '!' 'important' ]?"]

let declaration_runtime_module_path = Some [%module_path Css_types.Declaration]
...
let deprecated_system_color_runtime_module_path =
  Some [%module_path Css_types.DeprecatedSystemColor]

let discretionary_lig_values : discretionary_lig_values Rule.rule =
  [%spec "'discretionary-ligatures' | 'no-discretionary-ligatures'"]

let discretionary_lig_values_runtime_module_path =
  Some [%module_path Css_types.DiscretionaryLigValues]

let display_box : display_box Rule.rule = [%spec "'contents' | 'none'"]
let display_box_runtime_module_path = Some [%module_path Css_types.DisplayBox]
...
let east_asian_variant_values_runtime_module_path =
  Some [%module_path Css_types.EastAsianVariantValues]

let east_asian_width_values : east_asian_width_values Rule.rule =
  [%spec "'full-width' | 'proportional-width'"]

let east_asian_width_values_runtime_module_path =
  Some [%module_path Css_types.EastAsianWidthValues]

let ending_shape : ending_shape Rule.rule = [%spec "'circle' | 'ellipse'"]
let ending_shape_runtime_module_path = Some [%module_path Css_types.EndingShape]
...
let feature_type_runtime_module_path = Some [%module_path Css_types.FeatureType]
...
let feature_value_block_list_runtime_module_path =
  Some [%module_path Css_types.FeatureValueBlockList]

let feature_value_declaration : feature_value_declaration Rule.rule =
  [%spec "<custom-ident> ':' [ <integer> ]+ ';'"]

let feature_value_declaration_runtime_module_path =
  Some [%module_path Css_types.FeatureValueDeclaration]

let feature_value_declaration_list : feature_value_declaration_list Rule.rule =
  [%spec "<feature-value-declaration>"]

let feature_value_declaration_list_runtime_module_path =
...
let fill_rule_runtime_module_path = Some [%module_path Css_types.FillRule]
...
let filter_function_list_runtime_module_path =
  Some [%module_path Css_types.FilterFunctionList]
...
let fixed_repeat_runtime_module_path = Some [%module_path Css_types.FixedRepeat]
...
let fixed_size_runtime_module_path = Some [%module_path Css_types.FixedSize]
...
let font_stretch_absolute_runtime_module_path =
  Some [%module_path Css_types.FontStretchAbsolute]
...
let font_weight_absolute_runtime_module_path =
  Some [%module_path Css_types.FontWeightAbsolute]
...
let function_counter_runtime_module_path = Some [%module_path Css_types.Counter]
...
let function_image_runtime_module_path = Some [%module_path Css_types.Image]
...
let function_inset_runtime_module_path = Some [%module_path Css_types.Inset]
...
let function_paint_runtime_module_path = Some [%module_path Css_types.Paint]
...
let function_rotate_runtime_module_path = Some [%module_path Css_types.Rotate]
...
let function_scale_runtime_module_path = Some [%module_path Css_types.Scale]
...
let function_symbols_runtime_module_path = Some [%module_path Css_types.Symbols]
...
let function_var_runtime_module_path = Some [%module_path Css_types.Var] *)
let function_var : function_var Rule.rule = [%spec "var( <ident> )"]
let function_var_runtime_module_path = Some [%module_path Css_types.Var]
let gender : gender Rule.rule = [%spec "'male' | 'female' | 'neutral'"]
let gender_runtime_module_path = Some [%module_path Css_types.Gender]
...
let generic_name_runtime_module_path = Some [%module_path Css_types.GenericName]
...
let geometry_box_runtime_module_path = Some [%module_path Css_types.GeometryBox]
...
let gradient_runtime_module_path = Some [%module_path Css_types.Gradient]
...
let grid_line_runtime_module_path = Some [%module_path Css_types.GridLine]

let historical_lig_values : historical_lig_values Rule.rule =
  [%spec "'historical-ligatures' | 'no-historical-ligatures'"]

let historical_lig_values_runtime_module_path =
  Some [%module_path Css_types.HistoricalLigValues]

let hue : hue Rule.rule = [%spec "<number> | <extended-angle>"]
let hue_runtime_module_path = Some [%module_path Css_types.Hue]
let id_selector : id_selector Rule.rule = [%spec "<hash-token>"]
let id_selector_runtime_module_path = Some [%module_path Css_types.IdSelector]
...
let image_runtime_module_path = Some [%module_path Css_types.Image]
...
let image_tags_runtime_module_path = Some [%module_path Css_types.ImageTags]
...
let leader_type_runtime_module_path = Some [%module_path Css_types.LeaderType]
let left : left Rule.rule = [%spec "<extended-length> | 'auto'"]
let left_runtime_module_path = Some [%module_path Css_types.Left]
...
let line_style_runtime_module_path = Some [%module_path Css_types.LineStyle]

let line_width : line_width Rule.rule =
  [%spec "<extended-length> | 'thin' | 'medium' | 'thick'"]

let line_width_runtime_module_path = Some [%module_path Css_types.LineWidth]
...
let mask_layer_runtime_module_path = Some [%module_path Css_types.MaskLayer]
...
let masking_mode_runtime_module_path = Some [%module_path Css_types.MaskingMode]
...
let mf_gt_runtime_module_path = Some [%module_path Css_types.MfGt]
let mf_lt : mf_lt Rule.rule = [%spec "'<=' | '<'"]
let mf_lt_runtime_module_path = Some [%module_path Css_types.MfLt]

let mf_value : mf_value Rule.rule =
  [%spec
    "<number> | <dimension> | <ident> | <ratio> | <interpolation> | <calc()>"]

let mf_value_runtime_module_path = Some [%module_path Css_types.MfValue]
let mf_name : mf_name Rule.rule = [%spec "<ident>"]
let mf_name_runtime_module_path = Some [%module_path Css_types.MfName]
...
let mf_range_runtime_module_path = Some [%module_path Css_types.MfRange]
let mf_boolean : mf_boolean Rule.rule = [%spec "<mf-name>"]
let mf_boolean_runtime_module_path = Some [%module_path Css_types.MfBoolean]
let mf_plain : mf_plain Rule.rule = [%spec "<mf-name> ':' <mf-value>"]
let mf_plain_runtime_module_path = Some [%module_path Css_types.MfPlain]
...
let media_or_runtime_module_path = Some [%module_path Css_types.MediaOr]
let media_not : media_not Rule.rule = [%spec "'not' <media-in-parens>"]
let media_not_runtime_module_path = Some [%module_path Css_types.MediaNot]

let media_condition_without_or : media_condition_without_or Rule.rule =
  [%spec "<media-not> | <media-in-parens> <media-and>*"]

let media_condition_without_or_runtime_module_path =
  Some [%module_path Css_types.MediaConditionWithoutOr]
...
let media_query_runtime_module_path = Some [%module_path Css_types.MediaQuery]
...
let container_condition_list_runtime_module_path =
  Some [%module_path Css_types.ContainerConditionList]

let container_condition : container_condition Rule.rule =
  [%spec "[ <container-name> ]? <container-query>"]

let container_condition_runtime_module_path =
  Some [%module_path Css_types.ContainerCondition]
...
let size_feature_runtime_module_path = Some [%module_path Css_types.SizeFeature]
...
let style_query_runtime_module_path = Some [%module_path Css_types.StyleQuery]
...
let name_repeat_runtime_module_path = Some [%module_path Css_types.NameRepeat]
...
let nth_runtime_module_path = Some [%module_path Css_types.Nth]
let number_one_or_greater : number_one_or_greater Rule.rule = [%spec "<number>"]

let number_one_or_greater_runtime_module_path =
  Some [%module_path Css_types.NumberOneOrGreater]
...
let numeric_figure_values_runtime_module_path =
  Some [%module_path Css_types.NumericFigureValues]

let numeric_fraction_values : numeric_fraction_values Rule.rule =
  [%spec "'diagonal-fractions' | 'stacked-fractions'"]

let numeric_fraction_values_runtime_module_path =
  Some [%module_path Css_types.NumericFractionValues]

let numeric_spacing_values : numeric_spacing_values Rule.rule =
  [%spec "'proportional-nums' | 'tabular-nums'"]

let numeric_spacing_values_runtime_module_path =
  Some [%module_path Css_types.NumericSpacingValues]
...
let page_body_runtime_module_path = Some [%module_path Css_types.PageBody]
...
let page_margin_box_type_runtime_module_path =
  Some [%module_path Css_types.PageMarginBoxType]
...
let paint_runtime_module_path = Some [%module_path Css_types.Paint]
...
let property__moz_appearance_runtime_module_path =
  Some [%module_path Css_types.MozAppearance]

let property__moz_background_clip : property__moz_background_clip Rule.rule =
  [%spec "'padding' | 'border'"]

let property__moz_background_clip_runtime_module_path =
  Some [%module_path Css_types.MozBackgroundClip]
...
let property__moz_border_bottom_colors_runtime_module_path =
  Some [%module_path Css_types.MozBorderBottomColors]

let property__moz_border_left_colors :
  property__moz_border_left_colors Rule.rule =
  [%spec "[ <color> ]+ | 'none'"]

let property__moz_border_left_colors_runtime_module_path =
  Some [%module_path Css_types.MozBorderLeftColors]

let property__moz_border_radius_bottomleft :
  property__moz_border_radius_bottomleft Rule.rule =
  [%spec "<'border-bottom-left-radius'>"]

let property__moz_border_radius_bottomleft_runtime_module_path =
  Some [%module_path Css_types.MozBorderRadiusBottomleft]
...
let property__moz_border_radius_bottomright_runtime_module_path =
  Some [%module_path Css_types.MozBorderRadiusBottomright]

let property__moz_border_radius_topleft :
  property__moz_border_radius_topleft Rule.rule =
  [%spec "<'border-top-left-radius'>"]

let property__moz_border_radius_topleft_runtime_module_path =
  Some [%module_path Css_types.MozBorderRadiusTopleft]

let property__moz_border_radius_topright :
  property__moz_border_radius_topright Rule.rule =
  [%spec "<'border-bottom-right-radius'>"]

let property__moz_border_radius_topright_runtime_module_path =
  Some [%module_path Css_types.MozBorderRadiusTopright]

let property__moz_border_right_colors :
  property__moz_border_right_colors Rule.rule =
  [%spec "[ <color> ]+ | 'none'"]

let property__moz_border_right_colors_runtime_module_path =
  Some [%module_path Css_types.MozBorderRightColors]

let property__moz_border_top_colors : property__moz_border_top_colors Rule.rule
    =
  [%spec "[ <color> ]+ | 'none'"]

let property__moz_border_top_colors_runtime_module_path =
  Some [%module_path Css_types.MozBorderTopColors]
...
let property__moz_context_properties_runtime_module_path =
  Some [%module_path Css_types.MozContextProperties]

let property__moz_control_character_visibility :
  property__moz_control_character_visibility Rule.rule =
  [%spec "'visible' | 'hidden'"]

let property__moz_control_character_visibility_runtime_module_path =
  Some [%module_path Css_types.MozControlCharacterVisibility]
...
let property__moz_force_broken_image_icon_runtime_module_path =
  Some [%module_path Css_types.MozForceBrokenImageIcon]

let property__moz_image_region : property__moz_image_region Rule.rule =
  [%spec "<shape> | 'auto'"]

let property__moz_image_region_runtime_module_path =
  Some [%module_path Css_types.MozImageRegion]
...
let property__moz_osx_font_smoothing_runtime_module_path =
  Some [%module_path Css_types.MozOsxFontSmoothing]

let property__moz_outline_radius : property__moz_outline_radius Rule.rule =
  [%spec "[ <outline-radius> ]{1,4} [ '/' [ <outline-radius> ]{1,4} ]?"]

let property__moz_outline_radius_runtime_module_path =
  Some [%module_path Css_types.MozOutlineRadius]

let property__moz_outline_radius_bottomleft :
  property__moz_outline_radius_bottomleft Rule.rule =
  [%spec "<outline-radius>"]

let property__moz_outline_radius_bottomleft_runtime_module_path =
  Some [%module_path Css_types.MozOutlineRadiusBottomleft]

let property__moz_outline_radius_bottomright :
  property__moz_outline_radius_bottomright Rule.rule =
  [%spec "<outline-radius>"]

let property__moz_outline_radius_bottomright_runtime_module_path =
  Some [%module_path Css_types.MozOutlineRadiusBottomright]

let property__moz_outline_radius_topleft :
  property__moz_outline_radius_topleft Rule.rule =
  [%spec "<outline-radius>"]

let property__moz_outline_radius_topleft_runtime_module_path =
  Some [%module_path Css_types.MozOutlineRadiusTopleft]

let property__moz_outline_radius_topright :
  property__moz_outline_radius_topright Rule.rule =
  [%spec "<outline-radius>"]

let property__moz_outline_radius_topright_runtime_module_path =
  Some [%module_path Css_types.MozOutlineRadiusTopright]

let property__moz_stack_sizing : property__moz_stack_sizing Rule.rule =
  [%spec "'ignore' | 'stretch-to-fit'"]

let property__moz_stack_sizing_runtime_module_path =
  Some [%module_path Css_types.MozStackSizing]
...
let property__moz_user_modify_runtime_module_path =
  Some [%module_path Css_types.MozUserModify]

let property__moz_user_select : property__moz_user_select Rule.rule =
  [%spec "'none' | 'text' | 'all' | '-moz-none'"]

let property__moz_user_select_runtime_module_path =
  Some [%module_path Css_types.MozUserSelect]

let property__moz_window_dragging : property__moz_window_dragging Rule.rule =
  [%spec "'drag' | 'no-drag'"]

let property__moz_window_dragging_runtime_module_path =
  Some [%module_path Css_types.MozWindowDragging]

let property__moz_window_shadow : property__moz_window_shadow Rule.rule =
  [%spec "'default' | 'menu' | 'tooltip' | 'sheet' | 'none'"]

let property__moz_window_shadow_runtime_module_path =
  Some [%module_path Css_types.MozWindowShadow]
...
let property__webkit_appearance_runtime_module_path =
  Some [%module_path Css_types.WebkitAppearance]

let property__webkit_background_clip :
  property__webkit_background_clip Rule.rule =
  [%spec "[ <box> | 'border' | 'padding' | 'content' | 'text' ]#"]

let property__webkit_background_clip_runtime_module_path =
  Some [%module_path Css_types.WebkitBackgroundClip]

let property__webkit_border_before : property__webkit_border_before Rule.rule =
  [%spec "<'border-width'> || <'border-style'> || <'color'>"]

let property__webkit_border_before_runtime_module_path =
  Some [%module_path Css_types.WebkitBorderBefore]

let property__webkit_border_before_color :
  property__webkit_border_before_color Rule.rule =
  [%spec "<'color'>"]

let property__webkit_border_before_color_runtime_module_path =
  Some [%module_path Css_types.WebkitBorderBeforeColor]

let property__webkit_border_before_style :
  property__webkit_border_before_style Rule.rule =
  [%spec "<'border-style'>"]

let property__webkit_border_before_style_runtime_module_path =
  Some [%module_path Css_types.WebkitBorderBeforeStyle]

let property__webkit_border_before_width :
  property__webkit_border_before_width Rule.rule =
  [%spec "<'border-width'>"]

let property__webkit_border_before_width_runtime_module_path =
  Some [%module_path Css_types.WebkitBorderBeforeWidth]
...
let property__webkit_box_reflect_runtime_module_path =
  Some [%module_path Css_types.WebkitBoxReflect]

let property__webkit_column_break_after :
  property__webkit_column_break_after Rule.rule =
  [%spec "'always' | 'auto' | 'avoid'"]

let property__webkit_column_break_after_runtime_module_path =
  Some [%module_path Css_types.WebkitColumnBreakAfter]

let property__webkit_column_break_before :
  property__webkit_column_break_before Rule.rule =
  [%spec "'always' | 'auto' | 'avoid'"]

let property__webkit_column_break_before_runtime_module_path =
  Some [%module_path Css_types.WebkitColumnBreakBefore]

let property__webkit_column_break_inside :
  property__webkit_column_break_inside Rule.rule =
  [%spec "'always' | 'auto' | 'avoid'"]

let property__webkit_column_break_inside_runtime_module_path =
  Some [%module_path Css_types.WebkitColumnBreakInside]
...
let property__webkit_font_smoothing_runtime_module_path =
  Some [%module_path Css_types.WebkitFontSmoothing]

let property__webkit_line_clamp : property__webkit_line_clamp Rule.rule =
  [%spec "'none' | <integer>"]

let property__webkit_line_clamp_runtime_module_path =
  Some [%module_path Css_types.WebkitLineClamp]
...
let property__webkit_mask_attachment_runtime_module_path =
  Some [%module_path Css_types.WebkitMaskAttachment]
...
let property__webkit_mask_box_image_runtime_module_path =
  Some [%module_path Css_types.WebkitMaskBoxImage]

let property__webkit_mask_clip : property__webkit_mask_clip Rule.rule =
  [%spec "[ <box> | 'border' | 'padding' | 'content' | 'text' ]#"]

let property__webkit_mask_clip_runtime_module_path =
  Some [%module_path Css_types.WebkitMaskClip]

let property__webkit_mask_composite : property__webkit_mask_composite Rule.rule
    =
  [%spec "[ <composite-style> ]#"]

let property__webkit_mask_composite_runtime_module_path =
  Some [%module_path Css_types.WebkitMaskComposite]

let property__webkit_mask_image : property__webkit_mask_image Rule.rule =
  [%spec "[ <mask-reference> ]#"]

let property__webkit_mask_image_runtime_module_path =
  Some [%module_path Css_types.WebkitMaskImage]

let property__webkit_mask_origin : property__webkit_mask_origin Rule.rule =
  [%spec "[ <box> | 'border' | 'padding' | 'content' ]#"]

let property__webkit_mask_origin_runtime_module_path =
  Some [%module_path Css_types.WebkitMaskOrigin]

let property__webkit_mask_position : property__webkit_mask_position Rule.rule =
  [%spec "[ <position> ]#"]

let property__webkit_mask_position_runtime_module_path =
  Some [%module_path Css_types.WebkitMaskPosition]
...
let property__webkit_mask_position_x_runtime_module_path =
  Some [%module_path Css_types.WebkitMaskPositionX]
...
let property__webkit_mask_position_y_runtime_module_path =
  Some [%module_path Css_types.WebkitMaskPositionY]

let property__webkit_mask_repeat : property__webkit_mask_repeat Rule.rule =
  [%spec "[ <repeat-style> ]#"]

let property__webkit_mask_repeat_runtime_module_path =
  Some [%module_path Css_types.WebkitMaskRepeat]

let property__webkit_mask_repeat_x : property__webkit_mask_repeat_x Rule.rule =
  [%spec "'repeat' | 'no-repeat' | 'space' | 'round'"]

let property__webkit_mask_repeat_x_runtime_module_path =
  Some [%module_path Css_types.WebkitMaskRepeatX]

let property__webkit_mask_repeat_y : property__webkit_mask_repeat_y Rule.rule =
  [%spec "'repeat' | 'no-repeat' | 'space' | 'round'"]

let property__webkit_mask_repeat_y_runtime_module_path =
  Some [%module_path Css_types.WebkitMaskRepeatY]

let property__webkit_mask_size : property__webkit_mask_size Rule.rule =
  [%spec "[ <bg-size> ]#"]

let property__webkit_mask_size_runtime_module_path =
  Some [%module_path Css_types.WebkitMaskSize]

let property__webkit_overflow_scrolling :
  property__webkit_overflow_scrolling Rule.rule =
  [%spec "'auto' | 'touch'"]

let property__webkit_overflow_scrolling_runtime_module_path =
  Some [%module_path Css_types.WebkitOverflowScrolling]

let property__webkit_print_color_adjust :
  property__webkit_print_color_adjust Rule.rule =
  [%spec "'economy' | 'exact'"]

let property__webkit_print_color_adjust_runtime_module_path =
  Some [%module_path Css_types.WebkitPrintColorAdjust]

let property__webkit_tap_highlight_color :
  property__webkit_tap_highlight_color Rule.rule =
  [%spec "<color>"]

let property__webkit_tap_highlight_color_runtime_module_path =
  Some [%module_path Css_types.WebkitTapHighlightColor]

let property__webkit_text_fill_color :
  property__webkit_text_fill_color Rule.rule =
  [%spec "<color>"]

let property__webkit_text_fill_color_runtime_module_path =
  Some [%module_path Css_types.WebkitTextFillColor]

let property__webkit_text_security : property__webkit_text_security Rule.rule =
  [%spec "'none' | 'circle' | 'disc' | 'square'"]

let property__webkit_text_security_runtime_module_path =
  Some [%module_path Css_types.WebkitTextSecurity]

let property__webkit_text_stroke : property__webkit_text_stroke Rule.rule =
  [%spec "<extended-length> || <color>"]

let property__webkit_text_stroke_runtime_module_path =
  Some [%module_path Css_types.WebkitTextStroke]

let property__webkit_text_stroke_color :
  property__webkit_text_stroke_color Rule.rule =
  [%spec "<color>"]

let property__webkit_text_stroke_color_runtime_module_path =
  Some [%module_path Css_types.WebkitTextStrokeColor]

let property__webkit_text_stroke_width :
  property__webkit_text_stroke_width Rule.rule =
  [%spec "<extended-length>"]

let property__webkit_text_stroke_width_runtime_module_path =
  Some [%module_path Css_types.WebkitTextStrokeWidth]

let property__webkit_touch_callout : property__webkit_touch_callout Rule.rule =
  [%spec "'default' | 'none'"]

let property__webkit_touch_callout_runtime_module_path =
  Some [%module_path Css_types.WebkitTouchCallout]

let property__webkit_user_drag : property__webkit_user_drag Rule.rule =
  [%spec "'none' | 'element' | 'auto'"]

let property__webkit_user_drag_runtime_module_path =
  Some [%module_path Css_types.WebkitUserDrag]
...
let property__webkit_user_modify_runtime_module_path =
  Some [%module_path Css_types.WebkitUserModify]

let property__webkit_user_select : property__webkit_user_select Rule.rule =
  [%spec "'auto' | 'none' | 'text' | 'all'"]

let property__webkit_user_select_runtime_module_path =
  Some [%module_path Css_types.WebkitUserSelect]

let property__ms_overflow_style : property__ms_overflow_style Rule.rule =
  [%spec "'auto' | 'none' | 'scrollbar' | '-ms-autohiding-scrollbar'"]

let property__ms_overflow_style_runtime_module_path =
  Some [%module_path Css_types.MsOverflowStyle]
...
let property_alignment_baseline_runtime_module_path =
  Some [%module_path Css_types.AlignmentBaseline]

let property_all : property_all Rule.rule =
  [%spec "'initial' | 'inherit' | 'unset' | 'revert'"]

let property_all_runtime_module_path = Some [%module_path Css_types.All]
...
let property_animation_delay_runtime_module_path =
  Some [%module_path Css_types.AnimationDelay]

let property_animation_direction : property_animation_direction Rule.rule =
  [%spec "[ <single-animation-direction> ]#"]

let property_animation_direction_runtime_module_path =
  Some [%module_path Css_types.AnimationDirection]

let property_animation_duration : property_animation_duration Rule.rule =
  [%spec "[ <extended-time> ]#"]

let property_animation_duration_runtime_module_path =
  Some [%module_path Css_types.AnimationDuration]

let property_animation_fill_mode : property_animation_fill_mode Rule.rule =
  [%spec "[ <single-animation-fill-mode> ]#"]

let property_animation_fill_mode_runtime_module_path =
  Some [%module_path Css_types.AnimationFillMode]

let property_animation_iteration_count :
  property_animation_iteration_count Rule.rule =
  [%spec "[ <single-animation-iteration-count> ]#"]

let property_animation_iteration_count_runtime_module_path =
  Some [%module_path Css_types.AnimationIterationCount]
...
let property_animation_play_state_runtime_module_path =
  Some [%module_path Css_types.AnimationPlayState]

let property_animation_timing_function :
  property_animation_timing_function Rule.rule =
  [%spec "[ <timing-function> ]#"]

let property_animation_timing_function_runtime_module_path =
  Some [%module_path Css_types.AnimationTimingFunction]
...
let property_azimuth_runtime_module_path = Some [%module_path Css_types.Azimuth]
...
let property_backface_visibility_runtime_module_path =
  Some [%module_path Css_types.BackfaceVisibility]
...
let property_background_attachment_runtime_module_path =
  Some [%module_path Css_types.BackgroundAttachment]

let property_background_blend_mode : property_background_blend_mode Rule.rule =
  [%spec "[ <blend-mode> ]#"]

let property_background_blend_mode_runtime_module_path =
  Some [%module_path Css_types.BackgroundBlendMode]

let property_background_clip : property_background_clip Rule.rule =
  [%spec "[ <box> | 'text' | 'border-area' ]#"]

let property_background_clip_runtime_module_path =
  Some [%module_path Css_types.BackgroundClip]
...
let property_background_image_runtime_module_path =
  Some [%module_path Css_types.BackgroundImage]

let property_background_origin : property_background_origin Rule.rule =
  [%spec "[ <box> ]#"]

let property_background_origin_runtime_module_path =
  Some [%module_path Css_types.BackgroundOrigin]

let property_background_position : property_background_position Rule.rule =
  [%spec "[ <bg-position> ]#"]

let property_background_position_runtime_module_path =
  Some [%module_path Css_types.BackgroundPosition]
...
let property_background_position_x_runtime_module_path =
  Some [%module_path Css_types.BackgroundPositionX]
...
let property_background_position_y_runtime_module_path =
  Some [%module_path Css_types.BackgroundPositionY]

let property_background_repeat : property_background_repeat Rule.rule =
  [%spec "[ <repeat-style> ]#"]

let property_background_repeat_runtime_module_path =
  Some [%module_path Css_types.BackgroundRepeat]

let property_background_size : property_background_size Rule.rule =
  [%spec "[ <bg-size> ]#"]

let property_background_size_runtime_module_path =
  Some [%module_path Css_types.BackgroundSize]
...
let property_border_block_color_runtime_module_path =
  Some [%module_path Css_types.BorderBlockColor]

let property_border_block_end : property_border_block_end Rule.rule =
  [%spec "<'border'>"]

let property_border_block_end_runtime_module_path =
  Some [%module_path Css_types.BorderBlockEnd]

let property_border_block_end_color : property_border_block_end_color Rule.rule
    =
  [%spec "<'border-top-color'>"]

let property_border_block_end_color_runtime_module_path =
  Some [%module_path Css_types.BorderBlockEndColor]

let property_border_block_end_style : property_border_block_end_style Rule.rule
    =
  [%spec "<'border-top-style'>"]

let property_border_block_end_style_runtime_module_path =
  Some [%module_path Css_types.BorderBlockEndStyle]

let property_border_block_end_width : property_border_block_end_width Rule.rule
    =
  [%spec "<'border-top-width'>"]

let property_border_block_end_width_runtime_module_path =
  Some [%module_path Css_types.BorderBlockEndWidth]

let property_border_block_start : property_border_block_start Rule.rule =
  [%spec "<'border'>"]

let property_border_block_start_runtime_module_path =
  Some [%module_path Css_types.BorderBlockStart]

let property_border_block_start_color :
  property_border_block_start_color Rule.rule =
  [%spec "<'border-top-color'>"]

let property_border_block_start_color_runtime_module_path =
  Some [%module_path Css_types.BorderBlockStartColor]

let property_border_block_start_style :
  property_border_block_start_style Rule.rule =
  [%spec "<'border-top-style'>"]

let property_border_block_start_style_runtime_module_path =
  Some [%module_path Css_types.BorderBlockStartStyle]

let property_border_block_start_width :
  property_border_block_start_width Rule.rule =
  [%spec "<'border-top-width'>"]

let property_border_block_start_width_runtime_module_path =
  Some [%module_path Css_types.BorderBlockStartWidth]

let property_border_block_style : property_border_block_style Rule.rule =
  [%spec "<'border-top-style'>"]

let property_border_block_style_runtime_module_path =
  Some [%module_path Css_types.BorderBlockStyle]

let property_border_block_width : property_border_block_width Rule.rule =
  [%spec "<'border-top-width'>"]

let property_border_block_width_runtime_module_path =
  Some [%module_path Css_types.BorderBlockWidth]
...
let property_border_collapse_runtime_module_path =
  Some [%module_path Css_types.BorderCollapse]
...
let property_border_image_outset_runtime_module_path =
  Some [%module_path Css_types.BorderImageOutset]

let property_border_image_repeat : property_border_image_repeat Rule.rule =
  [%spec "[ 'stretch' | 'repeat' | 'round' | 'space' ]{1,2}"]

let property_border_image_repeat_runtime_module_path =
  Some [%module_path Css_types.BorderImageRepeat]

let property_border_image_slice : property_border_image_slice Rule.rule =
  [%spec "[ <number-percentage> ]{1,4} && [ 'fill' ]?"]

let property_border_image_slice_runtime_module_path =
  Some [%module_path Css_types.BorderImageSlice]

let property_border_image_source : property_border_image_source Rule.rule =
  [%spec "'none' | <image>"]

let property_border_image_source_runtime_module_path =
  Some [%module_path Css_types.BorderImageSource]

let property_border_image_width : property_border_image_width Rule.rule =
  [%spec
    "[ <extended-length> | <extended-percentage> | <number> | 'auto' ]{1,4}"]

let property_border_image_width_runtime_module_path =
  Some [%module_path Css_types.BorderImageWidth]
...
let property_border_inline_color_runtime_module_path =
  Some [%module_path Css_types.BorderInlineColor]

let property_border_inline_end : property_border_inline_end Rule.rule =
  [%spec "<'border'>"]

let property_border_inline_end_runtime_module_path =
  Some [%module_path Css_types.BorderInlineEnd]

let property_border_inline_end_color :
  property_border_inline_end_color Rule.rule =
  [%spec "<'border-top-color'>"]

let property_border_inline_end_color_runtime_module_path =
  Some [%module_path Css_types.BorderInlineEndColor]

let property_border_inline_end_style :
  property_border_inline_end_style Rule.rule =
  [%spec "<'border-top-style'>"]

let property_border_inline_end_style_runtime_module_path =
  Some [%module_path Css_types.BorderInlineEndStyle]

let property_border_inline_end_width :
  property_border_inline_end_width Rule.rule =
  [%spec "<'border-top-width'>"]

let property_border_inline_end_width_runtime_module_path =
  Some [%module_path Css_types.BorderInlineEndWidth]

let property_border_inline_start : property_border_inline_start Rule.rule =
  [%spec "<'border'>"]

let property_border_inline_start_runtime_module_path =
  Some [%module_path Css_types.BorderInlineStart]

let property_border_inline_start_color :
  property_border_inline_start_color Rule.rule =
  [%spec "<'border-top-color'>"]

let property_border_inline_start_color_runtime_module_path =
  Some [%module_path Css_types.BorderInlineStartColor]

let property_border_inline_start_style :
  property_border_inline_start_style Rule.rule =
  [%spec "<'border-top-style'>"]

let property_border_inline_start_style_runtime_module_path =
  Some [%module_path Css_types.BorderInlineStartStyle]

let property_border_inline_start_width :
  property_border_inline_start_width Rule.rule =
  [%spec "<'border-top-width'>"]

let property_border_inline_start_width_runtime_module_path =
  Some [%module_path Css_types.BorderInlineStartWidth]

let property_border_inline_style : property_border_inline_style Rule.rule =
  [%spec "<'border-top-style'>"]

let property_border_inline_style_runtime_module_path =
  Some [%module_path Css_types.BorderInlineStyle]

let property_border_inline_width : property_border_inline_width Rule.rule =
  [%spec "<'border-top-width'>"]

let property_border_inline_width_runtime_module_path =
...
let property_bottom_runtime_module_path = Some [%module_path Css_types.Bottom]
...
let property_box_decoration_break_runtime_module_path =
  Some [%module_path Css_types.BoxDecorationBreak]
...
let property_box_ordinal_group_runtime_module_path =
  Some [%module_path Css_types.BoxOrdinalGroup]
...
let property_clear_runtime_module_path = Some [%module_path Css_types.Clear]
let property_clip : property_clip Rule.rule = [%spec "<shape> | 'auto'"]
let property_clip_runtime_module_path = Some [%module_path Css_types.Clip]
...
let property_color_interpolation_filters_runtime_module_path =
  Some [%module_path Css_types.ColorInterpolationFilters]

let property_color_interpolation : property_color_interpolation Rule.rule =
  [%spec "'auto' | 'sRGB' | 'linearRGB'"]

let property_color_interpolation_runtime_module_path =
  Some [%module_path Css_types.ColorInterpolation]
...
let property_column_rule_color_runtime_module_path =
  Some [%module_path Css_types.ColumnRuleColor]

let property_column_rule_style : property_column_rule_style Rule.rule =
  [%spec "<'border-style'>"]

let property_column_rule_style_runtime_module_path =
  Some [%module_path Css_types.ColumnRuleStyle]

let property_column_rule_width : property_column_rule_width Rule.rule =
  [%spec "<'border-width'>"]

let property_column_rule_width_runtime_module_path =
  Some [%module_path Css_types.ColumnRuleWidth]
...
let property_columns_runtime_module_path = Some [%module_path Css_types.Columns]

let property_contain : property_contain Rule.rule =
  [%spec
    "'none' | 'strict' | 'content' | 'size' || 'layout' || 'style' || 'paint'"]

let property_contain_runtime_module_path = Some [%module_path Css_types.Contain]
...
let property_content_runtime_module_path = Some [%module_path Css_types.Content]

let property_content_visibility : property_content_visibility Rule.rule =
  [%spec "'visible' | 'hidden' | 'auto'"]

let property_content_visibility_runtime_module_path =
  Some [%module_path Css_types.ContentVisibility]

let property_counter_increment : property_counter_increment Rule.rule =
  [%spec "[ <custom-ident> [ <integer> ]? ]+ | 'none'"]

let property_counter_increment_runtime_module_path =
  Some [%module_path Css_types.CounterIncrement]
...
let property_cue_runtime_module_path = Some [%module_path Css_types.Cue]
...
let property_display_runtime_module_path = Some [%module_path Css_types.Display]
...
let property_dominant_baseline_runtime_module_path =
  Some [%module_path Css_types.DominantBaseline]
...
let property_filter_runtime_module_path = Some [%module_path Css_types.Filter]
...
let property_flex_runtime_module_path = Some [%module_path Css_types.Flex]
...
let property_float_runtime_module_path = Some [%module_path Css_types.Float]
...
let property_font_runtime_module_path = Some [%module_path Css_types.Font]
...
let property_font_feature_settings_runtime_module_path =
  Some [%module_path Css_types.FontFeatureSettings]
...
let property_font_language_override_runtime_module_path =
  Some [%module_path Css_types.FontLanguageOverride]

let property_font_optical_sizing : property_font_optical_sizing Rule.rule =
  [%spec "'auto' | 'none'"]

let property_font_optical_sizing_runtime_module_path =
  Some [%module_path Css_types.FontOpticalSizing]
...
let property_font_size_adjust_runtime_module_path =
  Some [%module_path Css_types.FontSizeAdjust]
...
let property_font_synthesis_weight_runtime_module_path =
  Some [%module_path Css_types.FontSynthesisWeight]

let property_font_synthesis_style : property_font_synthesis_style Rule.rule =
  [%spec "'auto' | 'none'"]

let property_font_synthesis_style_runtime_module_path =
  Some [%module_path Css_types.FontSynthesisStyle]

let property_font_synthesis_small_caps :
  property_font_synthesis_small_caps Rule.rule =
  [%spec "'auto' | 'none'"]

let property_font_synthesis_small_caps_runtime_module_path =
  Some [%module_path Css_types.FontSynthesisSmallCaps]

let property_font_synthesis_position :
  property_font_synthesis_position Rule.rule =
  [%spec "'auto' | 'none'"]

let property_font_synthesis_position_runtime_module_path =
  Some [%module_path Css_types.FontSynthesisPosition]
...
let property_font_variant_alternates_runtime_module_path =
  Some [%module_path Css_types.FontVariantAlternates]
...
let property_font_variant_caps_runtime_module_path =
  Some [%module_path Css_types.FontVariantCaps]
...
let property_font_variant_east_asian_runtime_module_path =
  Some [%module_path Css_types.FontVariantEastAsian]
...
let property_font_variant_ligatures_runtime_module_path =
  Some [%module_path Css_types.FontVariantLigatures]
...
let property_font_variant_numeric_runtime_module_path =
  Some [%module_path Css_types.FontVariantNumeric]

let property_font_variant_position : property_font_variant_position Rule.rule =
  [%spec "'normal' | 'sub' | 'super'"]

let property_font_variant_position_runtime_module_path =
  Some [%module_path Css_types.FontVariantPosition]

let property_font_variation_settings :
  property_font_variation_settings Rule.rule =
  [%spec "'normal' | [ <string> <number> ]#"]

let property_font_variation_settings_runtime_module_path =
  Some [%module_path Css_types.FontVariationSettings]

let property_font_variant_emoji : property_font_variant_emoji Rule.rule =
  [%spec "'normal' | 'text' | 'emoji' | 'unicode'"]

let property_font_variant_emoji_runtime_module_path =
  Some [%module_path Css_types.FontVariantEmoji]
...
let property_gap_runtime_module_path = Some [%module_path Css_types.Gap]

let property_glyph_orientation_horizontal :
  property_glyph_orientation_horizontal Rule.rule =
  [%spec "<extended-angle>"]

let property_glyph_orientation_horizontal_runtime_module_path =
  Some [%module_path Css_types.GlyphOrientationHorizontal]

let property_glyph_orientation_vertical :
  property_glyph_orientation_vertical Rule.rule =
  [%spec "<extended-angle>"]

let property_glyph_orientation_vertical_runtime_module_path =
  Some [%module_path Css_types.GlyphOrientationVertical]
...
let property_grid_runtime_module_path = Some [%module_path Css_types.Grid]
...
let property_grid_auto_columns_runtime_module_path =
  Some [%module_path Css_types.GridAutoColumns]
...
let property_grid_column_end_runtime_module_path =
  Some [%module_path Css_types.GridColumnEnd]
...
let property_grid_column_start_runtime_module_path =
  Some [%module_path Css_types.GridColumnStart]
...
let property_grid_template_areas_runtime_module_path =
  Some [%module_path Css_types.GridTemplateAreas]
...
let property_grid_template_columns_runtime_module_path =
  Some [%module_path Css_types.GridTemplateColumns]
...
let property_grid_template_rows_runtime_module_path =
  Some [%module_path Css_types.GridTemplateRows]

let property_hanging_punctuation : property_hanging_punctuation Rule.rule =
  [%spec "'none' | 'first' || [ 'force-end' | 'allow-end' ] || 'last'"]

let property_hanging_punctuation_runtime_module_path =
  Some [%module_path Css_types.HangingPunctuation]
...
let property_height_runtime_module_path = Some [%module_path Css_types.Height]

let property_hyphens : property_hyphens Rule.rule =
  [%spec "'none' | 'manual' | 'auto'"]

let property_hyphens_runtime_module_path = Some [%module_path Css_types.Hyphens]

let property_hyphenate_character : property_hyphenate_character Rule.rule =
  [%spec "'auto' | <string-token>"]

let property_hyphenate_character_runtime_module_path =
  Some [%module_path Css_types.HyphenateCharacter]

let property_hyphenate_limit_chars : property_hyphenate_limit_chars Rule.rule =
  [%spec "'auto' | <integer>"]

let property_hyphenate_limit_chars_runtime_module_path =
  Some [%module_path Css_types.HyphenateLimitChars]

let property_hyphenate_limit_lines : property_hyphenate_limit_lines Rule.rule =
  [%spec "'no-limit' | <integer>"]

let property_hyphenate_limit_lines_runtime_module_path =
  Some [%module_path Css_types.HyphenateLimitLines]

let property_hyphenate_limit_zone : property_hyphenate_limit_zone Rule.rule =
  [%spec "<extended-length> | <extended-percentage>"]

let property_hyphenate_limit_zone_runtime_module_path =
  Some [%module_path Css_types.HyphenateLimitZone]

let property_image_orientation : property_image_orientation Rule.rule =
  [%spec "'from-image' | <extended-angle> | [ <extended-angle> ]? 'flip'"]

let property_image_orientation_runtime_module_path =
  Some [%module_path Css_types.ImageOrientation]

let property_image_rendering : property_image_rendering Rule.rule =
  [%spec "'auto' |'smooth' | 'high-quality' | 'crisp-edges' | 'pixelated'"]

let property_image_rendering_runtime_module_path =
  Some [%module_path Css_types.ImageRendering]

let property_image_resolution : property_image_resolution Rule.rule =
  [%spec "[ 'from-image' || <resolution> ] && [ 'snap' ]?"]

let property_image_resolution_runtime_module_path =
  Some [%module_path Css_types.ImageResolution]
...
let property_initial_letter_align_runtime_module_path =
  Some [%module_path Css_types.InitialLetterAlign]
...
let property_inset_runtime_module_path = Some [%module_path Css_types.Inset]
...
let property_justify_content_runtime_module_path =
  Some [%module_path Css_types.JustifyContent]
...
let property_kerning_runtime_module_path = Some [%module_path Css_types.Kerning]
...
let property_layout_grid_char_runtime_module_path =
  Some [%module_path Css_types.LayoutGridChar]

let property_layout_grid_line : property_layout_grid_line Rule.rule =
  [%spec "'auto' | <custom-ident> | <string>"]

let property_layout_grid_line_runtime_module_path =
  Some [%module_path Css_types.LayoutGridLine]

let property_layout_grid_mode : property_layout_grid_mode Rule.rule =
  [%spec "'auto' | <custom-ident> | <string>"]

let property_layout_grid_mode_runtime_module_path =
  Some [%module_path Css_types.LayoutGridMode]

let property_layout_grid_type : property_layout_grid_type Rule.rule =
  [%spec "'auto' | <custom-ident> | <string>"]

let property_layout_grid_type_runtime_module_path =
  Some [%module_path Css_types.LayoutGridType]

let property_left : property_left Rule.rule =
  [%spec "<extended-length> | <extended-percentage> | 'auto'"]

let property_left_runtime_module_path = Some [%module_path Css_types.Left]
...
let property_line_height_step_runtime_module_path =
  Some [%module_path Css_types.LineHeightStep]
...
let property_list_style_image_runtime_module_path =
  Some [%module_path Css_types.ListStyleImage]

let property_list_style_position : property_list_style_position Rule.rule =
  [%spec "'inside' | 'outside'"]

let property_list_style_position_runtime_module_path =
  Some [%module_path Css_types.ListStylePosition]

let property_list_style_type : property_list_style_type Rule.rule =
  [%spec "<counter-style> | <string> | 'none'"]

let property_list_style_type_runtime_module_path =
  Some [%module_path Css_types.ListStyleType]
...
let property_margin_runtime_module_path = Some [%module_path Css_types.Margin]
...
let property_mask_border_mode_runtime_module_path =
  Some [%module_path Css_types.MaskBorderMode]

let property_mask_border_outset : property_mask_border_outset Rule.rule =
  [%spec "[ <extended-length> | <number> ]{1,4}"]

let property_mask_border_outset_runtime_module_path =
  Some [%module_path Css_types.MaskBorderOutset]

let property_mask_border_repeat : property_mask_border_repeat Rule.rule =
  [%spec "[ 'stretch' | 'repeat' | 'round' | 'space' ]{1,2}"]

let property_mask_border_repeat_runtime_module_path =
  Some [%module_path Css_types.MaskBorderRepeat]

let property_mask_border_slice : property_mask_border_slice Rule.rule =
  [%spec "[ <number-percentage> ]{1,4} [ 'fill' ]?"]

let property_mask_border_slice_runtime_module_path =
  Some [%module_path Css_types.MaskBorderSlice]

let property_mask_border_source : property_mask_border_source Rule.rule =
  [%spec "'none' | <image>"]

let property_mask_border_source_runtime_module_path =
  Some [%module_path Css_types.MaskBorderSource]

let property_mask_border_width : property_mask_border_width Rule.rule =
  [%spec
    "[ <extended-length> | <extended-percentage> | <number> | 'auto' ]{1,4}"]

let property_mask_border_width_runtime_module_path =
  Some [%module_path Css_types.MaskBorderWidth]
...
let property_masonry_auto_flow_runtime_module_path =
  Some [%module_path Css_types.MasonryAutoFlow]
...
let property_media_any_hover_runtime_module_path =
  Some [%module_path Css_types.MediaAnyHover]

let property_media_any_pointer : property_media_any_pointer Rule.rule =
  [%spec "none | coarse | fine"]

let property_media_any_pointer_runtime_module_path =
  Some [%module_path Css_types.MediaAnyPointer]
...
let property_media_max_aspect_ratio_runtime_module_path =
  Some [%module_path Css_types.MediaMaxAspectRatio]

let property_media_min_aspect_ratio : property_media_min_aspect_ratio Rule.rule
    =
  [%spec "<ratio>"]

let property_media_min_aspect_ratio_runtime_module_path =
  Some [%module_path Css_types.MediaMinAspectRatio]

let property_media_min_color : property_media_min_color Rule.rule =
  [%spec "<integer>"]

let property_media_min_color_runtime_module_path =
  Some [%module_path Css_types.MediaMinColor]

let property_media_color_gamut : property_media_color_gamut Rule.rule =
  [%spec "'srgb' | 'p3' | 'rec2020'"]

let property_media_color_gamut_runtime_module_path =
  Some [%module_path Css_types.MediaColorGamut]

let property_media_color_index : property_media_color_index Rule.rule =
  [%spec "<integer>"]

let property_media_color_index_runtime_module_path =
  Some [%module_path Css_types.MediaColorIndex]

let property_media_min_color_index : property_media_min_color_index Rule.rule =
  [%spec "<integer>"]

let property_media_min_color_index_runtime_module_path =
  Some [%module_path Css_types.MediaMinColorIndex]

let property_media_display_mode : property_media_display_mode Rule.rule =
  [%spec "'fullscreen' | 'standalone' | 'minimal-ui' | 'browser'"]

let property_media_display_mode_runtime_module_path =
  Some [%module_path Css_types.MediaDisplayMode]

let property_media_forced_colors : property_media_forced_colors Rule.rule =
  [%spec "'none' | 'active'"]

let property_media_forced_colors_runtime_module_path =
  Some [%module_path Css_types.MediaForcedColors]

let property_forced_color_adjust : property_forced_color_adjust Rule.rule =
  [%spec "'auto' | 'none' | 'preserve-parent-color'"]

let property_forced_color_adjust_runtime_module_path =
...
let property_media_inverted_colors_runtime_module_path =
  Some [%module_path Css_types.MediaInvertedColors]

let property_media_monochrome : property_media_monochrome Rule.rule =
  [%spec "<integer>"]

let property_media_monochrome_runtime_module_path =
  Some [%module_path Css_types.MediaMonochrome]

let property_media_prefers_color_scheme :
  property_media_prefers_color_scheme Rule.rule =
  [%spec "'dark' | 'light'"]

let property_media_prefers_color_scheme_runtime_module_path =
  Some [%module_path Css_types.MediaPrefersColorScheme]
...
let property_media_prefers_contrast_runtime_module_path =
  Some [%module_path Css_types.MediaPrefersContrast]

let property_media_prefers_reduced_motion :
  property_media_prefers_reduced_motion Rule.rule =
  [%spec "'no-preference' | 'reduce'"]

let property_media_prefers_reduced_motion_runtime_module_path =
  Some [%module_path Css_types.MediaPrefersReducedMotion]

let property_media_resolution : property_media_resolution Rule.rule =
  [%spec "<resolution>"]

let property_media_resolution_runtime_module_path =
  Some [%module_path Css_types.MediaResolution]

let property_media_min_resolution : property_media_min_resolution Rule.rule =
  [%spec "<resolution>"]

let property_media_min_resolution_runtime_module_path =
  Some [%module_path Css_types.MediaMinResolution]

let property_media_max_resolution : property_media_max_resolution Rule.rule =
  [%spec "<resolution>"]

let property_media_max_resolution_runtime_module_path =
  Some [%module_path Css_types.MediaMaxResolution]

let property_media_scripting : property_media_scripting Rule.rule =
  [%spec "'none' | 'initial-only' | 'enabled'"]

let property_media_scripting_runtime_module_path =
  Some [%module_path Css_types.MediaScripting]
...
let property_media_orientation_runtime_module_path =
  Some [%module_path Css_types.MediaOrientation]
...
let property_object_position_runtime_module_path =
  Some [%module_path Css_types.ObjectPosition]
...
let property_offset_runtime_module_path = Some [%module_path Css_types.Offset]
...
let property_offset_distance_runtime_module_path =
  Some [%module_path Css_types.OffsetDistance]
...
let property_offset_position_runtime_module_path =
  Some [%module_path Css_types.OffsetPosition]
...
let property_orphans_runtime_module_path = Some [%module_path Css_types.Orphans]
...
let property_outline_runtime_module_path = Some [%module_path Css_types.Outline]
...
let property_overflow_anchor_runtime_module_path =
  Some [%module_path Css_types.OverflowAnchor]
...
let property_overflow_clip_margin_runtime_module_path =
  Some [%module_path Css_types.OverflowClipMargin]

let property_overflow_inline : property_overflow_inline Rule.rule =
  [%spec "'visible' | 'hidden' | 'clip' | 'scroll' | 'auto' | <interpolation>"]

let property_overflow_inline_runtime_module_path =
  Some [%module_path Css_types.OverflowInline]
...
let property_overscroll_behavior_runtime_module_path =
  Some [%module_path Css_types.OverscrollBehavior]

let property_overscroll_behavior_block :
  property_overscroll_behavior_block Rule.rule =
  [%spec "'contain' | 'none' | 'auto'"]

let property_overscroll_behavior_block_runtime_module_path =
  Some [%module_path Css_types.OverscrollBehaviorBlock]

let property_overscroll_behavior_inline :
  property_overscroll_behavior_inline Rule.rule =
  [%spec "'contain' | 'none' | 'auto'"]

let property_overscroll_behavior_inline_runtime_module_path =
  Some [%module_path Css_types.OverscrollBehaviorInline]

let property_overscroll_behavior_x : property_overscroll_behavior_x Rule.rule =
  [%spec "'contain' | 'none' | 'auto'"]

let property_overscroll_behavior_x_runtime_module_path =
  Some [%module_path Css_types.OverscrollBehaviorX]

let property_overscroll_behavior_y : property_overscroll_behavior_y Rule.rule =
  [%spec "'contain' | 'none' | 'auto'"]

let property_overscroll_behavior_y_runtime_module_path =
  Some [%module_path Css_types.OverscrollBehaviorY]

let property_padding : property_padding Rule.rule =
  [%spec "[ <extended-length> | <extended-percentage> | <interpolation> ]{1,4}"]

let property_padding_runtime_module_path = Some [%module_path Css_types.Padding]
...
let property_page_break_after_runtime_module_path =
  Some [%module_path Css_types.PageBreakAfter]

let property_page_break_before : property_page_break_before Rule.rule =
  [%spec "'auto' | 'always' | 'avoid' | 'left' | 'right' | 'recto' | 'verso'"]

let property_page_break_before_runtime_module_path =
  Some [%module_path Css_types.PageBreakBefore]

let property_page_break_inside : property_page_break_inside Rule.rule =
  [%spec "'auto' | 'avoid'"]

let property_page_break_inside_runtime_module_path =
  Some [%module_path Css_types.PageBreakInside]
...
let property_pause_runtime_module_path = Some [%module_path Css_types.Pause]
...
let property_perspective_origin_runtime_module_path =
  Some [%module_path Css_types.PerspectiveOrigin]
...
let property_quotes_runtime_module_path = Some [%module_path Css_types.Quotes]

let property_resize : property_resize Rule.rule =
  [%spec "'none' | 'both' | 'horizontal' | 'vertical' | 'block' | 'inline'"]

let property_resize_runtime_module_path = Some [%module_path Css_types.Resize]

let property_rest : property_rest Rule.rule =
  [%spec "<'rest-before'> [ <'rest-after'> ]?"]

let property_rest_runtime_module_path = Some [%module_path Css_types.Rest]
...
let property_right_runtime_module_path = Some [%module_path Css_types.Right]
...
let property_rotate_runtime_module_path = Some [%module_path Css_types.Rotate]
...
let property_scale_runtime_module_path = Some [%module_path Css_types.Scale]

let property_scroll_behavior : property_scroll_behavior Rule.rule =
  [%spec "'auto' | 'smooth'"]

let property_scroll_behavior_runtime_module_path =
  Some [%module_path Css_types.ScrollBehavior]
...
let property_scroll_snap_align_runtime_module_path =
  Some [%module_path Css_types.ScrollSnapAlign]

let property_scroll_snap_coordinate : property_scroll_snap_coordinate Rule.rule
    =
  [%spec "'none' | [ <position> ]#"]

let property_scroll_snap_coordinate_runtime_module_path =
  Some [%module_path Css_types.ScrollSnapCoordinate]

let property_scroll_snap_destination :
  property_scroll_snap_destination Rule.rule =
  [%spec "<position>"]

let property_scroll_snap_destination_runtime_module_path =
  Some [%module_path Css_types.ScrollSnapDestination]
...
let property_scroll_snap_points_x_runtime_module_path =
  Some [%module_path Css_types.ScrollSnapPointsX]

let property_scroll_snap_points_y : property_scroll_snap_points_y Rule.rule =
  [%spec "'none' | repeat( <extended-length> | <extended-percentage> )"]

let property_scroll_snap_points_y_runtime_module_path =
  Some [%module_path Css_types.ScrollSnapPointsY]

let property_scroll_snap_stop : property_scroll_snap_stop Rule.rule =
  [%spec "'normal' | 'always'"]

let property_scroll_snap_stop_runtime_module_path =
  Some [%module_path Css_types.ScrollSnapStop]
...
let property_scroll_snap_type_runtime_module_path =
  Some [%module_path Css_types.ScrollSnapType]
...
let property_scrollbar_color_runtime_module_path =
  Some [%module_path Css_types.ScrollbarColor]

let property_scrollbar_width : property_scrollbar_width Rule.rule =
  [%spec "'auto' | 'thin' | 'none'"]

let property_scrollbar_width_runtime_module_path =
  Some [%module_path Css_types.ScrollbarWidth]

let property_scrollbar_gutter : property_scrollbar_gutter Rule.rule =
  [%spec "'auto' | 'stable' && 'both-edges'?"]

let property_scrollbar_gutter_runtime_module_path =
  Some [%module_path Css_types.ScrollbarGutter]

let property_scrollbar_3dlight_color :
  property_scrollbar_3dlight_color Rule.rule =
  [%spec "<color>"]

let property_scrollbar_3dlight_color_runtime_module_path =
  Some [%module_path Css_types.Scrollbar3dlightColor]

let property_scrollbar_arrow_color : property_scrollbar_arrow_color Rule.rule =
  [%spec "<color>"]

let property_scrollbar_arrow_color_runtime_module_path =
  Some [%module_path Css_types.ScrollbarArrowColor]

let property_scrollbar_base_color : property_scrollbar_base_color Rule.rule =
  [%spec "<color>"]

let property_scrollbar_base_color_runtime_module_path =
  Some [%module_path Css_types.ScrollbarBaseColor]

let property_scrollbar_darkshadow_color :
  property_scrollbar_darkshadow_color Rule.rule =
  [%spec "<color>"]

let property_scrollbar_darkshadow_color_runtime_module_path =
  Some [%module_path Css_types.ScrollbarDarkshadowColor]

let property_scrollbar_face_color : property_scrollbar_face_color Rule.rule =
  [%spec "<color>"]

let property_scrollbar_face_color_runtime_module_path =
  Some [%module_path Css_types.ScrollbarFaceColor]

let property_scrollbar_highlight_color :
  property_scrollbar_highlight_color Rule.rule =
  [%spec "<color>"]

let property_scrollbar_highlight_color_runtime_module_path =
  Some [%module_path Css_types.ScrollbarHighlightColor]

let property_scrollbar_shadow_color : property_scrollbar_shadow_color Rule.rule
    =
  [%spec "<color>"]

let property_scrollbar_shadow_color_runtime_module_path =
  Some [%module_path Css_types.ScrollbarShadowColor]

let property_scrollbar_track_color : property_scrollbar_track_color Rule.rule =
  [%spec "<color>"]

let property_scrollbar_track_color_runtime_module_path =
  Some [%module_path Css_types.ScrollbarTrackColor]

let property_shape_image_threshold : property_shape_image_threshold Rule.rule =
  [%spec "<alpha-value>"]

let property_shape_image_threshold_runtime_module_path =
  Some [%module_path Css_types.ShapeImageThreshold]
...
let property_shape_rendering_runtime_module_path =
  Some [%module_path Css_types.ShapeRendering]

let property_speak : property_speak Rule.rule =
  [%spec "'auto' | 'none' | 'normal'"]

let property_speak_runtime_module_path = Some [%module_path Css_types.Speak]
...
let property_src_runtime_module_path = Some [%module_path Css_types.Src]
let property_stroke : property_stroke Rule.rule = [%spec "<paint>"]
let property_stroke_runtime_module_path = Some [%module_path Css_types.Paint]
...
let property_stroke_dashoffset_runtime_module_path =
  Some [%module_path Css_types.StrokeDashoffset]
...
let property_stroke_linejoin_runtime_module_path =
  Some [%module_path Css_types.StrokeLinejoin]

let property_stroke_miterlimit : property_stroke_miterlimit Rule.rule =
  [%spec "<number-one-or-greater>"]

let property_stroke_miterlimit_runtime_module_path =
  Some [%module_path Css_types.StrokeMiterlimit]
...
let property_text_align_last_runtime_module_path =
  Some [%module_path Css_types.TextAlignLast]
...
let property_text_combine_upright_runtime_module_path =
  Some [%module_path Css_types.TextCombineUpright]
...
let property_text_decoration_runtime_module_path =
  Some [%module_path Css_types.TextDecoration]

let property_text_justify_trim : property_text_justify_trim Rule.rule =
  [%spec "'none' | 'all' | 'auto'"]

let property_text_justify_trim_runtime_module_path =
  Some [%module_path Css_types.TextJustifyTrim]
...
let property_text_kashida_space_runtime_module_path =
  Some [%module_path Css_types.TextKashidaSpace]
...
let property_text_decoration_line_runtime_module_path =
  Some [%module_path Css_types.TextDecorationLine]
...
let property_text_decoration_skip_runtime_module_path =
  Some [%module_path Css_types.TextDecorationSkip]
...
let property_text_decoration_skip_self_runtime_module_path =
  Some [%module_path Css_types.TextDecorationSkipSelf]

let property_text_decoration_skip_ink :
  property_text_decoration_skip_ink Rule.rule =
  [%spec "'auto' | 'all' | 'none'"]

let property_text_decoration_skip_ink_runtime_module_path =
  Some [%module_path Css_types.TextDecorationSkipInk]

let property_text_decoration_skip_box :
  property_text_decoration_skip_box Rule.rule =
  [%spec "'none' | 'all'"]

let property_text_decoration_skip_box_runtime_module_path =
  Some [%module_path Css_types.TextDecorationSkipBox]
...
let property_text_decoration_skip_spaces_runtime_module_path =
  Some [%module_path Css_types.TextDecorationSkipSpaces]

let property_text_decoration_skip_inset :
  property_text_decoration_skip_inset Rule.rule =
  [%spec "'none' | 'auto'"]

let property_text_decoration_skip_inset_runtime_module_path =
  Some [%module_path Css_types.TextDecorationSkipInset]

let property_text_decoration_style : property_text_decoration_style Rule.rule =
  [%spec "'solid' | 'double' | 'dotted' | 'dashed' | 'wavy'"]

let property_text_decoration_style_runtime_module_path =
  Some [%module_path Css_types.TextDecorationStyle]
...
let property_text_decoration_thickness_runtime_module_path =
  Some [%module_path Css_types.TextDecorationThickness]
...
let property_text_emphasis_position_runtime_module_path =
  Some [%module_path Css_types.TextEmphasisPosition]
...
let property_text_emphasis_style_runtime_module_path =
  Some [%module_path Css_types.TextEmphasisStyle]
...
let property_text_orientation_runtime_module_path =
  Some [%module_path Css_types.TextOrientation]
...
let property_text_size_adjust_runtime_module_path =
  Some [%module_path Css_types.TextSizeAdjust]
...
let property_text_underline_offset_runtime_module_path =
  Some [%module_path Css_types.TextUnderlineOffset]

let property_text_underline_position :
  property_text_underline_position Rule.rule =
  [%spec "'auto' | 'from-font' | 'under' || [ 'left' | 'right' ]"]

let property_text_underline_position_runtime_module_path =
  Some [%module_path Css_types.TextUnderlinePosition]

let property_top : property_top Rule.rule =
  [%spec "<extended-length> | <extended-percentage> | 'auto'"]

let property_top_runtime_module_path = Some [%module_path Css_types.Top]
...
let property_transform_origin_runtime_module_path =
  Some [%module_path Css_types.TransformOrigin]

let property_transform_style : property_transform_style Rule.rule =
  [%spec "'flat' | 'preserve-3d'"]

let property_transform_style_runtime_module_path =
  Some [%module_path Css_types.TransformStyle]
...
let property_transition_behavior_runtime_module_path =
  Some [%module_path Css_types.TransitionBehavior]

let property_transition_delay : property_transition_delay Rule.rule =
  [%spec "[ <extended-time> ]#"]

let property_transition_delay_runtime_module_path =
  Some [%module_path Css_types.TransitionDelay]

let property_transition_duration : property_transition_duration Rule.rule =
  [%spec "[ <extended-time> ]#"]

let property_transition_duration_runtime_module_path =
  Some [%module_path Css_types.TransitionDuration]
...
let property_transition_timing_function_runtime_module_path =
  Some [%module_path Css_types.TransitionTimingFunction]
...
let property_width_runtime_module_path = Some [%module_path Css_types.Width]
...
let property_z_index_runtime_module_path = Some [%module_path Css_types.ZIndex]

let property_zoom : property_zoom Rule.rule =
  [%spec "'normal' | 'reset' | <number> | <extended-percentage>"]

let property_zoom_runtime_module_path = Some [%module_path Css_types.Zoom]
...
let property_nav_up_runtime_module_path = Some [%module_path Css_types.NavUp]
...
let property_animation_composition_runtime_module_path =
  Some [%module_path Css_types.AnimationComposition]

let property_animation_range : property_animation_range Rule.rule =
  [%spec "[ 'normal' | <extended-length> | <extended-percentage> ]{1,2}"]

let property_animation_range_runtime_module_path =
  Some [%module_path Css_types.AnimationRange]

let property_animation_range_end : property_animation_range_end Rule.rule =
  [%spec "'normal' | <extended-length> | <extended-percentage>"]

let property_animation_range_end_runtime_module_path =
  Some [%module_path Css_types.AnimationRangeEnd]

let property_animation_range_start : property_animation_range_start Rule.rule =
  [%spec "'normal' | <extended-length> | <extended-percentage>"]

let property_animation_range_start_runtime_module_path =
  Some [%module_path Css_types.AnimationRangeStart]

let property_animation_timeline : property_animation_timeline Rule.rule =
  [%spec "[ 'none' | <custom-ident> ]#"]

let property_animation_timeline_runtime_module_path =
  Some [%module_path Css_types.AnimationTimeline]
...
let property_interpolate_size_runtime_module_path =
...
let property_scroll_timeline_runtime_module_path =
  Some [%module_path Css_types.ScrollTimeline]

let property_scroll_timeline_axis : property_scroll_timeline_axis Rule.rule =
  [%spec "[ 'block' | 'inline' | 'x' | 'y' ]#"]

let property_scroll_timeline_axis_runtime_module_path =
  Some [%module_path Css_types.ScrollTimelineAxis]

let property_scroll_timeline_name : property_scroll_timeline_name Rule.rule =
  [%spec "[ 'none' | <custom-ident> ]#"]

let property_scroll_timeline_name_runtime_module_path =
  Some [%module_path Css_types.ScrollTimelineName]
...
let property_view_timeline_axis_runtime_module_path =
  Some [%module_path Css_types.ViewTimelineAxis]

let property_view_timeline_inset : property_view_timeline_inset Rule.rule =
  [%spec "[ 'auto' | <extended-length> | <extended-percentage> ]{1,2}"]

let property_view_timeline_inset_runtime_module_path =
  Some [%module_path Css_types.ViewTimelineInset]

let property_view_timeline_name : property_view_timeline_name Rule.rule =
  [%spec "[ 'none' | <custom-ident> ]#"]

let property_view_timeline_name_runtime_module_path =
  Some [%module_path Css_types.ViewTimelineName]

let property_view_transition_name : property_view_transition_name Rule.rule =
  [%spec "'none' | <custom-ident>"]

let property_view_transition_name_runtime_module_path =
  Some [%module_path Css_types.ViewTransitionName]
...
let property_position_anchor_runtime_module_path =
  Some [%module_path Css_types.PositionAnchor]
...
let property_position_try_fallbacks_runtime_module_path =
  Some [%module_path Css_types.PositionTryFallbacks]

let property_position_try_options : property_position_try_options Rule.rule =
  [%spec "'none' | [ 'flip-block' || 'flip-inline' || 'flip-start' ]"]

let property_position_try_options_runtime_module_path =
  Some [%module_path Css_types.PositionTryOptions]
...
let property_position_visibility_runtime_module_path =
  Some [%module_path Css_types.PositionVisibility]
...
let property_scroll_start_block_runtime_module_path =
  Some [%module_path Css_types.ScrollStartBlock]
...
let property_scroll_start_inline_runtime_module_path =
  Some [%module_path Css_types.ScrollStartInline]
...
let property_scroll_start_target_runtime_module_path =
  Some [%module_path Css_types.ScrollStartTarget]

let property_scroll_start_target_block :
  property_scroll_start_target_block Rule.rule =
  [%spec "'none' | 'auto'"]

let property_scroll_start_target_block_runtime_module_path =
  Some [%module_path Css_types.ScrollStartTargetBlock]

let property_scroll_start_target_inline :
  property_scroll_start_target_inline Rule.rule =
  [%spec "'none' | 'auto'"]

let property_scroll_start_target_inline_runtime_module_path =
  Some [%module_path Css_types.ScrollStartTargetInline]

let property_scroll_start_target_x : property_scroll_start_target_x Rule.rule =
  [%spec "'none' | 'auto'"]

let property_scroll_start_target_x_runtime_module_path =
  Some [%module_path Css_types.ScrollStartTargetX]

let property_scroll_start_target_y : property_scroll_start_target_y Rule.rule =
  [%spec "'none' | 'auto'"]

let property_scroll_start_target_y_runtime_module_path =
  Some [%module_path Css_types.ScrollStartTargetY]

let property_text_spacing_trim : property_text_spacing_trim Rule.rule =
  [%spec "'normal' | 'space-all' | 'space-first' | 'trim-start'"]

let property_text_spacing_trim_runtime_module_path =
  Some [%module_path Css_types.TextSpacingTrim]
...
let property_word_space_transform_runtime_module_path =
  Some [%module_path Css_types.WordSpaceTransform]
...
let property_text_wrap_style_runtime_module_path =
  Some [%module_path Css_types.TextWrapStyle]
...
let property_white_space_collapse_runtime_module_path =
  Some [%module_path Css_types.WhiteSpaceCollapse]
...
let property_page_runtime_module_path = Some [%module_path Css_types.Page]
...
let property_size_runtime_module_path = Some [%module_path Css_types.Size]

let property_marks : property_marks Rule.rule =
  [%spec "'none' | 'crop' || 'cross'"]

let property_marks_runtime_module_path = Some [%module_path Css_types.Marks]

let property_bleed : property_bleed Rule.rule =
  [%spec "'auto' | <extended-length>"]

let property_bleed_runtime_module_path = Some [%module_path Css_types.Bleed]
...
let property_scrollbar_color_legacy_runtime_module_path =
  Some [%module_path Css_types.ScrollbarColorLegacy]
...
let property_color_rendering_runtime_module_path =
  Some [%module_path Css_types.ColorRendering]
...
let property_x_runtime_module_path = Some [%module_path Css_types.X]

let property_y : property_y Rule.rule =
  [%spec "<extended-length> | <extended-percentage>"]

let property_y_runtime_module_path = Some [%module_path Css_types.Y]
...
let property_contain_intrinsic_size_runtime_module_path =
  Some [%module_path Css_types.ContainIntrinsicSize]
...
let property_contain_intrinsic_width_runtime_module_path =
  Some [%module_path Css_types.ContainIntrinsicWidth]

let property_contain_intrinsic_height :
  property_contain_intrinsic_height Rule.rule =
  [%spec "'none' | 'auto' <extended-length> | <extended-length>"]

let property_contain_intrinsic_height_runtime_module_path =
  Some [%module_path Css_types.ContainIntrinsicHeight]

let property_contain_intrinsic_block_size :
  property_contain_intrinsic_block_size Rule.rule =
  [%spec "'none' | 'auto' <extended-length> | <extended-length>"]

let property_contain_intrinsic_block_size_runtime_module_path =
  Some [%module_path Css_types.ContainIntrinsicBlockSize]

let property_contain_intrinsic_inline_size :
  property_contain_intrinsic_inline_size Rule.rule =
  [%spec "'none' | 'auto' <extended-length> | <extended-length>"]

let property_contain_intrinsic_inline_size_runtime_module_path =
  Some [%module_path Css_types.ContainIntrinsicInlineSize]

(* Print *)
let property_print_color_adjust : property_print_color_adjust Rule.rule =
  [%spec "'economy' | 'exact'"]

let property_print_color_adjust_runtime_module_path =
  Some [%module_path Css_types.PrintColorAdjust]
...
let property_animation_delay_end_runtime_module_path =
  Some [%module_path Css_types.AnimationDelayEnd]

let property_animation_delay_start : property_animation_delay_start Rule.rule =
  [%spec "[ <extended-time> ]#"]

let property_animation_delay_start_runtime_module_path =
  Some [%module_path Css_types.AnimationDelayStart]
...
let property_scroll_marker_group_runtime_module_path =
  Some [%module_path Css_types.ScrollMarkerGroup]

let property_container_name_computed :
  property_container_name_computed Rule.rule =
  [%spec "'none' | [ <custom-ident> ]#"]

let property_container_name_computed_runtime_module_path =
  Some [%module_path Css_types.ContainerNameComputed]
...
let property_hyphenate_limit_last_runtime_module_path =
  Some [%module_path Css_types.HyphenateLimitLast]

let pseudo_class_selector : pseudo_class_selector Rule.rule =
  [%spec "':' <ident-token> | ':' <function-token> <any-value> ')'"]

let pseudo_class_selector_runtime_module_path =
  Some [%module_path Css_types.PseudoClassSelector]

let pseudo_element_selector : pseudo_element_selector Rule.rule =
  [%spec "':' <pseudo-class-selector>"]

let pseudo_element_selector_runtime_module_path =
  Some [%module_path Css_types.PseudoElementSelector]

let pseudo_page : pseudo_page Rule.rule =
  [%spec "':' [ 'left' | 'right' | 'first' | 'blank' ]"]

let pseudo_page_runtime_module_path = Some [%module_path Css_types.PseudoPage]

let quote : quote Rule.rule =
  [%spec "'open-quote' | 'close-quote' | 'no-open-quote' | 'no-close-quote'"]

let quote_runtime_module_path = Some [%module_path Css_types.Quote]

let ratio : ratio Rule.rule =
  [%spec "<integer> '/' <integer> | <number> | <interpolation>"]

let ratio_runtime_module_path = Some [%module_path Css_types.Ratio]
...
let relative_selector_list_runtime_module_path =
...
let repeat_style_runtime_module_path = Some [%module_path Css_types.RepeatStyle]
let right : right Rule.rule = [%spec "<extended-length> | 'auto'"]
let right_runtime_module_path = Some [%module_path Css_types.Right]
...
let shadow_t_runtime_module_path = Some [%module_path Css_types.TextShadow]
...
let shape_runtime_module_path = Some [%module_path Css_types.Shape]
let shape_box : shape_box Rule.rule = [%spec "<box> | 'margin-box'"]
let shape_box_runtime_module_path = Some [%module_path Css_types.ShapeBox]
...
let shape_radius_runtime_module_path = Some [%module_path Css_types.ShapeRadius]
...
let single_animation_no_interp_runtime_module_path =
  Some [%module_path Css_types.SingleAnimationNoInterp]
...
let single_animation_direction_runtime_module_path =
  Some [%module_path Css_types.SingleAnimationDirection]
...
let single_animation_direction_no_interp_runtime_module_path =
  Some [%module_path Css_types.SingleAnimationDirectionNoInterp]

let single_animation_fill_mode : single_animation_fill_mode Rule.rule =
  [%spec "'none' | 'forwards' | 'backwards' | 'both' | <interpolation>"]

let single_animation_fill_mode_runtime_module_path =
  Some [%module_path Css_types.SingleAnimationFillMode]

let single_animation_fill_mode_no_interp :
  single_animation_fill_mode_no_interp Rule.rule =
  [%spec "'none' | 'forwards' | 'backwards' | 'both'"]

let single_animation_fill_mode_no_interp_runtime_module_path =
  Some [%module_path Css_types.SingleAnimationFillModeNoInterp]

let single_animation_iteration_count :
  single_animation_iteration_count Rule.rule =
  [%spec "'infinite' | <number> | <interpolation>"]

let single_animation_iteration_count_runtime_module_path =
  Some [%module_path Css_types.SingleAnimationIterationCount]

let single_animation_iteration_count_no_interp :
  single_animation_iteration_count_no_interp Rule.rule =
  [%spec "'infinite' | <number>"]

let single_animation_iteration_count_no_interp_runtime_module_path =
  Some [%module_path Css_types.SingleAnimationIterationCountNoInterp]

let single_animation_play_state : single_animation_play_state Rule.rule =
  [%spec "'running' | 'paused' | <interpolation>"]

let single_animation_play_state_runtime_module_path =
  Some [%module_path Css_types.SingleAnimationPlayState]

let single_animation_play_state_no_interp :
  single_animation_play_state_no_interp Rule.rule =
  [%spec "'running' | 'paused'"]

let single_animation_play_state_no_interp_runtime_module_path =
  Some [%module_path Css_types.SingleAnimationPlayStateNoInterp]
...
let single_transition_no_interp_runtime_module_path =
  Some [%module_path Css_types.SingleTransitionNoInterp]
...
let single_transition_property_runtime_module_path =
  Some [%module_path Css_types.SingleTransitionProperty]

let single_transition_property_no_interp :
  single_transition_property_no_interp Rule.rule =
  [%spec "<custom-ident> | 'all'"]

let single_transition_property_no_interp_runtime_module_path =
  Some [%module_path Css_types.SingleTransitionPropertyNoInterp]
...
let size_runtime_module_path = Some [%module_path Css_types.Size]
...
let ray_size_runtime_module_path = Some [%module_path Css_types.RaySize]
...
let radial_size_runtime_module_path = Some [%module_path Css_types.RadialSize]
...
let step_timing_function_runtime_module_path =
  Some [%module_path Css_types.StepTimingFunction]
...
let supports_selector_fn_runtime_module_path =
  Some [%module_path Css_types.SupportsSelectorFn]

let svg_length : svg_length Rule.rule =
  [%spec "<extended-percentage> | <extended-length> | <number>"]

let svg_length_runtime_module_path = Some [%module_path Css_types.SvgLength]
...
let symbols_type_runtime_module_path = Some [%module_path Css_types.SymbolsType]

let target : target Rule.rule =
  [%spec "<target-counter()> | <target-counters()> | <target-text()>"]

let target_runtime_module_path = Some [%module_path Css_types.Target]
let url : url Rule.rule = [%spec "<url-no-interp> | url( <interpolation> )"]
let url_runtime_module_path = Some [%module_path Css_types.Url]
...
let extended_length_runtime_module_path = Some [%module_path Css_types.Length]
...
let extended_angle_runtime_module_path = Some [%module_path Css_types.Angle]

let extended_time : extended_time Rule.rule =
  [%spec "<time> | <calc()> | <interpolation> | <min()> | <max()>"]

let extended_time_runtime_module_path = Some [%module_path Css_types.Time]

let extended_time_no_interp : extended_time_no_interp Rule.rule =
  [%spec "<time> | <calc()> | <min()> | <max()>"]

let extended_time_no_interp_runtime_module_path =
  Some [%module_path Css_types.Time]

let extended_percentage : extended_percentage Rule.rule =
  [%spec "<percentage> | <calc()> | <interpolation> | <min()> | <max()> "]

let extended_percentage_runtime_module_path =
  Some [%module_path Css_types.Percentage]
...
let timing_function_no_interp_runtime_module_path =
  Some [%module_path Css_types.TimingFunctionNoInterp]

let top : top Rule.rule = [%spec "<extended-length> | 'auto'"]
let top_runtime_module_path = Some [%module_path Css_types.Top]

let try_tactic : try_tactic Rule.rule =
  [%spec "'flip-block' | 'flip-inline' | 'flip-start'"]

let try_tactic_runtime_module_path = Some [%module_path Css_types.TryTactic]
...
let track_group_runtime_module_path = Some [%module_path Css_types.TrackGroup]

let track_list : track_list Rule.rule =
  [%spec
    "[ [ <line-names> ]? [ <track-size> | <track-repeat> ] ]+ [ <line-names> ]?"]

let track_list_runtime_module_path = Some [%module_path Css_types.TrackList]
...
let track_minmax_runtime_module_path = Some [%module_path Css_types.TrackMinmax]
...
let track_repeat_runtime_module_path = Some [%module_path Css_types.TrackRepeat]
...
let track_size_runtime_module_path = Some [%module_path Css_types.TrackSize]
...
let transition_behavior_value_runtime_module_path =
  Some [%module_path Css_types.TransitionBehaviorValue]

let transition_behavior_value_no_interp :
  transition_behavior_value_no_interp Rule.rule =
  [%spec "'normal' | 'allow-discrete'"]

let transition_behavior_value_no_interp_runtime_module_path =
  Some [%module_path Css_types.TransitionBehaviorValueNoInterp]
...
let type_or_unit_runtime_module_path = Some [%module_path Css_types.TypeOrUnit]
...
let visual_box_runtime_module_path = Some [%module_path Css_types.VisualBox]
let wq_name : wq_name Rule.rule = [%spec "[ <ns-prefix> ]? <ident-token>"]
let wq_name_runtime_module_path = Some [%module_path Css_types.WqName]

let attr_name : attr_name Rule.rule =
  [%spec "[ <ident-token>? '|' ]? <ident-token>"]

let attr_name_runtime_module_path = Some [%module_path Css_types.AttrName]
...
let attr_unit_runtime_module_path = Some [%module_path Css_types.AttrUnit]
...
let syntax_single_component_runtime_module_path =
...
let syntax_runtime_module_path = Some [%module_path Css_types.Syntax]
...
let attr_type_runtime_module_path = Some [%module_path Css_types.AttrType]
let x : x Rule.rule = [%spec "<number>"]
let x_runtime_module_path = Some [%module_path Css_types.X]
let y : y Rule.rule = [%spec "<number>"]
let y_runtime_module_path = Some [%module_path Css_types.Y]
  ...
  [
    ...
    ( Property "display",
      pack_rule property_display
        ?runtime_module_path:property_display_runtime_module_path () );
    ( Property "overflow",
      pack_rule property_overflow
        ?runtime_module_path:property_overflow_runtime_module_path () );
    ( Property "position",
      pack_rule property_position
        ?runtime_module_path:property_position_runtime_module_path () );
    ( Property "visibility",
      pack_rule property_visibility
        ?runtime_module_path:property_visibility_runtime_module_path () );
    ( Property "float",
      pack_rule property_float
        ?runtime_module_path:property_float_runtime_module_path () );
    ( Property "clear",
      pack_rule property_clear
        ?runtime_module_path:property_clear_runtime_module_path () );
    ( Property "table-layout",
      pack_rule property_table_layout
        ?runtime_module_path:property_table_layout_runtime_module_path () );
    ( Property "border-collapse",
      pack_rule property_border_collapse
        ?runtime_module_path:property_border_collapse_runtime_module_path () );
    ( Property "empty-cells",
      pack_rule property_empty_cells
        ?runtime_module_path:property_empty_cells_runtime_module_path () );
    ( Property "caption-side",
      pack_rule property_caption_side
        ?runtime_module_path:property_caption_side_runtime_module_path () );
    ( Property "direction",
      pack_rule property_direction
        ?runtime_module_path:property_direction_runtime_module_path () );
    ( Property "unicode-bidi",
      pack_rule property_unicode_bidi
        ?runtime_module_path:property_unicode_bidi_runtime_module_path () );
    ( Property "writing-mode",
      pack_rule property_writing_mode
        ?runtime_module_path:property_writing_mode_runtime_module_path () );
    ( Property "text-orientation",
      pack_rule property_text_orientation
        ?runtime_module_path:property_text_orientation_runtime_module_path () );
    ( Property "text-transform",
      pack_rule property_text_transform
        ?runtime_module_path:property_text_transform_runtime_module_path () );
    ( Property "white-space",
      pack_rule property_white_space
        ?runtime_module_path:property_white_space_runtime_module_path () );
    ( Property "word-break",
      pack_rule property_word_break
        ?runtime_module_path:property_word_break_runtime_module_path () );
    ( Property "overflow-wrap",
      pack_rule property_overflow_wrap
        ?runtime_module_path:property_overflow_wrap_runtime_module_path () );
    ( Property "text-align",
      pack_rule property_text_align
        ?runtime_module_path:property_text_align_runtime_module_path () );
    ( Property "text-align-last",
      pack_rule property_text_align_last
        ?runtime_module_path:property_text_align_last_runtime_module_path () );
    ( Property "text-justify",
      pack_rule property_text_justify
        ?runtime_module_path:property_text_justify_runtime_module_path () );
    ( Property "text-decoration-line",
      pack_rule property_text_decoration_line
        ?runtime_module_path:property_text_decoration_line_runtime_module_path
        () );
    ( Property "text-decoration-style",
      pack_rule property_text_decoration_style
        ?runtime_module_path:property_text_decoration_style_runtime_module_path
        () );
    ( Property "text-decoration-skip-ink",
      pack_rule property_text_decoration_skip_ink
        ?runtime_module_path:
          property_text_decoration_skip_ink_runtime_module_path () );
    ( Property "font-style",
      pack_rule property_font_style
        ?runtime_module_path:property_font_style_runtime_module_path () );
    ( Property "font-variant-caps",
      pack_rule property_font_variant_caps
        ?runtime_module_path:property_font_variant_caps_runtime_module_path () );
    ( Property "font-stretch",
      pack_rule property_font_stretch
        ?runtime_module_path:property_font_stretch_runtime_module_path () );
    ( Property "font-kerning",
      pack_rule property_font_kerning
        ?runtime_module_path:property_font_kerning_runtime_module_path () );
    ( Property "font-variant-position",
      pack_rule property_font_variant_position
        ?runtime_module_path:property_font_variant_position_runtime_module_path
        () );
    ( Property "list-style-position",
      pack_rule property_list_style_position
        ?runtime_module_path:property_list_style_position_runtime_module_path ()
    );
    ( Property "list-style-type",
      pack_rule property_list_style_type
        ?runtime_module_path:property_list_style_type_runtime_module_path () );
    ( Property "pointer-events",
      pack_rule property_pointer_events
        ?runtime_module_path:property_pointer_events_runtime_module_path () );
    ( Property "user-select",
      pack_rule property_user_select
        ?runtime_module_path:property_user_select_runtime_module_path () );
    ( Property "resize",
      pack_rule property_resize
        ?runtime_module_path:property_resize_runtime_module_path () );
    ( Property "box-sizing",
      pack_rule property_box_sizing
        ?runtime_module_path:property_box_sizing_runtime_module_path () );
    ( Property "object-fit",
      pack_rule property_object_fit
        ?runtime_module_path:property_object_fit_runtime_module_path () );
    ( Property "isolation",
      pack_rule property_isolation
        ?runtime_module_path:property_isolation_runtime_module_path () );
    ( Property "mix-blend-mode",
      pack_rule property_mix_blend_mode
        ?runtime_module_path:property_mix_blend_mode_runtime_module_path () );
    ( Property "backface-visibility",
      pack_rule property_backface_visibility
        ?runtime_module_path:property_backface_visibility_runtime_module_path ()
    );
    ( Property "flex-direction",
      pack_rule property_flex_direction
        ?runtime_module_path:property_flex_direction_runtime_module_path () );
    ( Property "flex-wrap",
      pack_rule property_flex_wrap
        ?runtime_module_path:property_flex_wrap_runtime_module_path () );
    ( Property "justify-content",
      pack_rule property_justify_content
        ?runtime_module_path:property_justify_content_runtime_module_path () );
    ( Property "align-items",
      pack_rule property_align_items
        ?runtime_module_path:property_align_items_runtime_module_path () );
    ( Property "align-content",
      pack_rule property_align_content
        ?runtime_module_path:property_align_content_runtime_module_path () );
    ( Property "align-self",
      pack_rule property_align_self
        ?runtime_module_path:property_align_self_runtime_module_path () );
    ( Property "justify-items",
      pack_rule property_justify_items
        ?runtime_module_path:property_justify_items_runtime_module_path () );
    ( Property "justify-self",
      pack_rule property_justify_self
        ?runtime_module_path:property_justify_self_runtime_module_path () );
    ( Property "scroll-behavior",
      pack_rule property_scroll_behavior
        ?runtime_module_path:property_scroll_behavior_runtime_module_path () );
    ( Property "overscroll-behavior",
      pack_rule property_overscroll_behavior
        ?runtime_module_path:property_overscroll_behavior_runtime_module_path ()
    );
    ( Property "overflow-anchor",
      pack_rule property_overflow_anchor
        ?runtime_module_path:property_overflow_anchor_runtime_module_path () );
    ( Property "touch-action",
      pack_rule property_touch_action
        ?runtime_module_path:property_touch_action_runtime_module_path () );
    ( Property "caret-color",
      pack_rule property_caret_color
        ?runtime_module_path:property_caret_color_runtime_module_path () );
    ( Property "appearance",
      pack_rule property_appearance
        ?runtime_module_path:property_appearance_runtime_module_path () );
    ( Property "text-rendering",
      pack_rule property_text_rendering
        ?runtime_module_path:property_text_rendering_runtime_module_path () );
    ( Property "image-rendering",
      pack_rule property_image_rendering
        ?runtime_module_path:property_image_rendering_runtime_module_path () );
    ( Property "color-scheme",
      pack_rule property_color_scheme
        ?runtime_module_path:property_color_scheme_runtime_module_path () );
    ( Property "forced-color-adjust",
      pack_rule property_forced_color_adjust
        ?runtime_module_path:property_forced_color_adjust_runtime_module_path ()
    );
    ( Property "print-color-adjust",
      pack_rule property_print_color_adjust
        ?runtime_module_path:property_print_color_adjust_runtime_module_path ()
    );
    ( Property "contain-intrinsic-size",
      pack_rule property_contain_intrinsic_size
        ?runtime_module_path:property_contain_intrinsic_size_runtime_module_path
        () );
    ( Property "content-visibility",
      pack_rule property_content_visibility
        ?runtime_module_path:property_content_visibility_runtime_module_path ()
    );
    ( Property "hyphens",
      pack_rule property_hyphens
        ?runtime_module_path:property_hyphens_runtime_module_path () );
    ( Property "column-fill",
      pack_rule property_column_fill
        ?runtime_module_path:property_column_fill_runtime_module_path () );
    ( Property "column-span",
      pack_rule property_column_span
        ?runtime_module_path:property_column_span_runtime_module_path () );
    ( Property "clip-rule",
      pack_rule property_clip_rule
        ?runtime_module_path:property_clip_rule_runtime_module_path () );
    ( Property "font-optical-sizing",
      pack_rule property_font_optical_sizing
        ?runtime_module_path:property_font_optical_sizing_runtime_module_path ()
    );
    ( Property "font-palette",
      pack_rule property_font_palette
        ?runtime_module_path:property_font_palette_runtime_module_path () );
    ( Property "font-synthesis-weight",
      pack_rule property_font_synthesis_weight
        ?runtime_module_path:property_font_synthesis_weight_runtime_module_path
        () );
    ( Property "font-synthesis-style",
      pack_rule property_font_synthesis_style
        ?runtime_module_path:property_font_synthesis_style_runtime_module_path
        () );
    ( Property "font-synthesis-small-caps",
      pack_rule property_font_synthesis_small_caps
        ?runtime_module_path:
          property_font_synthesis_small_caps_runtime_module_path () );
    ( Property "font-synthesis-position",
      pack_rule property_font_synthesis_position
        ?runtime_module_path:
          property_font_synthesis_position_runtime_module_path () );
    ( Property "mask-border-mode",
      pack_rule property_mask_border_mode
        ?runtime_module_path:property_mask_border_mode_runtime_module_path () );
    ( Property "mask-type",
      pack_rule property_mask_type
        ?runtime_module_path:property_mask_type_runtime_module_path () );
    ( Property "ruby-merge",
      pack_rule property_ruby_merge
        ?runtime_module_path:property_ruby_merge_runtime_module_path () );
    ( Property "ruby-position",
      pack_rule property_ruby_position
        ?runtime_module_path:property_ruby_position_runtime_module_path () );
    ( Property "scroll-snap-stop",
      pack_rule property_scroll_snap_stop
        ?runtime_module_path:property_scroll_snap_stop_runtime_module_path () );
    ( Property "scrollbar-width",
      pack_rule property_scrollbar_width
        ?runtime_module_path:property_scrollbar_width_runtime_module_path () );
    ( Property "speak",
      pack_rule property_speak
        ?runtime_module_path:property_speak_runtime_module_path () );
    ( Property "stroke-linecap",
      pack_rule property_stroke_linecap
        ?runtime_module_path:property_stroke_linecap_runtime_module_path () );
    ( Property "box-decoration-break",
      pack_rule property_box_decoration_break
        ?runtime_module_path:property_box_decoration_break_runtime_module_path
        () );
    ( Property "color-adjust",
      pack_rule property_color_adjust
        ?runtime_module_path:property_color_adjust_runtime_module_path () );
    ( Property "text-decoration-thickness",
      pack_rule property_text_decoration_thickness
        ?runtime_module_path:
          property_text_decoration_thickness_runtime_module_path () );
    ( Property "text-underline-position",
      pack_rule property_text_underline_position
        ?runtime_module_path:
          property_text_underline_position_runtime_module_path () );
    ( Property "word-wrap",
      pack_rule property_word_wrap
        ?runtime_module_path:property_word_wrap_runtime_module_path () );
    ( Property "break-inside",
      pack_rule property_break_inside
        ?runtime_module_path:property_break_inside_runtime_module_path () );
    ( Property "break-before",
      pack_rule property_break_before
        ?runtime_module_path:property_break_before_runtime_module_path () );
    ( Property "break-after",
      pack_rule property_break_after
        ?runtime_module_path:property_break_after_runtime_module_path () );
    ( Property "page-break-after",
      pack_rule property_page_break_after
        ?runtime_module_path:property_page_break_after_runtime_module_path () );
    ( Property "page-break-before",
      pack_rule property_page_break_before
        ?runtime_module_path:property_page_break_before_runtime_module_path () );
    ( Property "page-break-inside",
      pack_rule property_page_break_inside
        ?runtime_module_path:property_page_break_inside_runtime_module_path () );
    ( Property "border-image-repeat",
      pack_rule property_border_image_repeat
        ?runtime_module_path:property_border_image_repeat_runtime_module_path ()
    );
    ( Property "transform-style",
      pack_rule property_transform_style
        ?runtime_module_path:property_transform_style_runtime_module_path () );
    ( Property "transform-box",
      pack_rule property_transform_box
        ?runtime_module_path:property_transform_box_runtime_module_path () );
    ( Property "grid-auto-flow",
      pack_rule property_grid_auto_flow
        ?runtime_module_path:property_grid_auto_flow_runtime_module_path () );
    ( Property "font-display",
      pack_rule property_font_display
        ?runtime_module_path:property_font_display_runtime_module_path () );
    ( Property "will-change",
      pack_rule property_will_change
        ?runtime_module_path:property_will_change_runtime_module_path () );
    ( Property "contain",
      pack_rule property_contain
        ?runtime_module_path:property_contain_runtime_module_path () );
    ( Property "all",
      pack_rule property_all
        ?runtime_module_path:property_all_runtime_module_path () );
    (* Values with runtime types *)
    Value "age", pack_rule age ?runtime_module_path:age_runtime_module_path ();
    ( Value "attachment",
      pack_rule attachment ?runtime_module_path:attachment_runtime_module_path
        () );
    Value "box", pack_rule box ?runtime_module_path:box_runtime_module_path ();
    ( Value "display-box",
      pack_rule display_box ?runtime_module_path:display_box_runtime_module_path
        () );
    ( Value "display-outside",
      pack_rule display_outside
        ?runtime_module_path:display_outside_runtime_module_path () );
    ( Value "ending-shape",
      pack_rule ending_shape
        ?runtime_module_path:ending_shape_runtime_module_path () );
    ( Value "fill-rule",
      pack_rule fill_rule ?runtime_module_path:fill_rule_runtime_module_path ()
    );
    Value "zero", pack_rule zero ();
    ( Value "gender",
      pack_rule gender ?runtime_module_path:gender_runtime_module_path () );
    ( Value "combinator",
      pack_rule combinator ?runtime_module_path:combinator_runtime_module_path
        () );
    ( Value "contextual-alt-values",
      pack_rule contextual_alt_values
        ?runtime_module_path:contextual_alt_values_runtime_module_path () );
    ( Value "east-asian-width-values",
      pack_rule east_asian_width_values
        ?runtime_module_path:east_asian_width_values_runtime_module_path () );
    ( Value "attr-modifier",
      pack_rule attr_modifier
        ?runtime_module_path:attr_modifier_runtime_module_path () );
    ( Value "image-tags",
      pack_rule image_tags ?runtime_module_path:image_tags_runtime_module_path
        () );
    ( Value "line-style",
      pack_rule line_style ?runtime_module_path:line_style_runtime_module_path
        () );
    ( Value "line-width",
      pack_rule line_width ?runtime_module_path:line_width_runtime_module_path
        () );
    ( Value "named-color",
      pack_rule named_color ?runtime_module_path:named_color_runtime_module_path
        () );
    ( Value "color",
      pack_rule color ?runtime_module_path:color_runtime_module_path () );
    ( Value "alpha-value",
      pack_rule alpha_value ?runtime_module_path:alpha_value_runtime_module_path
        () );
    Value "hue", pack_rule hue ?runtime_module_path:hue_runtime_module_path ();
    ( Value "bg-image",
      pack_rule bg_image ?runtime_module_path:bg_image_runtime_module_path () );
    ( Value "content-replacement",
      pack_rule content_replacement
        ?runtime_module_path:content_replacement_runtime_module_path () );
    ( Value "transform-list",
      pack_rule transform_list
        ?runtime_module_path:transform_list_runtime_module_path () );
    ( Value "transform-function",
      pack_rule transform_function
        ?runtime_module_path:transform_function_runtime_module_path () );
    ( Value "image",
      pack_rule image ?runtime_module_path:image_runtime_module_path () );
    ( Value "font_families",
      pack_rule font_families
        ?runtime_module_path:font_families_runtime_module_path () );
    ( Value "color-interpolation-method",
      pack_rule color_interpolation_method
        ?runtime_module_path:color_interpolation_method_runtime_module_path () );
    ...
    ( Property "outline-style",
      pack_rule property_outline_style
        ?runtime_module_path:property_outline_style_runtime_module_path () );
    ( Property "width",
      pack_rule property_width
        ?runtime_module_path:property_width_runtime_module_path () );
    Property "border", pack_rule property_border ();
    ( Property "flex-grow",
      pack_rule property_flex_grow
        ?runtime_module_path:property_flex_grow_runtime_module_path () );
    ( Property "flex-shrink",
      pack_rule property_flex_shrink
        ?runtime_module_path:property_flex_shrink_runtime_module_path () );
    ( Property "flex-basis",
      pack_rule property_flex_basis
        ?runtime_module_path:property_flex_basis_runtime_module_path () );
    ( Value "family-name",
      pack_rule family_name ?runtime_module_path:family_name_runtime_module_path
        () );
    ( Value "keyframes-name",
      pack_rule keyframes_name
        ?runtime_module_path:keyframes_name_runtime_module_path () );
    Value "url", pack_rule url ?runtime_module_path:url_runtime_module_path ();
    (* Image functions *)
    ( Function "image()",
      pack_rule function_image
        ?runtime_module_path:function_image_runtime_module_path () );
    Function "image-set()", pack_rule function_image_set ();
    Function "element()", pack_rule function_element ();
    ( Function "paint()",
      pack_rule function_paint
        ?runtime_module_path:function_paint_runtime_module_path () );
    Function "cross-fade()", pack_rule function_cross_fade ();
    (* Gradient and other values *)
    ( Value "gradient",
      pack_rule gradient ?runtime_module_path:gradient_runtime_module_path () );
    Value "shadow", pack_rule shadow ();
    ( Value "track-list",
      pack_rule track_list ?runtime_module_path:track_list_runtime_module_path
        () );
    ( Value "line-names",
      pack_rule line_names ?runtime_module_path:line_names_runtime_module_path
        () );
    ( Value "side-or-corner",
      pack_rule side_or_corner
        ?runtime_module_path:side_or_corner_runtime_module_path () );
    ( Value "track-size",
      pack_rule track_size ?runtime_module_path:track_size_runtime_module_path
        () );
    ( Value "track-breadth",
      pack_rule track_breadth
        ?runtime_module_path:track_breadth_runtime_module_path () );
    ( Value "track-repeat",
      pack_rule track_repeat
        ?runtime_module_path:track_repeat_runtime_module_path () );
    ( Value "content-list",
      pack_rule content_list
        ?runtime_module_path:content_list_runtime_module_path () );
    ( Value "mask-reference",
      pack_rule mask_reference
        ?runtime_module_path:mask_reference_runtime_module_path () );
    ( Value "color-stop-list",
      pack_rule color_stop_list
        ?runtime_module_path:color_stop_list_runtime_module_path () );
    ( Value "mask-source",
      pack_rule mask_source ?runtime_module_path:mask_source_runtime_module_path
        () );
    ( Value "length-percentage",
      pack_rule length_percentage
        ?runtime_module_path:length_percentage_runtime_module_path () );
    ( Value "auto-track-list",
      pack_rule auto_track_list
        ?runtime_module_path:auto_track_list_runtime_module_path () );
    ( Value "counter-style",
      pack_rule counter_style
        ?runtime_module_path:counter_style_runtime_module_path () );
    ( Value "counter-style-name",
      pack_rule counter_style_name
        ?runtime_module_path:counter_style_name_runtime_module_path () );
    ( Value "fixed-size",
      pack_rule fixed_size ?runtime_module_path:fixed_size_runtime_module_path
        () );
    ( Value "fixed-repeat",
      pack_rule fixed_repeat
        ?runtime_module_path:fixed_repeat_runtime_module_path () );
    ( Value "fixed-breadth",
      pack_rule fixed_breadth
        ?runtime_module_path:fixed_breadth_runtime_module_path () );
    ( Value "auto-repeat",
      pack_rule auto_repeat ?runtime_module_path:auto_repeat_runtime_module_path
        () );
    ( Value "extended-time-no-interp",
      pack_rule extended_time_no_interp
        ?runtime_module_path:extended_time_no_interp_runtime_module_path () );
    ( Value "timing-function-no-interp",
      pack_rule timing_function_no_interp
        ?runtime_module_path:timing_function_no_interp_runtime_module_path () );
    ( Value "cubic-bezier-timing-function",
      pack_rule cubic_bezier_timing_function
        ?runtime_module_path:cubic_bezier_timing_function_runtime_module_path ()
    );
    ( Value "step-timing-function",
      pack_rule step_timing_function
        ?runtime_module_path:step_timing_function_runtime_module_path () );
    ( Value "single-animation",
      pack_rule single_animation
        ?runtime_module_path:single_animation_runtime_module_path () );
    ( Value "single-animation-no-interp",
      pack_rule single_animation_no_interp
        ?runtime_module_path:single_animation_no_interp_runtime_module_path () );
    ( Value "single-animation-direction-no-interp",
      pack_rule single_animation_direction_no_interp
        ?runtime_module_path:
          single_animation_direction_no_interp_runtime_module_path () );
    ( Value "single-animation-fill-mode-no-interp",
      pack_rule single_animation_fill_mode_no_interp
        ?runtime_module_path:
          single_animation_fill_mode_no_interp_runtime_module_path () );
    ( Value "single-animation-iteration-count-no-interp",
      pack_rule single_animation_iteration_count_no_interp
        ?runtime_module_path:
          single_animation_iteration_count_no_interp_runtime_module_path () );
    ( Value "single-animation-play-state-no-interp",
      pack_rule single_animation_play_state_no_interp
        ?runtime_module_path:
          single_animation_play_state_no_interp_runtime_module_path () );
    ( Value "shadow-t",
      pack_rule shadow_t ?runtime_module_path:shadow_t_runtime_module_path () );
    ( Value "font-weight-absolute",
      pack_rule font_weight_absolute
        ?runtime_module_path:font_weight_absolute_runtime_module_path () );
    (* Commonly referenced values *)
    ( Value "position",
      pack_rule position ?runtime_module_path:position_runtime_module_path () );
    ( Value "timing-function",
      pack_rule timing_function
        ?runtime_module_path:timing_function_runtime_module_path () );
    ( Value "number-percentage",
      pack_rule number_percentage
        ?runtime_module_path:number_percentage_runtime_module_path () );
    ( Value "grid-line",
      pack_rule grid_line ?runtime_module_path:grid_line_runtime_module_path ()
    );
    ( Value "single-transition-property",
      pack_rule single_transition_property
        ?runtime_module_path:single_transition_property_runtime_module_path () );
    ( Value "outline-radius",
      pack_rule outline_radius
        ?runtime_module_path:outline_radius_runtime_module_path () );
    ( Value "bg-size",
      pack_rule bg_size ?runtime_module_path:bg_size_runtime_module_path () );
    ( Value "bg-position",
      pack_rule bg_position ?runtime_module_path:bg_position_runtime_module_path
        () );
    ( Value "feature-value-name",
      pack_rule feature_value_name
        ?runtime_module_path:feature_value_name_runtime_module_path () );
    ( Value "svg-length",
      pack_rule svg_length ?runtime_module_path:svg_length_runtime_module_path
        () );
    ( Value "single-animation-iteration-count",
      pack_rule single_animation_iteration_count
        ?runtime_module_path:
          single_animation_iteration_count_runtime_module_path () );
    ( Value "basic-shape",
      pack_rule basic_shape ?runtime_module_path:basic_shape_runtime_module_path
        () );
    ( Value "filter-function",
      pack_rule filter_function
        ?runtime_module_path:filter_function_runtime_module_path () );
    Function "attr()", pack_rule function_attr ();
    ( Function "symbols()",
      pack_rule function_symbols
        ?runtime_module_path:function_symbols_runtime_module_path () );
    (* Gradient functions *)
    ...
    ( Function "translate()",
      pack_rule function_translate
        ?runtime_module_path:function_translate_runtime_module_path () );
    ...
    ( Function "scale()",
      pack_rule function_scale
        ?runtime_module_path:function_scale_runtime_module_path () );
    ...
    ( Function "rotate()",
      pack_rule function_rotate
        ?runtime_module_path:function_rotate_runtime_module_path () );
    ...
    ( Function "perspective()",
      pack_rule function_perspective
        ?runtime_module_path:function_perspective_runtime_module_path () );
    ( Value "overflow-position",
      pack_rule overflow_position
        ?runtime_module_path:overflow_position_runtime_module_path () );
    ( Value "relative-size",
      pack_rule relative_size
        ?runtime_module_path:relative_size_runtime_module_path () );
    ( Value "repeat-style",
      pack_rule repeat_style
        ?runtime_module_path:repeat_style_runtime_module_path () );
    ( Value "self-position",
      pack_rule self_position
        ?runtime_module_path:self_position_runtime_module_path () );
    ( Value "single-animation-direction",
      pack_rule single_animation_direction
        ?runtime_module_path:single_animation_direction_runtime_module_path () );
    ( Value "single-animation-fill-mode",
      pack_rule single_animation_fill_mode
        ?runtime_module_path:single_animation_fill_mode_runtime_module_path () );
    ( Value "single-animation-play-state",
      pack_rule single_animation_play_state
        ?runtime_module_path:single_animation_play_state_runtime_module_path ()
    );
    ( Value "step-position",
      pack_rule step_position
        ?runtime_module_path:step_position_runtime_module_path () );
    ( Value "symbols-type",
      pack_rule symbols_type
        ?runtime_module_path:symbols_type_runtime_module_path () );
    ( Value "masking-mode",
      pack_rule masking_mode
        ?runtime_module_path:masking_mode_runtime_module_path () );
    ( Value "numeric-figure-values",
      pack_rule numeric_figure_values
        ?runtime_module_path:numeric_figure_values_runtime_module_path () );
    ( Value "numeric-spacing-values",
      pack_rule numeric_spacing_values
        ?runtime_module_path:numeric_spacing_values_runtime_module_path () );
    ( Value "absolute-size",
      pack_rule absolute_size
        ?runtime_module_path:absolute_size_runtime_module_path () );
    ( Value "content-position",
      pack_rule content_position
        ?runtime_module_path:content_position_runtime_module_path () );
    ( Value "baseline-position",
      pack_rule baseline_position
        ?runtime_module_path:baseline_position_runtime_module_path () );
    ( Value "blend-mode",
      pack_rule blend_mode ?runtime_module_path:blend_mode_runtime_module_path
        () );
    ( Value "geometry-box",
      pack_rule geometry_box
        ?runtime_module_path:geometry_box_runtime_module_path () );
    ( Property "-webkit-appearance",
      pack_rule property__webkit_appearance
        ?runtime_module_path:property__webkit_appearance_runtime_module_path ()
    );
    ( Property "stroke-linejoin",
      pack_rule property_stroke_linejoin
        ?runtime_module_path:property_stroke_linejoin_runtime_module_path () );
    ( Property "perspective-origin",
      pack_rule property_perspective_origin
        ?runtime_module_path:property_perspective_origin_runtime_module_path ()
    );
    (* CSS Math Functions *)
    ...
    ( Function "var()",
      pack_rule function_var
        ?runtime_module_path:function_var_runtime_module_path () );
    Function "color-mix()", pack_rule function_color_mix ();
    (* CSS Calc internal types *)
    ( Value "calc-product",
      pack_rule calc_product
        ?runtime_module_path:calc_product_runtime_module_path () );
    ( Value "calc-sum",
      pack_rule calc_sum ?runtime_module_path:calc_sum_runtime_module_path () );
    ( Value "calc-value",
      pack_rule calc_value ?runtime_module_path:calc_value_runtime_module_path
        () );
    (* Media query building blocks *)
    ( Value "mf-eq",
      pack_rule mf_eq ?runtime_module_path:mf_eq_runtime_module_path () );
    ( Value "mf-gt",
      pack_rule mf_gt ?runtime_module_path:mf_gt_runtime_module_path () );
    ( Value "mf-lt",
      pack_rule mf_lt ?runtime_module_path:mf_lt_runtime_module_path () );
    (* Media query types *)
    ( Property "media-type",
      pack_rule property_media_type
        ?runtime_module_path:property_media_type_runtime_module_path () );
    ( Property "container-type",
      pack_rule property_container_type
        ?runtime_module_path:property_container_type_runtime_module_path () );
    ( Value "dimension",
      pack_rule dimension ?runtime_module_path:dimension_runtime_module_path ()
    );
    ( Value "ratio",
      pack_rule ratio ?runtime_module_path:ratio_runtime_module_path () );
    ( Value "mf-name",
      pack_rule mf_name ?runtime_module_path:mf_name_runtime_module_path () );
    ( Value "mf-value",
      pack_rule mf_value ?runtime_module_path:mf_value_runtime_module_path () );
    ( Value "mf-boolean",
      pack_rule mf_boolean ?runtime_module_path:mf_boolean_runtime_module_path
        () );
    ( Value "mf-plain",
      pack_rule mf_plain ?runtime_module_path:mf_plain_runtime_module_path () );
    ( Value "mf-comparison",
      pack_rule mf_comparison
        ?runtime_module_path:mf_comparison_runtime_module_path () );
    ( Value "mf-range",
      pack_rule mf_range ?runtime_module_path:mf_range_runtime_module_path () );
    (* Media query types *)
    ( Media_query "media-feature",
      pack_rule media_feature
        ?runtime_module_path:media_feature_runtime_module_path () );
    ( Media_query "media-in-parens",
      pack_rule media_in_parens
        ?runtime_module_path:media_in_parens_runtime_module_path () );
    ( Media_query "media-or",
      pack_rule media_or ?runtime_module_path:media_or_runtime_module_path () );
    ( Media_query "media-and",
      pack_rule media_and ?runtime_module_path:media_and_runtime_module_path ()
    );
    ( Media_query "media-not",
      pack_rule media_not ?runtime_module_path:media_not_runtime_module_path ()
    );
    ( Media_query "media-condition-without-or",
      pack_rule media_condition_without_or
        ?runtime_module_path:media_condition_without_or_runtime_module_path () );
    ( Media_query "media-condition",
      pack_rule media_condition
        ?runtime_module_path:media_condition_runtime_module_path () );
    ( Media_query "media-query",
      pack_rule media_query ?runtime_module_path:media_query_runtime_module_path
        () );
    ( Media_query "media-query-list",
      pack_rule media_query_list
        ?runtime_module_path:media_query_list_runtime_module_path () );
    (* Container query types *)
    ( Value "container-query",
      pack_rule container_query
        ?runtime_module_path:container_query_runtime_module_path () );
    ( Value "container-condition",
      pack_rule container_condition
        ?runtime_module_path:container_condition_runtime_module_path () );
    ( Value "query-in-parens",
      pack_rule query_in_parens
        ?runtime_module_path:query_in_parens_runtime_module_path () );
    ( Value "size-feature",
      pack_rule size_feature
        ?runtime_module_path:size_feature_runtime_module_path () );
    ( Value "style-query",
      pack_rule style_query ?runtime_module_path:style_query_runtime_module_path
        () );
    ( Value "style-feature",
      pack_rule style_feature
        ?runtime_module_path:style_feature_runtime_module_path () );
    ( Value "style-in-parens",
      pack_rule style_in_parens
        ?runtime_module_path:style_in_parens_runtime_module_path () );
    (* Legacy/Non-standard values - keyword only *)
    ( Value "legacy-radial-gradient-shape",
      pack_rule legacy_radial_gradient_shape
        ?runtime_module_path:legacy_radial_gradient_shape_runtime_module_path ()
    );
    ( Value "legacy-radial-gradient-size",
      pack_rule legacy_radial_gradient_size
        ?runtime_module_path:legacy_radial_gradient_size_runtime_module_path ()
    );
    ( Value "legacy-radial-gradient-arguments",
      pack_rule legacy_radial_gradient_arguments
        ?runtime_module_path:
          legacy_radial_gradient_arguments_runtime_module_path () );
    ( Value "legacy-radial-gradient",
      pack_rule legacy_radial_gradient
        ?runtime_module_path:legacy_radial_gradient_runtime_module_path () );
    ( Value "legacy-repeating-radial-gradient",
      pack_rule legacy_repeating_radial_gradient
        ?runtime_module_path:
          legacy_repeating_radial_gradient_runtime_module_path () );
    ( Value "legacy-linear-gradient",
      pack_rule legacy_linear_gradient
        ?runtime_module_path:legacy_linear_gradient_runtime_module_path () );
    ( Value "legacy-linear-gradient-arguments",
      pack_rule legacy_linear_gradient_arguments
        ?runtime_module_path:
          legacy_linear_gradient_arguments_runtime_module_path () );
    ( Value "legacy-repeating-linear-gradient",
      pack_rule legacy_repeating_linear_gradient
        ?runtime_module_path:
          legacy_repeating_linear_gradient_runtime_module_path () );
    ( Value "legacy-gradient",
      pack_rule legacy_gradient
        ?runtime_module_path:legacy_gradient_runtime_module_path () );
    ( Value "-non-standard-color",
      pack_rule non_standard_color
        ?runtime_module_path:non_standard_color_runtime_module_path () );
    ( Value "-non-standard-font",
      pack_rule non_standard_font
        ?runtime_module_path:non_standard_font_runtime_module_path () );
    ( Value "-non-standard-image-rendering",
      pack_rule non_standard_image_rendering
        ?runtime_module_path:non_standard_image_rendering_runtime_module_path ()
    );
    ( Value "-non-standard-overflow",
      pack_rule non_standard_overflow
        ?runtime_module_path:non_standard_overflow_runtime_module_path () );
    ( Value "-non-standard-width",
      pack_rule non_standard_width
        ?runtime_module_path:non_standard_width_runtime_module_path () );
    ( Value "-webkit-gradient-type",
      pack_rule webkit_gradient_type
        ?runtime_module_path:webkit_gradient_type_runtime_module_path () );
    ( Value "-webkit-mask-box-repeat",
      pack_rule webkit_mask_box_repeat
        ?runtime_module_path:webkit_mask_box_repeat_runtime_module_path () );
    ( Value "-webkit-mask-clip-style",
      pack_rule webkit_mask_clip_style
        ?runtime_module_path:webkit_mask_clip_style_runtime_module_path () );
    (* Keyword-only CSS values *)
    ( Value "common-lig-values",
      pack_rule common_lig_values
        ?runtime_module_path:common_lig_values_runtime_module_path () );
    ( Value "compat-auto",
      pack_rule compat_auto ?runtime_module_path:compat_auto_runtime_module_path
        () );
    ( Value "composite-style",
      pack_rule composite_style
        ?runtime_module_path:composite_style_runtime_module_path () );
    ( Value "compositing-operator",
      pack_rule compositing_operator
        ?runtime_module_path:compositing_operator_runtime_module_path () );
    ( Value "content-distribution",
      pack_rule content_distribution
        ?runtime_module_path:content_distribution_runtime_module_path () );
    ( Value "deprecated-system-color",
      pack_rule deprecated_system_color
        ?runtime_module_path:deprecated_system_color_runtime_module_path () );
    ( Value "discretionary-lig-values",
      pack_rule discretionary_lig_values
        ?runtime_module_path:discretionary_lig_values_runtime_module_path () );
    ( Value "display-inside",
      pack_rule display_inside
        ?runtime_module_path:display_inside_runtime_module_path () );
    ( Value "display-internal",
      pack_rule display_internal
        ?runtime_module_path:display_internal_runtime_module_path () );
    ( Value "display-legacy",
      pack_rule display_legacy
        ?runtime_module_path:display_legacy_runtime_module_path () );
    ( Value "east-asian-variant-values",
      pack_rule east_asian_variant_values
        ?runtime_module_path:east_asian_variant_values_runtime_module_path () );
    ( Value "feature-type",
      pack_rule feature_type
        ?runtime_module_path:feature_type_runtime_module_path () );
    ( Value "font-variant-css21",
      pack_rule font_variant_css21
        ?runtime_module_path:font_variant_css21_runtime_module_path () );
    ( Value "generic-family",
      pack_rule generic_family
        ?runtime_module_path:generic_family_runtime_module_path () );
    ( Value "generic-name",
      pack_rule generic_name
        ?runtime_module_path:generic_name_runtime_module_path () );
    ( Value "historical-lig-values",
      pack_rule historical_lig_values
        ?runtime_module_path:historical_lig_values_runtime_module_path () );
    ( Value "numeric-fraction-values",
      pack_rule numeric_fraction_values
        ?runtime_module_path:numeric_fraction_values_runtime_module_path () );
    ...
    ( Value "page-margin-box-type",
      pack_rule page_margin_box_type
        ?runtime_module_path:page_margin_box_type_runtime_module_path () );
    ( Value "polar-color-space",
      pack_rule polar_color_space
        ?runtime_module_path:polar_color_space_runtime_module_path () );
    ( Value "quote",
      pack_rule quote ?runtime_module_path:quote_runtime_module_path () );
    ( Value "rectangular-color-space",
      pack_rule rectangular_color_space
        ?runtime_module_path:rectangular_color_space_runtime_module_path () );
    ( Value "shape-box",
      pack_rule shape_box ?runtime_module_path:shape_box_runtime_module_path ()
    );
    ( Value "visual-box",
      pack_rule visual_box ?runtime_module_path:visual_box_runtime_module_path
        () );
    (* ============================================= *)
    ...
    ( Property "-moz-appearance",
      pack_rule property__moz_appearance
        ?runtime_module_path:property__moz_appearance_runtime_module_path () );
    ( Property "-moz-background-clip",
      pack_rule property__moz_background_clip
        ?runtime_module_path:property__moz_background_clip_runtime_module_path
        () );
    ( Property "-moz-binding",
      pack_rule property__moz_binding
        ?runtime_module_path:property__moz_binding_runtime_module_path () );
    ( Property "-moz-border-bottom-colors",
      pack_rule property__moz_border_bottom_colors
        ?runtime_module_path:
          property__moz_border_bottom_colors_runtime_module_path () );
    ( Property "-moz-border-left-colors",
      pack_rule property__moz_border_left_colors
        ?runtime_module_path:
          property__moz_border_left_colors_runtime_module_path () );
    ( Property "-moz-border-radius-bottomleft",
      pack_rule property__moz_border_radius_bottomleft
        ?runtime_module_path:
          property__moz_border_radius_bottomleft_runtime_module_path () );
    ( Property "-moz-border-radius-bottomright",
      pack_rule property__moz_border_radius_bottomright
        ?runtime_module_path:
          property__moz_border_radius_bottomright_runtime_module_path () );
    ( Property "-moz-border-radius-topleft",
      pack_rule property__moz_border_radius_topleft
        ?runtime_module_path:
          property__moz_border_radius_topleft_runtime_module_path () );
    ( Property "-moz-border-radius-topright",
      pack_rule property__moz_border_radius_topright
        ?runtime_module_path:
          property__moz_border_radius_topright_runtime_module_path () );
    ( Property "-moz-border-right-colors",
      pack_rule property__moz_border_right_colors
        ?runtime_module_path:
          property__moz_border_right_colors_runtime_module_path () );
    ( Property "-moz-border-top-colors",
      pack_rule property__moz_border_top_colors
        ?runtime_module_path:property__moz_border_top_colors_runtime_module_path
        () );
    ( Property "-moz-context-properties",
      pack_rule property__moz_context_properties
        ?runtime_module_path:
          property__moz_context_properties_runtime_module_path () );
    ( Property "-moz-control-character-visibility",
      pack_rule property__moz_control_character_visibility
        ?runtime_module_path:
          property__moz_control_character_visibility_runtime_module_path () );
    ( Property "-moz-float-edge",
      pack_rule property__moz_float_edge
        ?runtime_module_path:property__moz_float_edge_runtime_module_path () );
    ( Property "-moz-force-broken-image-icon",
      pack_rule property__moz_force_broken_image_icon
        ?runtime_module_path:
          property__moz_force_broken_image_icon_runtime_module_path () );
    ( Property "-moz-image-region",
      pack_rule property__moz_image_region
        ?runtime_module_path:property__moz_image_region_runtime_module_path () );
    ( Property "-moz-orient",
      pack_rule property__moz_orient
        ?runtime_module_path:property__moz_orient_runtime_module_path () );
    ( Property "-moz-osx-font-smoothing",
      pack_rule property__moz_osx_font_smoothing
        ?runtime_module_path:
          property__moz_osx_font_smoothing_runtime_module_path () );
    ( Property "-moz-outline-radius",
      pack_rule property__moz_outline_radius
        ?runtime_module_path:property__moz_outline_radius_runtime_module_path ()
    );
    ( Property "-moz-outline-radius-bottomleft",
      pack_rule property__moz_outline_radius_bottomleft
        ?runtime_module_path:
          property__moz_outline_radius_bottomleft_runtime_module_path () );
    ( Property "-moz-outline-radius-bottomright",
      pack_rule property__moz_outline_radius_bottomright
        ?runtime_module_path:
          property__moz_outline_radius_bottomright_runtime_module_path () );
    ( Property "-moz-outline-radius-topleft",
      pack_rule property__moz_outline_radius_topleft
        ?runtime_module_path:
          property__moz_outline_radius_topleft_runtime_module_path () );
    ( Property "-moz-outline-radius-topright",
      pack_rule property__moz_outline_radius_topright
        ?runtime_module_path:
          property__moz_outline_radius_topright_runtime_module_path () );
    ( Property "-moz-stack-sizing",
      pack_rule property__moz_stack_sizing
        ?runtime_module_path:property__moz_stack_sizing_runtime_module_path () );
    ( Property "-moz-text-blink",
      pack_rule property__moz_text_blink
        ?runtime_module_path:property__moz_text_blink_runtime_module_path () );
    ( Property "-moz-user-focus",
      pack_rule property__moz_user_focus
        ?runtime_module_path:property__moz_user_focus_runtime_module_path () );
    ( Property "-moz-user-input",
      pack_rule property__moz_user_input
        ?runtime_module_path:property__moz_user_input_runtime_module_path () );
    ( Property "-moz-user-modify",
      pack_rule property__moz_user_modify
        ?runtime_module_path:property__moz_user_modify_runtime_module_path () );
    ( Property "-moz-user-select",
      pack_rule property__moz_user_select
        ?runtime_module_path:property__moz_user_select_runtime_module_path () );
    ( Property "-moz-window-dragging",
      pack_rule property__moz_window_dragging
        ?runtime_module_path:property__moz_window_dragging_runtime_module_path
        () );
    ( Property "-moz-window-shadow",
      pack_rule property__moz_window_shadow
        ?runtime_module_path:property__moz_window_shadow_runtime_module_path ()
    );
    ( Property "-webkit-background-clip",
      pack_rule property__webkit_background_clip
        ?runtime_module_path:
          property__webkit_background_clip_runtime_module_path () );
    ( Property "-webkit-border-before",
      pack_rule property__webkit_border_before
        ?runtime_module_path:property__webkit_border_before_runtime_module_path
        () );
    ( Property "-webkit-border-before-color",
      pack_rule property__webkit_border_before_color
        ?runtime_module_path:
          property__webkit_border_before_color_runtime_module_path () );
    ( Property "-webkit-border-before-style",
      pack_rule property__webkit_border_before_style
        ?runtime_module_path:
          property__webkit_border_before_style_runtime_module_path () );
    ( Property "-webkit-border-before-width",
      pack_rule property__webkit_border_before_width
        ?runtime_module_path:
          property__webkit_border_before_width_runtime_module_path () );
    ( Property "-webkit-box-reflect",
      pack_rule property__webkit_box_reflect
        ?runtime_module_path:property__webkit_box_reflect_runtime_module_path ()
    );
    ( Property "-webkit-column-break-after",
      pack_rule property__webkit_column_break_after
        ?runtime_module_path:
          property__webkit_column_break_after_runtime_module_path () );
    ( Property "-webkit-column-break-before",
      pack_rule property__webkit_column_break_before
        ?runtime_module_path:
          property__webkit_column_break_before_runtime_module_path () );
    ( Property "-webkit-column-break-inside",
      pack_rule property__webkit_column_break_inside
        ?runtime_module_path:
          property__webkit_column_break_inside_runtime_module_path () );
    ( Property "-webkit-font-smoothing",
      pack_rule property__webkit_font_smoothing
        ?runtime_module_path:property__webkit_font_smoothing_runtime_module_path
        () );
    ( Property "-webkit-line-clamp",
      pack_rule property__webkit_line_clamp
        ?runtime_module_path:property__webkit_line_clamp_runtime_module_path ()
    );
    ( Property "-webkit-mask",
      pack_rule property__webkit_mask
        ?runtime_module_path:property__webkit_mask_runtime_module_path () );
    ( Property "-webkit-mask-attachment",
      pack_rule property__webkit_mask_attachment
        ?runtime_module_path:
          property__webkit_mask_attachment_runtime_module_path () );
    ( Property "-webkit-mask-box-image",
      pack_rule property__webkit_mask_box_image
        ?runtime_module_path:property__webkit_mask_box_image_runtime_module_path
        () );
    ( Property "-webkit-mask-clip",
      pack_rule property__webkit_mask_clip
        ?runtime_module_path:property__webkit_mask_clip_runtime_module_path () );
    ( Property "-webkit-mask-composite",
      pack_rule property__webkit_mask_composite
        ?runtime_module_path:property__webkit_mask_composite_runtime_module_path
        () );
    ( Property "-webkit-mask-image",
      pack_rule property__webkit_mask_image
        ?runtime_module_path:property__webkit_mask_image_runtime_module_path ()
    );
    ( Property "-webkit-mask-origin",
      pack_rule property__webkit_mask_origin
        ?runtime_module_path:property__webkit_mask_origin_runtime_module_path ()
    );
    ( Property "-webkit-mask-position",
      pack_rule property__webkit_mask_position
        ?runtime_module_path:property__webkit_mask_position_runtime_module_path
        () );
    ( Property "-webkit-mask-position-x",
      pack_rule property__webkit_mask_position_x
        ?runtime_module_path:
          property__webkit_mask_position_x_runtime_module_path () );
    ( Property "-webkit-mask-position-y",
      pack_rule property__webkit_mask_position_y
        ?runtime_module_path:
          property__webkit_mask_position_y_runtime_module_path () );
    ( Property "-webkit-mask-repeat",
      pack_rule property__webkit_mask_repeat
        ?runtime_module_path:property__webkit_mask_repeat_runtime_module_path ()
    );
    ( Property "-webkit-mask-repeat-x",
      pack_rule property__webkit_mask_repeat_x
        ?runtime_module_path:property__webkit_mask_repeat_x_runtime_module_path
        () );
    ( Property "-webkit-mask-repeat-y",
      pack_rule property__webkit_mask_repeat_y
        ?runtime_module_path:property__webkit_mask_repeat_y_runtime_module_path
        () );
    ( Property "-webkit-mask-size",
      pack_rule property__webkit_mask_size
        ?runtime_module_path:property__webkit_mask_size_runtime_module_path () );
    ( Property "-webkit-overflow-scrolling",
      pack_rule property__webkit_overflow_scrolling
        ?runtime_module_path:
          property__webkit_overflow_scrolling_runtime_module_path () );
    ( Property "-webkit-print-color-adjust",
      pack_rule property__webkit_print_color_adjust
        ?runtime_module_path:
          property__webkit_print_color_adjust_runtime_module_path () );
    ( Property "-webkit-tap-highlight-color",
      pack_rule property__webkit_tap_highlight_color
        ?runtime_module_path:
          property__webkit_tap_highlight_color_runtime_module_path () );
    ( Property "-webkit-text-fill-color",
      pack_rule property__webkit_text_fill_color
        ?runtime_module_path:
          property__webkit_text_fill_color_runtime_module_path () );
    ( Property "-webkit-text-security",
      pack_rule property__webkit_text_security
        ?runtime_module_path:property__webkit_text_security_runtime_module_path
        () );
    ( Property "-webkit-text-stroke",
      pack_rule property__webkit_text_stroke
        ?runtime_module_path:property__webkit_text_stroke_runtime_module_path ()
    );
    ( Property "-webkit-text-stroke-color",
      pack_rule property__webkit_text_stroke_color
        ?runtime_module_path:
          property__webkit_text_stroke_color_runtime_module_path () );
    ( Property "-webkit-text-stroke-width",
      pack_rule property__webkit_text_stroke_width
        ?runtime_module_path:
          property__webkit_text_stroke_width_runtime_module_path () );
    ( Property "-webkit-touch-callout",
      pack_rule property__webkit_touch_callout
        ?runtime_module_path:property__webkit_touch_callout_runtime_module_path
        () );
    ( Property "-webkit-user-drag",
      pack_rule property__webkit_user_drag
        ?runtime_module_path:property__webkit_user_drag_runtime_module_path () );
    ( Property "-webkit-user-modify",
      pack_rule property__webkit_user_modify
        ?runtime_module_path:property__webkit_user_modify_runtime_module_path ()
    );
    ( Property "-webkit-user-select",
      pack_rule property__webkit_user_select
        ?runtime_module_path:property__webkit_user_select_runtime_module_path ()
    );
    (* Vendor-prefixed properties - Microsoft *)
    ( Property "-ms-overflow-style",
      pack_rule property__ms_overflow_style
        ?runtime_module_path:property__ms_overflow_style_runtime_module_path ()
    );
    ( Property "accent-color",
      pack_rule property_accent_color
        ?runtime_module_path:property_accent_color_runtime_module_path () );
    ( Property "alignment-baseline",
      pack_rule property_alignment_baseline
        ?runtime_module_path:property_alignment_baseline_runtime_module_path ()
    );
    ( Property "anchor-name",
      pack_rule property_anchor_name
        ?runtime_module_path:property_anchor_name_runtime_module_path () );
    ( Property "anchor-scope",
      pack_rule property_anchor_scope
        ?runtime_module_path:property_anchor_scope_runtime_module_path () );
    ( Property "animation",
      pack_rule property_animation
        ?runtime_module_path:property_animation_runtime_module_path () );
    ( Property "animation-composition",
      pack_rule property_animation_composition
        ?runtime_module_path:property_animation_composition_runtime_module_path
        () );
    ( Property "animation-delay",
      pack_rule property_animation_delay
        ?runtime_module_path:property_animation_delay_runtime_module_path () );
    ( Property "animation-delay-end",
      pack_rule property_animation_delay_end
        ?runtime_module_path:property_animation_delay_end_runtime_module_path ()
    );
    ( Property "animation-delay-start",
      pack_rule property_animation_delay_start
        ?runtime_module_path:property_animation_delay_start_runtime_module_path
        () );
    ( Property "animation-direction",
      pack_rule property_animation_direction
        ?runtime_module_path:property_animation_direction_runtime_module_path ()
    );
    ( Property "animation-duration",
      pack_rule property_animation_duration
        ?runtime_module_path:property_animation_duration_runtime_module_path ()
    );
    ( Property "animation-fill-mode",
      pack_rule property_animation_fill_mode
        ?runtime_module_path:property_animation_fill_mode_runtime_module_path ()
    );
    ( Property "animation-iteration-count",
      pack_rule property_animation_iteration_count
        ?runtime_module_path:
          property_animation_iteration_count_runtime_module_path () );
    Property "animation-name", pack_rule property_animation_name ();
    ( Property "animation-play-state",
      pack_rule property_animation_play_state
        ?runtime_module_path:property_animation_play_state_runtime_module_path
        () );
    ( Property "animation-range",
      pack_rule property_animation_range
        ?runtime_module_path:property_animation_range_runtime_module_path () );
    ( Property "animation-range-end",
      pack_rule property_animation_range_end
        ?runtime_module_path:property_animation_range_end_runtime_module_path ()
    );
    ( Property "animation-range-start",
      pack_rule property_animation_range_start
        ?runtime_module_path:property_animation_range_start_runtime_module_path
        () );
    ( Property "animation-timeline",
      pack_rule property_animation_timeline
        ?runtime_module_path:property_animation_timeline_runtime_module_path ()
    );
    ( Property "animation-timing-function",
      pack_rule property_animation_timing_function
        ?runtime_module_path:
          property_animation_timing_function_runtime_module_path () );
    ( Property "aspect-ratio",
      pack_rule property_aspect_ratio
        ?runtime_module_path:property_aspect_ratio_runtime_module_path () );
    ( Property "azimuth",
      pack_rule property_azimuth
        ?runtime_module_path:property_azimuth_runtime_module_path () );
    ( Property "backdrop-blur",
      pack_rule property_backdrop_blur
        ?runtime_module_path:property_backdrop_blur_runtime_module_path () );
    Property "backdrop-filter", pack_rule property_backdrop_filter ();
    ( Property "background",
      pack_rule property_background
        ?runtime_module_path:property_background_runtime_module_path () );
    ( Property "background-attachment",
      pack_rule property_background_attachment
        ?runtime_module_path:property_background_attachment_runtime_module_path
        () );
    ( Property "background-blend-mode",
      pack_rule property_background_blend_mode
        ?runtime_module_path:property_background_blend_mode_runtime_module_path
        () );
    ( Property "background-clip",
      pack_rule property_background_clip
        ?runtime_module_path:property_background_clip_runtime_module_path () );
    Property "background-color", pack_rule property_background_color ();
    ( Property "background-image",
      pack_rule property_background_image
        ?runtime_module_path:property_background_image_runtime_module_path () );
    ( Property "background-origin",
      pack_rule property_background_origin
        ?runtime_module_path:property_background_origin_runtime_module_path () );
    ( Property "background-position",
      pack_rule property_background_position
        ?runtime_module_path:property_background_position_runtime_module_path ()
    );
    ( Property "background-position-x",
      pack_rule property_background_position_x
        ?runtime_module_path:property_background_position_x_runtime_module_path
        () );
    ( Property "background-position-y",
      pack_rule property_background_position_y
        ?runtime_module_path:property_background_position_y_runtime_module_path
        () );
    ( Property "background-repeat",
      pack_rule property_background_repeat
        ?runtime_module_path:property_background_repeat_runtime_module_path () );
    ( Property "background-size",
      pack_rule property_background_size
        ?runtime_module_path:property_background_size_runtime_module_path () );
    ( Property "baseline-shift",
      pack_rule property_baseline_shift
        ?runtime_module_path:property_baseline_shift_runtime_module_path () );
    ( Property "behavior",
      pack_rule property_behavior
        ?runtime_module_path:property_behavior_runtime_module_path () );
    ( Property "bleed",
      pack_rule property_bleed
        ?runtime_module_path:property_bleed_runtime_module_path () );
    ( Property "block-overflow",
      pack_rule property_block_overflow
        ?runtime_module_path:property_block_overflow_runtime_module_path () );
    Property "block-size", pack_rule property_block_size ();
    ( Property "border-block",
      pack_rule property_border_block
        ?runtime_module_path:property_border_block_runtime_module_path () );
    ( Property "border-block-color",
      pack_rule property_border_block_color
        ?runtime_module_path:property_border_block_color_runtime_module_path ()
    );
    ( Property "border-block-end",
      pack_rule property_border_block_end
        ?runtime_module_path:property_border_block_end_runtime_module_path () );
    ( Property "border-block-end-color",
      pack_rule property_border_block_end_color
        ?runtime_module_path:property_border_block_end_color_runtime_module_path
        () );
    ( Property "border-block-end-style",
      pack_rule property_border_block_end_style
        ?runtime_module_path:property_border_block_end_style_runtime_module_path
        () );
    ( Property "border-block-end-width",
      pack_rule property_border_block_end_width
        ?runtime_module_path:property_border_block_end_width_runtime_module_path
        () );
    ( Property "border-block-start",
      pack_rule property_border_block_start
        ?runtime_module_path:property_border_block_start_runtime_module_path ()
    );
    ( Property "border-block-start-color",
      pack_rule property_border_block_start_color
        ?runtime_module_path:
          property_border_block_start_color_runtime_module_path () );
    ( Property "border-block-start-style",
      pack_rule property_border_block_start_style
        ?runtime_module_path:
          property_border_block_start_style_runtime_module_path () );
    ( Property "border-block-start-width",
      pack_rule property_border_block_start_width
        ?runtime_module_path:
          property_border_block_start_width_runtime_module_path () );
    ( Property "border-block-style",
      pack_rule property_border_block_style
        ?runtime_module_path:property_border_block_style_runtime_module_path ()
    );
    ( Property "border-block-width",
      pack_rule property_border_block_width
        ?runtime_module_path:property_border_block_width_runtime_module_path ()
    );
    ( Property "border-bottom",
      pack_rule property_border_bottom
        ?runtime_module_path:property_border_bottom_runtime_module_path () );
    ...
    ( Property "border-image",
      pack_rule property_border_image
        ?runtime_module_path:property_border_image_runtime_module_path () );
    ( Property "border-image-outset",
      pack_rule property_border_image_outset
        ?runtime_module_path:property_border_image_outset_runtime_module_path ()
    );
    ( Property "border-image-slice",
      pack_rule property_border_image_slice
        ?runtime_module_path:property_border_image_slice_runtime_module_path ()
    );
    ( Property "border-image-source",
      pack_rule property_border_image_source
        ?runtime_module_path:property_border_image_source_runtime_module_path ()
    );
    ( Property "border-image-width",
      pack_rule property_border_image_width
        ?runtime_module_path:property_border_image_width_runtime_module_path ()
    );
    ( Property "border-inline",
      pack_rule property_border_inline
        ?runtime_module_path:property_border_inline_runtime_module_path () );
    ( Property "border-inline-color",
      pack_rule property_border_inline_color
        ?runtime_module_path:property_border_inline_color_runtime_module_path ()
    );
    ( Property "border-inline-end",
      pack_rule property_border_inline_end
        ?runtime_module_path:property_border_inline_end_runtime_module_path () );
    ( Property "border-inline-end-color",
      pack_rule property_border_inline_end_color
        ?runtime_module_path:
          property_border_inline_end_color_runtime_module_path () );
    ( Property "border-inline-end-style",
      pack_rule property_border_inline_end_style
        ?runtime_module_path:
          property_border_inline_end_style_runtime_module_path () );
    ( Property "border-inline-end-width",
      pack_rule property_border_inline_end_width
        ?runtime_module_path:
          property_border_inline_end_width_runtime_module_path () );
    ( Property "border-inline-start",
      pack_rule property_border_inline_start
        ?runtime_module_path:property_border_inline_start_runtime_module_path ()
    );
    ( Property "border-inline-start-color",
      pack_rule property_border_inline_start_color
        ?runtime_module_path:
          property_border_inline_start_color_runtime_module_path () );
    ( Property "border-inline-start-style",
      pack_rule property_border_inline_start_style
        ?runtime_module_path:
          property_border_inline_start_style_runtime_module_path () );
    ( Property "border-inline-start-width",
      pack_rule property_border_inline_start_width
        ?runtime_module_path:
          property_border_inline_start_width_runtime_module_path () );
    ( Property "border-inline-style",
      pack_rule property_border_inline_style
        ?runtime_module_path:property_border_inline_style_runtime_module_path ()
    );
    ( Property "border-inline-width",
      pack_rule property_border_inline_width
        ?runtime_module_path:property_border_inline_width_runtime_module_path ()
    );
    ( Property "border-left",
      pack_rule property_border_left
        ?runtime_module_path:property_border_left_runtime_module_path () );
    ...
    ( Property "border-radius",
      pack_rule property_border_radius
        ?runtime_module_path:property_border_radius_runtime_module_path () );
    ( Property "border-right",
      pack_rule property_border_right
        ?runtime_module_path:property_border_right_runtime_module_path () );
    ...
    ( Property "border-spacing",
      pack_rule property_border_spacing
        ?runtime_module_path:property_border_spacing_runtime_module_path () );
    ...
    ( Property "border-style",
      pack_rule property_border_style
        ?runtime_module_path:property_border_style_runtime_module_path () );
    ( Property "border-top",
      pack_rule property_border_top
        ?runtime_module_path:property_border_top_runtime_module_path () );
    ...
    ( Property "bottom",
      pack_rule property_bottom
        ?runtime_module_path:property_bottom_runtime_module_path () );
    ( Property "box-align",
      pack_rule property_box_align
        ?runtime_module_path:property_box_align_runtime_module_path () );
    ( Property "box-direction",
      pack_rule property_box_direction
        ?runtime_module_path:property_box_direction_runtime_module_path () );
    ( Property "box-flex",
      pack_rule property_box_flex
        ?runtime_module_path:property_box_flex_runtime_module_path () );
    ( Property "box-flex-group",
      pack_rule property_box_flex_group
        ?runtime_module_path:property_box_flex_group_runtime_module_path () );
    ( Property "box-lines",
      pack_rule property_box_lines
        ?runtime_module_path:property_box_lines_runtime_module_path () );
    ( Property "box-ordinal-group",
      pack_rule property_box_ordinal_group
        ?runtime_module_path:property_box_ordinal_group_runtime_module_path () );
    ( Property "box-orient",
      pack_rule property_box_orient
        ?runtime_module_path:property_box_orient_runtime_module_path () );
    ( Property "-webkit-box-orient",
      pack_rule property_box_orient
        ?runtime_module_path:property_box_orient_runtime_module_path () );
    ( Property "box-pack",
      pack_rule property_box_pack
        ?runtime_module_path:property_box_pack_runtime_module_path () );
    ( Property "box-shadow",
      pack_rule property_box_shadow
        ?runtime_module_path:property_box_shadow_runtime_module_path () );
    ( Property "-webkit-box-shadow",
      pack_rule property_box_shadow
        ?runtime_module_path:property_box_shadow_runtime_module_path () );
    ( Property "clip",
      pack_rule property_clip
        ?runtime_module_path:property_clip_runtime_module_path () );
    ( Property "clip-path",
      pack_rule property_clip_path
        ?runtime_module_path:property_clip_path_runtime_module_path () );
    ( Property "color",
      pack_rule property_color
        ?runtime_module_path:property_color_runtime_module_path () );
    ( Property "color-interpolation",
      pack_rule property_color_interpolation
        ?runtime_module_path:property_color_interpolation_runtime_module_path ()
    );
    ( Property "color-interpolation-filters",
      pack_rule property_color_interpolation_filters
        ?runtime_module_path:
          property_color_interpolation_filters_runtime_module_path () );
    ( Property "color-rendering",
      pack_rule property_color_rendering
        ?runtime_module_path:property_color_rendering_runtime_module_path () );
    ( Property "column-count",
      pack_rule property_column_count
        ?runtime_module_path:property_column_count_runtime_module_path () );
    ( Property "column-rule",
      pack_rule property_column_rule
        ?runtime_module_path:property_column_rule_runtime_module_path () );
    ( Property "column-rule-color",
      pack_rule property_column_rule_color
        ?runtime_module_path:property_column_rule_color_runtime_module_path () );
    ( Property "column-rule-style",
      pack_rule property_column_rule_style
        ?runtime_module_path:property_column_rule_style_runtime_module_path () );
    ( Property "column-rule-width",
      pack_rule property_column_rule_width
        ?runtime_module_path:property_column_rule_width_runtime_module_path () );
    ( Property "column-width",
      pack_rule property_column_width
        ?runtime_module_path:property_column_width_runtime_module_path () );
    ( Property "columns",
      pack_rule property_columns
        ?runtime_module_path:property_columns_runtime_module_path () );
    ( Property "contain-intrinsic-block-size",
      pack_rule property_contain_intrinsic_block_size
        ?runtime_module_path:
          property_contain_intrinsic_block_size_runtime_module_path () );
    ( Property "contain-intrinsic-height",
      pack_rule property_contain_intrinsic_height
        ?runtime_module_path:
          property_contain_intrinsic_height_runtime_module_path () );
    ( Property "contain-intrinsic-inline-size",
      pack_rule property_contain_intrinsic_inline_size
        ?runtime_module_path:
          property_contain_intrinsic_inline_size_runtime_module_path () );
    ( Property "contain-intrinsic-width",
      pack_rule property_contain_intrinsic_width
        ?runtime_module_path:
          property_contain_intrinsic_width_runtime_module_path () );
    ( Property "container",
      pack_rule property_container
        ?runtime_module_path:property_container_runtime_module_path () );
    ( Property "container-name",
      pack_rule property_container_name
        ?runtime_module_path:property_container_name_runtime_module_path () );
    ( Property "container-name-computed",
      pack_rule property_container_name_computed
        ?runtime_module_path:
          property_container_name_computed_runtime_module_path () );
    ( Property "content",
      pack_rule property_content
        ?runtime_module_path:property_content_runtime_module_path () );
    ( Property "counter-increment",
      pack_rule property_counter_increment
        ?runtime_module_path:property_counter_increment_runtime_module_path () );
    ( Property "counter-reset",
      pack_rule property_counter_reset
        ?runtime_module_path:property_counter_reset_runtime_module_path () );
    ( Property "counter-set",
      pack_rule property_counter_set
        ?runtime_module_path:property_counter_set_runtime_module_path () );
    ( Property "cue",
      pack_rule property_cue
        ?runtime_module_path:property_cue_runtime_module_path () );
    ( Property "cue-after",
      pack_rule property_cue_after
        ?runtime_module_path:property_cue_after_runtime_module_path () );
    ( Property "cue-before",
      pack_rule property_cue_before
        ?runtime_module_path:property_cue_before_runtime_module_path () );
    ( Property "cursor",
      pack_rule property_cursor
        ?runtime_module_path:property_cursor_runtime_module_path () );
    ...
    ( Property "dominant-baseline",
      pack_rule property_dominant_baseline
        ?runtime_module_path:property_dominant_baseline_runtime_module_path () );
    ( Property "field-sizing",
      pack_rule property_field_sizing
        ?runtime_module_path:property_field_sizing_runtime_module_path () );
    ( Property "fill",
      pack_rule property_fill
        ?runtime_module_path:property_fill_runtime_module_path () );
    ( Property "fill-opacity",
      pack_rule property_fill_opacity
        ?runtime_module_path:property_fill_opacity_runtime_module_path () );
    ( Property "fill-rule",
      pack_rule property_fill_rule
        ?runtime_module_path:property_fill_rule_runtime_module_path () );
    ( Property "filter",
      pack_rule property_filter
        ?runtime_module_path:property_filter_runtime_module_path () );
    ( Property "flex",
      pack_rule property_flex
        ?runtime_module_path:property_flex_runtime_module_path () );
    ( Property "flex-flow",
      pack_rule property_flex_flow
        ?runtime_module_path:property_flex_flow_runtime_module_path () );
    ...
    ( Property "font",
      pack_rule property_font
        ?runtime_module_path:property_font_runtime_module_path () );
    ( Property "font-family",
      pack_rule property_font_family
        ?runtime_module_path:property_font_family_runtime_module_path () );
    ( Property "font-feature-settings",
      pack_rule property_font_feature_settings
        ?runtime_module_path:property_font_feature_settings_runtime_module_path
        () );
    ( Property "font-language-override",
      pack_rule property_font_language_override
        ?runtime_module_path:property_font_language_override_runtime_module_path
        () );
    ( Property "font-size",
      pack_rule property_font_size
        ?runtime_module_path:property_font_size_runtime_module_path () );
    ( Property "font-size-adjust",
      pack_rule property_font_size_adjust
        ?runtime_module_path:property_font_size_adjust_runtime_module_path () );
    ( Property "font-smooth",
      pack_rule property_font_smooth
        ?runtime_module_path:property_font_smooth_runtime_module_path () );
    ( Property "font-synthesis",
      pack_rule property_font_synthesis
        ?runtime_module_path:property_font_synthesis_runtime_module_path () );
    ( Property "font-variant",
      pack_rule property_font_variant
        ?runtime_module_path:property_font_variant_runtime_module_path () );
    ( Property "font-variant-alternates",
      pack_rule property_font_variant_alternates
        ?runtime_module_path:
          property_font_variant_alternates_runtime_module_path () );
    ( Property "font-variant-east-asian",
      pack_rule property_font_variant_east_asian
        ?runtime_module_path:
          property_font_variant_east_asian_runtime_module_path () );
    ( Property "font-variant-emoji",
      pack_rule property_font_variant_emoji
        ?runtime_module_path:property_font_variant_emoji_runtime_module_path ()
    );
    ( Property "font-variant-ligatures",
      pack_rule property_font_variant_ligatures
        ?runtime_module_path:property_font_variant_ligatures_runtime_module_path
        () );
    ( Property "font-variant-numeric",
      pack_rule property_font_variant_numeric
        ?runtime_module_path:property_font_variant_numeric_runtime_module_path
        () );
    ( Property "font-variation-settings",
      pack_rule property_font_variation_settings
        ?runtime_module_path:
          property_font_variation_settings_runtime_module_path () );
    ( Property "font-weight",
      pack_rule property_font_weight
        ?runtime_module_path:property_font_weight_runtime_module_path () );
    ( Property "gap",
      pack_rule property_gap
        ?runtime_module_path:property_gap_runtime_module_path () );
    ( Property "glyph-orientation-horizontal",
      pack_rule property_glyph_orientation_horizontal
        ?runtime_module_path:
          property_glyph_orientation_horizontal_runtime_module_path () );
    ( Property "glyph-orientation-vertical",
      pack_rule property_glyph_orientation_vertical
        ?runtime_module_path:
          property_glyph_orientation_vertical_runtime_module_path () );
    ( Property "grid",
      pack_rule property_grid
        ?runtime_module_path:property_grid_runtime_module_path () );
    ( Property "grid-area",
      pack_rule property_grid_area
        ?runtime_module_path:property_grid_area_runtime_module_path () );
    ( Property "grid-auto-columns",
      pack_rule property_grid_auto_columns
        ?runtime_module_path:property_grid_auto_columns_runtime_module_path () );
    ( Property "grid-auto-rows",
      pack_rule property_grid_auto_rows
        ?runtime_module_path:property_grid_auto_rows_runtime_module_path () );
    ( Property "grid-column",
      pack_rule property_grid_column
        ?runtime_module_path:property_grid_column_runtime_module_path () );
    ( Property "grid-column-end",
      pack_rule property_grid_column_end
        ?runtime_module_path:property_grid_column_end_runtime_module_path () );
    Property "grid-column-gap", pack_rule property_grid_column_gap ();
    ( Property "grid-column-start",
      pack_rule property_grid_column_start
        ?runtime_module_path:property_grid_column_start_runtime_module_path () );
    Property "grid-gap", pack_rule property_grid_gap ();
    ( Property "grid-row",
      pack_rule property_grid_row
        ?runtime_module_path:property_grid_row_runtime_module_path () );
    ( Property "grid-row-end",
      pack_rule property_grid_row_end
        ?runtime_module_path:property_grid_row_end_runtime_module_path () );
    Property "grid-row-gap", pack_rule property_grid_row_gap ();
    ( Property "grid-row-start",
      pack_rule property_grid_row_start
        ?runtime_module_path:property_grid_row_start_runtime_module_path () );
    ( Property "grid-template",
      pack_rule property_grid_template
        ?runtime_module_path:property_grid_template_runtime_module_path () );
    ( Property "grid-template-areas",
      pack_rule property_grid_template_areas
        ?runtime_module_path:property_grid_template_areas_runtime_module_path ()
    );
    ( Property "grid-template-columns",
      pack_rule property_grid_template_columns
        ?runtime_module_path:property_grid_template_columns_runtime_module_path
        () );
    ( Property "grid-template-rows",
      pack_rule property_grid_template_rows
        ?runtime_module_path:property_grid_template_rows_runtime_module_path ()
    );
    ( Property "hanging-punctuation",
      pack_rule property_hanging_punctuation
        ?runtime_module_path:property_hanging_punctuation_runtime_module_path ()
    );
    ( Property "height",
      pack_rule property_height
        ?runtime_module_path:property_height_runtime_module_path () );
    ( Property "hyphenate-character",
      pack_rule property_hyphenate_character
        ?runtime_module_path:property_hyphenate_character_runtime_module_path ()
    );
    ( Property "hyphenate-limit-chars",
      pack_rule property_hyphenate_limit_chars
        ?runtime_module_path:property_hyphenate_limit_chars_runtime_module_path
        () );
    ( Property "hyphenate-limit-last",
      pack_rule property_hyphenate_limit_last
        ?runtime_module_path:property_hyphenate_limit_last_runtime_module_path
        () );
    ( Property "hyphenate-limit-lines",
      pack_rule property_hyphenate_limit_lines
        ?runtime_module_path:property_hyphenate_limit_lines_runtime_module_path
        () );
    ( Property "hyphenate-limit-zone",
      pack_rule property_hyphenate_limit_zone
        ?runtime_module_path:property_hyphenate_limit_zone_runtime_module_path
        () );
    ( Property "image-orientation",
      pack_rule property_image_orientation
        ?runtime_module_path:property_image_orientation_runtime_module_path () );
    ( Property "image-resolution",
      pack_rule property_image_resolution
        ?runtime_module_path:property_image_resolution_runtime_module_path () );
    ( Property "ime-mode",
      pack_rule property_ime_mode
        ?runtime_module_path:property_ime_mode_runtime_module_path () );
    ( Property "inherits",
      pack_rule property_inherits
        ?runtime_module_path:property_inherits_runtime_module_path () );
    ( Property "initial-letter",
      pack_rule property_initial_letter
        ?runtime_module_path:property_initial_letter_runtime_module_path () );
    ( Property "initial-letter-align",
      pack_rule property_initial_letter_align
        ?runtime_module_path:property_initial_letter_align_runtime_module_path
        () );
    ( Property "initial-value",
      pack_rule property_initial_value
        ?runtime_module_path:property_initial_value_runtime_module_path () );
    Property "inline-size", pack_rule property_inline_size ();
    ( Property "inset",
      pack_rule property_inset
        ?runtime_module_path:property_inset_runtime_module_path () );
    ( Property "inset-area",
      pack_rule property_inset_area
        ?runtime_module_path:property_inset_area_runtime_module_path () );
    ( Property "inset-block",
      pack_rule property_inset_block
        ?runtime_module_path:property_inset_block_runtime_module_path () );
    ...
    ( Property "inset-inline",
      pack_rule property_inset_inline
        ?runtime_module_path:property_inset_inline_runtime_module_path () );
    ...
    ( Property "interpolate-size",
      pack_rule property_interpolate_size
        ?runtime_module_path:property_interpolate_size_runtime_module_path () );
    ( Property "kerning",
      pack_rule property_kerning
        ?runtime_module_path:property_kerning_runtime_module_path () );
    ( Property "layout-grid",
      pack_rule property_layout_grid
        ?runtime_module_path:property_layout_grid_runtime_module_path () );
    ( Property "layout-grid-char",
      pack_rule property_layout_grid_char
        ?runtime_module_path:property_layout_grid_char_runtime_module_path () );
    ( Property "layout-grid-line",
      pack_rule property_layout_grid_line
        ?runtime_module_path:property_layout_grid_line_runtime_module_path () );
    ( Property "layout-grid-mode",
      pack_rule property_layout_grid_mode
        ?runtime_module_path:property_layout_grid_mode_runtime_module_path () );
    ( Property "layout-grid-type",
      pack_rule property_layout_grid_type
        ?runtime_module_path:property_layout_grid_type_runtime_module_path () );
    ( Property "left",
      pack_rule property_left
        ?runtime_module_path:property_left_runtime_module_path () );
    ( Property "letter-spacing",
      pack_rule property_letter_spacing
        ?runtime_module_path:property_letter_spacing_runtime_module_path () );
    Property "lighting-color", pack_rule property_lighting_color ();
    ( Property "line-break",
      pack_rule property_line_break
        ?runtime_module_path:property_line_break_runtime_module_path () );
    ( Property "line-clamp",
      pack_rule property_line_clamp
        ?runtime_module_path:property_line_clamp_runtime_module_path () );
    ( Property "line-height",
      pack_rule property_line_height
        ?runtime_module_path:property_line_height_runtime_module_path () );
    ( Property "line-height-step",
      pack_rule property_line_height_step
        ?runtime_module_path:property_line_height_step_runtime_module_path () );
    ( Property "list-style",
      pack_rule property_list_style
        ?runtime_module_path:property_list_style_runtime_module_path () );
    ( Property "list-style-image",
      pack_rule property_list_style_image
        ?runtime_module_path:property_list_style_image_runtime_module_path () );
    ( Property "margin",
      pack_rule property_margin
        ?runtime_module_path:property_margin_runtime_module_path () );
    ( Property "margin-block",
      pack_rule property_margin_block
        ?runtime_module_path:property_margin_block_runtime_module_path () );
    ...
    ( Property "margin-inline",
      pack_rule property_margin_inline
        ?runtime_module_path:property_margin_inline_runtime_module_path () );
    ...
    ( Property "margin-trim",
      pack_rule property_margin_trim
        ?runtime_module_path:property_margin_trim_runtime_module_path () );
    ( Property "marker",
      pack_rule property_marker
        ?runtime_module_path:property_marker_runtime_module_path () );
    ( Property "marker-end",
      pack_rule property_marker_end
        ?runtime_module_path:property_marker_end_runtime_module_path () );
    ( Property "marker-mid",
      pack_rule property_marker_mid
        ?runtime_module_path:property_marker_mid_runtime_module_path () );
    ( Property "marker-start",
      pack_rule property_marker_start
        ?runtime_module_path:property_marker_start_runtime_module_path () );
    ( Property "marks",
      pack_rule property_marks
        ?runtime_module_path:property_marks_runtime_module_path () );
    ( Property "mask",
      pack_rule property_mask
        ?runtime_module_path:property_mask_runtime_module_path () );
    ( Property "mask-border",
      pack_rule property_mask_border
        ?runtime_module_path:property_mask_border_runtime_module_path () );
    ( Property "mask-border-outset",
      pack_rule property_mask_border_outset
        ?runtime_module_path:property_mask_border_outset_runtime_module_path ()
    );
    ( Property "mask-border-repeat",
      pack_rule property_mask_border_repeat
        ?runtime_module_path:property_mask_border_repeat_runtime_module_path ()
    );
    ( Property "mask-border-slice",
      pack_rule property_mask_border_slice
        ?runtime_module_path:property_mask_border_slice_runtime_module_path () );
    ( Property "mask-border-source",
      pack_rule property_mask_border_source
        ?runtime_module_path:property_mask_border_source_runtime_module_path ()
    );
    ( Property "mask-border-width",
      pack_rule property_mask_border_width
        ?runtime_module_path:property_mask_border_width_runtime_module_path () );
    ( Property "mask-clip",
      pack_rule property_mask_clip
        ?runtime_module_path:property_mask_clip_runtime_module_path () );
    ( Property "mask-composite",
      pack_rule property_mask_composite
        ?runtime_module_path:property_mask_composite_runtime_module_path () );
    ( Property "mask-image",
      pack_rule property_mask_image
        ?runtime_module_path:property_mask_image_runtime_module_path () );
    ( Property "mask-mode",
      pack_rule property_mask_mode
        ?runtime_module_path:property_mask_mode_runtime_module_path () );
    ( Property "mask-origin",
      pack_rule property_mask_origin
        ?runtime_module_path:property_mask_origin_runtime_module_path () );
    ( Property "mask-position",
      pack_rule property_mask_position
        ?runtime_module_path:property_mask_position_runtime_module_path () );
    ( Property "mask-repeat",
      pack_rule property_mask_repeat
        ?runtime_module_path:property_mask_repeat_runtime_module_path () );
    ( Property "mask-size",
      pack_rule property_mask_size
        ?runtime_module_path:property_mask_size_runtime_module_path () );
    ( Property "masonry-auto-flow",
      pack_rule property_masonry_auto_flow
        ?runtime_module_path:property_masonry_auto_flow_runtime_module_path () );
    ( Property "math-depth",
      pack_rule property_math_depth
        ?runtime_module_path:property_math_depth_runtime_module_path () );
    ( Property "math-shift",
      pack_rule property_math_shift
        ?runtime_module_path:property_math_shift_runtime_module_path () );
    ( Property "math-style",
      pack_rule property_math_style
        ?runtime_module_path:property_math_style_runtime_module_path () );
    Property "max-block-size", pack_rule property_max_block_size ();
    ( Property "max-height",
      pack_rule property_max_height
        ?runtime_module_path:property_max_height_runtime_module_path () );
    Property "max-inline-size", pack_rule property_max_inline_size ();
    ( Property "max-lines",
      pack_rule property_max_lines
        ?runtime_module_path:property_max_lines_runtime_module_path () );
    ( Property "max-width",
      pack_rule property_max_width
        ?runtime_module_path:property_max_width_runtime_module_path () );
    ( Property "media-any-hover",
      pack_rule property_media_any_hover
        ?runtime_module_path:property_media_any_hover_runtime_module_path () );
    ( Property "media-any-pointer",
      pack_rule property_media_any_pointer
        ?runtime_module_path:property_media_any_pointer_runtime_module_path () );
    ( Property "media-color-gamut",
      pack_rule property_media_color_gamut
        ?runtime_module_path:property_media_color_gamut_runtime_module_path () );
    ( Property "media-color-index",
      pack_rule property_media_color_index
        ?runtime_module_path:property_media_color_index_runtime_module_path () );
    ( Property "media-display-mode",
      pack_rule property_media_display_mode
        ?runtime_module_path:property_media_display_mode_runtime_module_path ()
    );
    ( Property "media-forced-colors",
      pack_rule property_media_forced_colors
        ?runtime_module_path:property_media_forced_colors_runtime_module_path ()
    );
    ( Property "media-grid",
      pack_rule property_media_grid
        ?runtime_module_path:property_media_grid_runtime_module_path () );
    ( Property "media-hover",
      pack_rule property_media_hover
        ?runtime_module_path:property_media_hover_runtime_module_path () );
    ( Property "media-inverted-colors",
      pack_rule property_media_inverted_colors
        ?runtime_module_path:property_media_inverted_colors_runtime_module_path
        () );
    ( Property "media-max-aspect-ratio",
      pack_rule property_media_max_aspect_ratio
        ?runtime_module_path:property_media_max_aspect_ratio_runtime_module_path
        () );
    ( Property "media-max-resolution",
      pack_rule property_media_max_resolution
        ?runtime_module_path:property_media_max_resolution_runtime_module_path
        () );
    ( Property "media-min-aspect-ratio",
      pack_rule property_media_min_aspect_ratio
        ?runtime_module_path:property_media_min_aspect_ratio_runtime_module_path
        () );
    ( Property "media-min-color",
      pack_rule property_media_min_color
        ?runtime_module_path:property_media_min_color_runtime_module_path () );
    ( Property "media-min-color-index",
      pack_rule property_media_min_color_index
        ?runtime_module_path:property_media_min_color_index_runtime_module_path
        () );
    ( Property "media-min-resolution",
      pack_rule property_media_min_resolution
        ?runtime_module_path:property_media_min_resolution_runtime_module_path
        () );
    ( Property "media-monochrome",
      pack_rule property_media_monochrome
        ?runtime_module_path:property_media_monochrome_runtime_module_path () );
    ( Property "media-orientation",
      pack_rule property_media_orientation
        ?runtime_module_path:property_media_orientation_runtime_module_path () );
    ( Property "media-pointer",
      pack_rule property_media_pointer
        ?runtime_module_path:property_media_pointer_runtime_module_path () );
    ( Property "media-prefers-color-scheme",
      pack_rule property_media_prefers_color_scheme
        ?runtime_module_path:
          property_media_prefers_color_scheme_runtime_module_path () );
    ( Property "media-prefers-contrast",
      pack_rule property_media_prefers_contrast
        ?runtime_module_path:property_media_prefers_contrast_runtime_module_path
        () );
    ( Property "media-prefers-reduced-motion",
      pack_rule property_media_prefers_reduced_motion
        ?runtime_module_path:
          property_media_prefers_reduced_motion_runtime_module_path () );
    ( Property "media-resolution",
      pack_rule property_media_resolution
        ?runtime_module_path:property_media_resolution_runtime_module_path () );
    ( Property "media-scripting",
      pack_rule property_media_scripting
        ?runtime_module_path:property_media_scripting_runtime_module_path () );
    ( Property "media-update",
      pack_rule property_media_update
        ?runtime_module_path:property_media_update_runtime_module_path () );
    Property "min-block-size", pack_rule property_min_block_size ();
    ( Property "min-height",
      pack_rule property_min_height
        ?runtime_module_path:property_min_height_runtime_module_path () );
    Property "min-inline-size", pack_rule property_min_inline_size ();
    ( Property "min-width",
      pack_rule property_min_width
        ?runtime_module_path:property_min_width_runtime_module_path () );
    ( Property "nav-down",
      pack_rule property_nav_down
        ?runtime_module_path:property_nav_down_runtime_module_path () );
    ( Property "nav-left",
      pack_rule property_nav_left
        ?runtime_module_path:property_nav_left_runtime_module_path () );
    ( Property "nav-right",
      pack_rule property_nav_right
        ?runtime_module_path:property_nav_right_runtime_module_path () );
    ( Property "nav-up",
      pack_rule property_nav_up
        ?runtime_module_path:property_nav_up_runtime_module_path () );
    ( Property "object-position",
      pack_rule property_object_position
        ?runtime_module_path:property_object_position_runtime_module_path () );
    ( Property "offset",
      pack_rule property_offset
        ?runtime_module_path:property_offset_runtime_module_path () );
    ( Property "offset-anchor",
      pack_rule property_offset_anchor
        ?runtime_module_path:property_offset_anchor_runtime_module_path () );
    ( Property "offset-distance",
      pack_rule property_offset_distance
        ?runtime_module_path:property_offset_distance_runtime_module_path () );
    ( Property "offset-path",
      pack_rule property_offset_path
        ?runtime_module_path:property_offset_path_runtime_module_path () );
    ( Property "offset-position",
      pack_rule property_offset_position
        ?runtime_module_path:property_offset_position_runtime_module_path () );
    ( Property "offset-rotate",
      pack_rule property_offset_rotate
        ?runtime_module_path:property_offset_rotate_runtime_module_path () );
    Property "opacity", pack_rule property_opacity ();
    ( Property "order",
      pack_rule property_order
        ?runtime_module_path:property_order_runtime_module_path () );
    ( Property "orphans",
      pack_rule property_orphans
        ?runtime_module_path:property_orphans_runtime_module_path () );
    ( Property "outline",
      pack_rule property_outline
        ?runtime_module_path:property_outline_runtime_module_path () );
    ...
    ( Property "overflow-block",
      pack_rule property_overflow_block
        ?runtime_module_path:property_overflow_block_runtime_module_path () );
    ( Property "overflow-clip-margin",
      pack_rule property_overflow_clip_margin
        ?runtime_module_path:property_overflow_clip_margin_runtime_module_path
        () );
    ( Property "overflow-inline",
      pack_rule property_overflow_inline
        ?runtime_module_path:property_overflow_inline_runtime_module_path () );
    ...
    ( Property "overlay",
      pack_rule property_overlay
        ?runtime_module_path:property_overlay_runtime_module_path () );
    ( Property "overscroll-behavior-block",
      pack_rule property_overscroll_behavior_block
        ?runtime_module_path:
          property_overscroll_behavior_block_runtime_module_path () );
    ( Property "overscroll-behavior-inline",
      pack_rule property_overscroll_behavior_inline
        ?runtime_module_path:
          property_overscroll_behavior_inline_runtime_module_path () );
    ( Property "overscroll-behavior-x",
      pack_rule property_overscroll_behavior_x
        ?runtime_module_path:property_overscroll_behavior_x_runtime_module_path
        () );
    ( Property "overscroll-behavior-y",
      pack_rule property_overscroll_behavior_y
        ?runtime_module_path:property_overscroll_behavior_y_runtime_module_path
        () );
    ( Property "padding",
      pack_rule property_padding
        ?runtime_module_path:property_padding_runtime_module_path () );
    ( Property "padding-block",
      pack_rule property_padding_block
        ?runtime_module_path:property_padding_block_runtime_module_path () );
    ...
    ( Property "padding-inline",
      pack_rule property_padding_inline
        ?runtime_module_path:property_padding_inline_runtime_module_path () );
    ...
    ( Property "page",
      pack_rule property_page
        ?runtime_module_path:property_page_runtime_module_path () );
    ( Property "paint-order",
      pack_rule property_paint_order
        ?runtime_module_path:property_paint_order_runtime_module_path () );
    ( Property "pause",
      pack_rule property_pause
        ?runtime_module_path:property_pause_runtime_module_path () );
    ( Property "pause-after",
      pack_rule property_pause_after
        ?runtime_module_path:property_pause_after_runtime_module_path () );
    ( Property "pause-before",
      pack_rule property_pause_before
        ?runtime_module_path:property_pause_before_runtime_module_path () );
    ( Property "perspective",
      pack_rule property_perspective
        ?runtime_module_path:property_perspective_runtime_module_path () );
    ( Property "place-content",
      pack_rule property_place_content
        ?runtime_module_path:property_place_content_runtime_module_path () );
    ( Property "place-items",
      pack_rule property_place_items
        ?runtime_module_path:property_place_items_runtime_module_path () );
    ( Property "place-self",
      pack_rule property_place_self
        ?runtime_module_path:property_place_self_runtime_module_path () );
    ( Property "position-anchor",
      pack_rule property_position_anchor
        ?runtime_module_path:property_position_anchor_runtime_module_path () );
    ( Property "position-area",
      pack_rule property_position_area
        ?runtime_module_path:property_position_area_runtime_module_path () );
    ( Property "position-try",
      pack_rule property_position_try
        ?runtime_module_path:property_position_try_runtime_module_path () );
    ( Property "position-try-fallbacks",
      pack_rule property_position_try_fallbacks
        ?runtime_module_path:property_position_try_fallbacks_runtime_module_path
        () );
    ( Property "position-try-options",
      pack_rule property_position_try_options
        ?runtime_module_path:property_position_try_options_runtime_module_path
        () );
    ( Property "position-visibility",
      pack_rule property_position_visibility
        ?runtime_module_path:property_position_visibility_runtime_module_path ()
    );
    ( Property "quotes",
      pack_rule property_quotes
        ?runtime_module_path:property_quotes_runtime_module_path () );
    Property "r", pack_rule property_r ();
    ( Property "reading-flow",
      pack_rule property_reading_flow
        ?runtime_module_path:property_reading_flow_runtime_module_path () );
    ( Property "rest",
      pack_rule property_rest
        ?runtime_module_path:property_rest_runtime_module_path () );
    ( Property "rest-after",
      pack_rule property_rest_after
        ?runtime_module_path:property_rest_after_runtime_module_path () );
    ( Property "rest-before",
      pack_rule property_rest_before
        ?runtime_module_path:property_rest_before_runtime_module_path () );
    ( Property "right",
      pack_rule property_right
        ?runtime_module_path:property_right_runtime_module_path () );
    ( Property "rotate",
      pack_rule property_rotate
        ?runtime_module_path:property_rotate_runtime_module_path () );
    ( Property "ruby-align",
      pack_rule property_ruby_align
        ?runtime_module_path:property_ruby_align_runtime_module_path () );
    ( Property "ruby-overhang",
      pack_rule property_ruby_overhang
        ?runtime_module_path:property_ruby_overhang_runtime_module_path () );
    Property "rx", pack_rule property_rx ();
    Property "ry", pack_rule property_ry ();
    ( Property "scale",
      pack_rule property_scale
        ?runtime_module_path:property_scale_runtime_module_path () );
    ( Property "scroll-margin",
      pack_rule property_scroll_margin
        ?runtime_module_path:property_scroll_margin_runtime_module_path () );
    ...
    ( Property "scroll-marker-group",
      pack_rule property_scroll_marker_group
        ?runtime_module_path:property_scroll_marker_group_runtime_module_path ()
    );
    ( Property "scroll-padding",
      pack_rule property_scroll_padding
        ?runtime_module_path:property_scroll_padding_runtime_module_path () );
    ...
    ( Property "scroll-snap-align",
      pack_rule property_scroll_snap_align
        ?runtime_module_path:property_scroll_snap_align_runtime_module_path () );
    ( Property "scroll-snap-coordinate",
      pack_rule property_scroll_snap_coordinate
        ?runtime_module_path:property_scroll_snap_coordinate_runtime_module_path
        () );
    ( Property "scroll-snap-destination",
      pack_rule property_scroll_snap_destination
        ?runtime_module_path:
          property_scroll_snap_destination_runtime_module_path () );
    ( Property "scroll-snap-points-x",
      pack_rule property_scroll_snap_points_x
        ?runtime_module_path:property_scroll_snap_points_x_runtime_module_path
        () );
    ( Property "scroll-snap-points-y",
      pack_rule property_scroll_snap_points_y
        ?runtime_module_path:property_scroll_snap_points_y_runtime_module_path
        () );
    ( Property "scroll-snap-type",
      pack_rule property_scroll_snap_type
        ?runtime_module_path:property_scroll_snap_type_runtime_module_path () );
    ...
    ( Property "scroll-start",
      pack_rule property_scroll_start
        ?runtime_module_path:property_scroll_start_runtime_module_path () );
    ( Property "scroll-start-block",
      pack_rule property_scroll_start_block
        ?runtime_module_path:property_scroll_start_block_runtime_module_path ()
    );
    ( Property "scroll-start-inline",
      pack_rule property_scroll_start_inline
        ?runtime_module_path:property_scroll_start_inline_runtime_module_path ()
    );
    ( Property "scroll-start-target",
      pack_rule property_scroll_start_target
        ?runtime_module_path:property_scroll_start_target_runtime_module_path ()
    );
    ( Property "scroll-start-target-block",
      pack_rule property_scroll_start_target_block
        ?runtime_module_path:
          property_scroll_start_target_block_runtime_module_path () );
    ( Property "scroll-start-target-inline",
      pack_rule property_scroll_start_target_inline
        ?runtime_module_path:
          property_scroll_start_target_inline_runtime_module_path () );
    ( Property "scroll-start-target-x",
      pack_rule property_scroll_start_target_x
        ?runtime_module_path:property_scroll_start_target_x_runtime_module_path
        () );
    ( Property "scroll-start-target-y",
      pack_rule property_scroll_start_target_y
        ?runtime_module_path:property_scroll_start_target_y_runtime_module_path
        () );
    ( Property "scroll-start-x",
      pack_rule property_scroll_start_x
        ?runtime_module_path:property_scroll_start_x_runtime_module_path () );
    ( Property "scroll-start-y",
      pack_rule property_scroll_start_y
        ?runtime_module_path:property_scroll_start_y_runtime_module_path () );
    ( Property "scroll-timeline",
      pack_rule property_scroll_timeline
        ?runtime_module_path:property_scroll_timeline_runtime_module_path () );
    ( Property "scroll-timeline-axis",
      pack_rule property_scroll_timeline_axis
        ?runtime_module_path:property_scroll_timeline_axis_runtime_module_path
        () );
    ( Property "scroll-timeline-name",
      pack_rule property_scroll_timeline_name
        ?runtime_module_path:property_scroll_timeline_name_runtime_module_path
        () );
    ( Property "scrollbar-3dlight-color",
      pack_rule property_scrollbar_3dlight_color
        ?runtime_module_path:
          property_scrollbar_3dlight_color_runtime_module_path () );
    ( Property "scrollbar-arrow-color",
      pack_rule property_scrollbar_arrow_color
        ?runtime_module_path:property_scrollbar_arrow_color_runtime_module_path
        () );
    ( Property "scrollbar-base-color",
      pack_rule property_scrollbar_base_color
        ?runtime_module_path:property_scrollbar_base_color_runtime_module_path
        () );
    ( Property "scrollbar-color",
      pack_rule property_scrollbar_color
        ?runtime_module_path:property_scrollbar_color_runtime_module_path () );
    ( Property "scrollbar-color-legacy",
      pack_rule property_scrollbar_color_legacy
        ?runtime_module_path:property_scrollbar_color_legacy_runtime_module_path
        () );
    ( Property "scrollbar-darkshadow-color",
      pack_rule property_scrollbar_darkshadow_color
        ?runtime_module_path:
          property_scrollbar_darkshadow_color_runtime_module_path () );
    ( Property "scrollbar-face-color",
      pack_rule property_scrollbar_face_color
        ?runtime_module_path:property_scrollbar_face_color_runtime_module_path
        () );
    ( Property "scrollbar-gutter",
      pack_rule property_scrollbar_gutter
        ?runtime_module_path:property_scrollbar_gutter_runtime_module_path () );
    ( Property "scrollbar-highlight-color",
      pack_rule property_scrollbar_highlight_color
        ?runtime_module_path:
          property_scrollbar_highlight_color_runtime_module_path () );
    ( Property "scrollbar-shadow-color",
      pack_rule property_scrollbar_shadow_color
        ?runtime_module_path:property_scrollbar_shadow_color_runtime_module_path
        () );
    ( Property "scrollbar-track-color",
      pack_rule property_scrollbar_track_color
        ?runtime_module_path:property_scrollbar_track_color_runtime_module_path
        () );
    ( Property "shape-image-threshold",
      pack_rule property_shape_image_threshold
        ?runtime_module_path:property_shape_image_threshold_runtime_module_path
        () );
    ( Property "shape-margin",
      pack_rule property_shape_margin
        ?runtime_module_path:property_shape_margin_runtime_module_path () );
    ( Property "shape-outside",
      pack_rule property_shape_outside
        ?runtime_module_path:property_shape_outside_runtime_module_path () );
    ( Property "shape-rendering",
      pack_rule property_shape_rendering
        ?runtime_module_path:property_shape_rendering_runtime_module_path () );
    ( Property "size",
      pack_rule property_size
        ?runtime_module_path:property_size_runtime_module_path () );
    ( Property "speak-as",
      pack_rule property_speak_as
        ?runtime_module_path:property_speak_as_runtime_module_path () );
    ( Property "src",
      pack_rule property_src
        ?runtime_module_path:property_src_runtime_module_path () );
    ...
    ( Property "stroke",
      pack_rule property_stroke
        ?runtime_module_path:property_stroke_runtime_module_path () );
    Property "stroke-dasharray", pack_rule property_stroke_dasharray ();
    ( Property "stroke-dashoffset",
      pack_rule property_stroke_dashoffset
        ?runtime_module_path:property_stroke_dashoffset_runtime_module_path () );
    ( Property "stroke-miterlimit",
      pack_rule property_stroke_miterlimit
        ?runtime_module_path:property_stroke_miterlimit_runtime_module_path () );
    ( Property "stroke-opacity",
      pack_rule property_stroke_opacity
        ?runtime_module_path:property_stroke_opacity_runtime_module_path () );
    ( Property "stroke-width",
      pack_rule property_stroke_width
        ?runtime_module_path:property_stroke_width_runtime_module_path () );
    ( Property "syntax",
      pack_rule property_syntax
        ?runtime_module_path:property_syntax_runtime_module_path () );
    ( Property "tab-size",
      pack_rule property_tab_size
        ?runtime_module_path:property_tab_size_runtime_module_path () );
    ( Property "text-align-all",
      pack_rule property_text_align_all
        ?runtime_module_path:property_text_align_all_runtime_module_path () );
    ( Property "text-anchor",
      pack_rule property_text_anchor
        ?runtime_module_path:property_text_anchor_runtime_module_path () );
    ( Property "text-autospace",
      pack_rule property_text_autospace
        ?runtime_module_path:property_text_autospace_runtime_module_path () );
    ( Property "text-blink",
      pack_rule property_text_blink
        ?runtime_module_path:property_text_blink_runtime_module_path () );
    ( Property "text-box-edge",
      pack_rule property_text_box_edge
        ?runtime_module_path:property_text_box_edge_runtime_module_path () );
    ( Property "text-box-trim",
      pack_rule property_text_box_trim
        ?runtime_module_path:property_text_box_trim_runtime_module_path () );
    ( Property "text-combine-upright",
      pack_rule property_text_combine_upright
        ?runtime_module_path:property_text_combine_upright_runtime_module_path
        () );
    ( Property "text-decoration",
      pack_rule property_text_decoration
        ?runtime_module_path:property_text_decoration_runtime_module_path () );
    ( Property "text-decoration-color",
      pack_rule property_text_decoration_color () );
    ( Property "text-decoration-skip",
      pack_rule property_text_decoration_skip
        ?runtime_module_path:property_text_decoration_skip_runtime_module_path
        () );
    ( Property "text-decoration-skip-box",
      pack_rule property_text_decoration_skip_box
        ?runtime_module_path:
          property_text_decoration_skip_box_runtime_module_path () );
    ( Property "text-decoration-skip-inset",
      pack_rule property_text_decoration_skip_inset
        ?runtime_module_path:
          property_text_decoration_skip_inset_runtime_module_path () );
    ( Property "text-decoration-skip-self",
      pack_rule property_text_decoration_skip_self
        ?runtime_module_path:
          property_text_decoration_skip_self_runtime_module_path () );
    ( Property "text-decoration-skip-spaces",
      pack_rule property_text_decoration_skip_spaces
        ?runtime_module_path:
          property_text_decoration_skip_spaces_runtime_module_path () );
    ( Property "text-edge",
      pack_rule property_text_edge
        ?runtime_module_path:property_text_edge_runtime_module_path () );
    ( Property "text-emphasis",
      pack_rule property_text_emphasis
        ?runtime_module_path:property_text_emphasis_runtime_module_path () );
    ...
    ( Property "text-emphasis-position",
      pack_rule property_text_emphasis_position
        ?runtime_module_path:property_text_emphasis_position_runtime_module_path
        () );
    ( Property "text-emphasis-style",
      pack_rule property_text_emphasis_style
        ?runtime_module_path:property_text_emphasis_style_runtime_module_path ()
    );
    ( Property "text-indent",
      pack_rule property_text_indent
        ?runtime_module_path:property_text_indent_runtime_module_path () );
    ( Property "text-justify-trim",
      pack_rule property_text_justify_trim
        ?runtime_module_path:property_text_justify_trim_runtime_module_path () );
    ( Property "text-kashida",
      pack_rule property_text_kashida
        ?runtime_module_path:property_text_kashida_runtime_module_path () );
    ( Property "text-kashida-space",
      pack_rule property_text_kashida_space
        ?runtime_module_path:property_text_kashida_space_runtime_module_path ()
    );
    ( Property "text-overflow",
      pack_rule property_text_overflow
        ?runtime_module_path:property_text_overflow_runtime_module_path () );
    ( Property "text-shadow",
      pack_rule property_text_shadow
        ?runtime_module_path:property_text_shadow_runtime_module_path () );
    ( Property "text-size-adjust",
      pack_rule property_text_size_adjust
        ?runtime_module_path:property_text_size_adjust_runtime_module_path () );
    ( Property "text-spacing-trim",
      pack_rule property_text_spacing_trim
        ?runtime_module_path:property_text_spacing_trim_runtime_module_path () );
    ( Property "text-underline-offset",
      pack_rule property_text_underline_offset
        ?runtime_module_path:property_text_underline_offset_runtime_module_path
        () );
    ( Property "text-wrap",
      pack_rule property_text_wrap
        ?runtime_module_path:property_text_wrap_runtime_module_path () );
    ( Property "text-wrap-mode",
      pack_rule property_text_wrap_mode
        ?runtime_module_path:property_text_wrap_mode_runtime_module_path () );
    ( Property "text-wrap-style",
      pack_rule property_text_wrap_style
        ?runtime_module_path:property_text_wrap_style_runtime_module_path () );
    ( Property "timeline-scope",
      pack_rule property_timeline_scope
        ?runtime_module_path:property_timeline_scope_runtime_module_path () );
    ( Property "top",
      pack_rule property_top
        ?runtime_module_path:property_top_runtime_module_path () );
    ( Property "transform",
      pack_rule property_transform
        ?runtime_module_path:property_transform_runtime_module_path () );
    ( Property "transform-origin",
      pack_rule property_transform_origin
        ?runtime_module_path:property_transform_origin_runtime_module_path () );
    ( Property "transition",
      pack_rule property_transition
        ?runtime_module_path:property_transition_runtime_module_path () );
    ( Property "transition-behavior",
      pack_rule property_transition_behavior
        ?runtime_module_path:property_transition_behavior_runtime_module_path ()
    );
    ( Property "transition-delay",
      pack_rule property_transition_delay
        ?runtime_module_path:property_transition_delay_runtime_module_path () );
    ( Property "transition-duration",
      pack_rule property_transition_duration
        ?runtime_module_path:property_transition_duration_runtime_module_path ()
    );
    Property "transition-property", pack_rule property_transition_property ();
    ( Property "transition-timing-function",
      pack_rule property_transition_timing_function
        ?runtime_module_path:
          property_transition_timing_function_runtime_module_path () );
    ( Property "translate",
      pack_rule property_translate
        ?runtime_module_path:property_translate_runtime_module_path () );
    ( Property "unicode-range",
      pack_rule property_unicode_range
        ?runtime_module_path:property_unicode_range_runtime_module_path () );
    ( Property "vector-effect",
      pack_rule property_vector_effect
        ?runtime_module_path:property_vector_effect_runtime_module_path () );
    ( Property "vertical-align",
      pack_rule property_vertical_align
        ?runtime_module_path:property_vertical_align_runtime_module_path () );
    ( Property "view-timeline",
      pack_rule property_view_timeline
        ?runtime_module_path:property_view_timeline_runtime_module_path () );
    ( Property "view-timeline-axis",
      pack_rule property_view_timeline_axis
        ?runtime_module_path:property_view_timeline_axis_runtime_module_path ()
    );
    ( Property "view-timeline-inset",
      pack_rule property_view_timeline_inset
        ?runtime_module_path:property_view_timeline_inset_runtime_module_path ()
    );
    ( Property "view-timeline-name",
      pack_rule property_view_timeline_name
        ?runtime_module_path:property_view_timeline_name_runtime_module_path ()
    );
    ( Property "view-transition-name",
      pack_rule property_view_transition_name
        ?runtime_module_path:property_view_transition_name_runtime_module_path
        () );
    ( Property "voice-balance",
      pack_rule property_voice_balance
        ?runtime_module_path:property_voice_balance_runtime_module_path () );
    ( Property "voice-duration",
      pack_rule property_voice_duration
        ?runtime_module_path:property_voice_duration_runtime_module_path () );
    ( Property "voice-family",
      pack_rule property_voice_family
        ?runtime_module_path:property_voice_family_runtime_module_path () );
    ( Property "voice-pitch",
      pack_rule property_voice_pitch
        ?runtime_module_path:property_voice_pitch_runtime_module_path () );
    ( Property "voice-range",
      pack_rule property_voice_range
        ?runtime_module_path:property_voice_range_runtime_module_path () );
    ( Property "voice-rate",
      pack_rule property_voice_rate
        ?runtime_module_path:property_voice_rate_runtime_module_path () );
    ( Property "voice-stress",
      pack_rule property_voice_stress
        ?runtime_module_path:property_voice_stress_runtime_module_path () );
    ( Property "voice-volume",
      pack_rule property_voice_volume
        ?runtime_module_path:property_voice_volume_runtime_module_path () );
    ( Property "white-space-collapse",
      pack_rule property_white_space_collapse
        ?runtime_module_path:property_white_space_collapse_runtime_module_path
        () );
    ( Property "widows",
      pack_rule property_widows
        ?runtime_module_path:property_widows_runtime_module_path () );
    ( Property "word-space-transform",
      pack_rule property_word_space_transform
        ?runtime_module_path:property_word_space_transform_runtime_module_path
        () );
    ( Property "word-spacing",
      pack_rule property_word_spacing
        ?runtime_module_path:property_word_spacing_runtime_module_path () );
    ( Property "x",
      pack_rule property_x ?runtime_module_path:property_x_runtime_module_path
        () );
    ( Property "y",
      pack_rule property_y ?runtime_module_path:property_y_runtime_module_path
        () );
    ( Property "z-index",
      pack_rule property_z_index
        ?runtime_module_path:property_z_index_runtime_module_path () );
    ( Property "zoom",
      pack_rule property_zoom
        ?runtime_module_path:property_zoom_runtime_module_path () );
    ...
    ( Function "counter()",
      pack_rule function_counter
        ?runtime_module_path:function_counter_runtime_module_path () );
    ( Function "counters()",
      pack_rule function_counters
        ?runtime_module_path:function_counters_runtime_module_path () );
    ...
    ( Function "inset()",
      pack_rule function_inset
        ?runtime_module_path:function_inset_runtime_module_path () );
    ...
    ( Value "angular-color-stop",
      pack_rule angular_color_stop
        ?runtime_module_path:angular_color_stop_runtime_module_path () );
    ( Value "angular-color-stop-list",
      pack_rule angular_color_stop_list
        ?runtime_module_path:angular_color_stop_list_runtime_module_path () );
    ( Value "animateable-feature",
      pack_rule animateable_feature
        ?runtime_module_path:animateable_feature_runtime_module_path () );
    ( Value "attr-fallback",
      pack_rule attr_fallback
        ?runtime_module_path:attr_fallback_runtime_module_path () );
    ( Value "attr-matcher",
      pack_rule attr_matcher
        ?runtime_module_path:attr_matcher_runtime_module_path () );
    ( Value "attr-name",
      pack_rule attr_name ?runtime_module_path:attr_name_runtime_module_path ()
    );
    ( Value "attr-type",
      pack_rule attr_type ?runtime_module_path:attr_type_runtime_module_path ()
    );
    ( Value "attr-unit",
      pack_rule attr_unit ?runtime_module_path:attr_unit_runtime_module_path ()
    );
    ( Value "attribute-selector",
      pack_rule attribute_selector
        ?runtime_module_path:attribute_selector_runtime_module_path () );
    ( Value "bg-layer",
      pack_rule bg_layer ?runtime_module_path:bg_layer_runtime_module_path () );
    ( Value "border-radius",
      pack_rule border_radius
        ?runtime_module_path:border_radius_runtime_module_path () );
    ( Value "bottom",
      pack_rule bottom ?runtime_module_path:bottom_runtime_module_path () );
    ( Value "cf-final-image",
      pack_rule cf_final_image
        ?runtime_module_path:cf_final_image_runtime_module_path () );
    ( Value "cf-mixing-image",
      pack_rule cf_mixing_image
        ?runtime_module_path:cf_mixing_image_runtime_module_path () );
    ( Value "class-selector",
      pack_rule class_selector
        ?runtime_module_path:class_selector_runtime_module_path () );
    ( Value "clip-source",
      pack_rule clip_source ?runtime_module_path:clip_source_runtime_module_path
        () );
    ( Value "color-stop",
      pack_rule color_stop ?runtime_module_path:color_stop_runtime_module_path
        () );
    ( Value "color-stop-angle",
      pack_rule color_stop_angle
        ?runtime_module_path:color_stop_angle_runtime_module_path () );
    ( Value "color-stop-length",
      pack_rule color_stop_length
        ?runtime_module_path:color_stop_length_runtime_module_path () );
    ( Value "complex-selector",
      pack_rule complex_selector
        ?runtime_module_path:complex_selector_runtime_module_path () );
    ( Value "complex-selector-list",
      pack_rule complex_selector_list
        ?runtime_module_path:complex_selector_list_runtime_module_path () );
    ( Value "compound-selector",
      pack_rule compound_selector
        ?runtime_module_path:compound_selector_runtime_module_path () );
    ( Value "compound-selector-list",
      pack_rule compound_selector_list
        ?runtime_module_path:compound_selector_list_runtime_module_path () );
    ( Value "container-condition-list",
      pack_rule container_condition_list
        ?runtime_module_path:container_condition_list_runtime_module_path () );
    ( Value "counter-name",
      pack_rule counter_name
        ?runtime_module_path:counter_name_runtime_module_path () );
    ( Value "declaration",
      pack_rule declaration ?runtime_module_path:declaration_runtime_module_path
        () );
    ( Value "declaration-list",
      pack_rule declaration_list
        ?runtime_module_path:declaration_list_runtime_module_path () );
    ( Value "display-listitem",
      pack_rule display_listitem
        ?runtime_module_path:display_listitem_runtime_module_path () );
    ( Value "explicit-track-list",
      pack_rule explicit_track_list
        ?runtime_module_path:explicit_track_list_runtime_module_path () );
    ( Value "extended-angle",
      pack_rule extended_angle
        ?runtime_module_path:extended_angle_runtime_module_path () );
    ( Value "extended-frequency",
      pack_rule extended_frequency
        ?runtime_module_path:extended_frequency_runtime_module_path () );
    ( Value "extended-length",
      pack_rule extended_length
        ?runtime_module_path:extended_length_runtime_module_path () );
    ( Value "extended-percentage",
      pack_rule extended_percentage
        ?runtime_module_path:extended_percentage_runtime_module_path () );
    ( Value "extended-time",
      pack_rule extended_time
        ?runtime_module_path:extended_time_runtime_module_path () );
    ( Value "feature-tag-value",
      pack_rule feature_tag_value
        ?runtime_module_path:feature_tag_value_runtime_module_path () );
    ( Value "feature-value-block",
      pack_rule feature_value_block
        ?runtime_module_path:feature_value_block_runtime_module_path () );
    ( Value "feature-value-block-list",
      pack_rule feature_value_block_list
        ?runtime_module_path:feature_value_block_list_runtime_module_path () );
    ( Value "feature-value-declaration",
      pack_rule feature_value_declaration
        ?runtime_module_path:feature_value_declaration_runtime_module_path () );
    ( Value "feature-value-declaration-list",
      pack_rule feature_value_declaration_list
        ?runtime_module_path:feature_value_declaration_list_runtime_module_path
        () );
    ( Value "filter-function-list",
      pack_rule filter_function_list
        ?runtime_module_path:filter_function_list_runtime_module_path () );
    ( Value "final-bg-layer",
      pack_rule final_bg_layer
        ?runtime_module_path:final_bg_layer_runtime_module_path () );
    ( Value "font-stretch-absolute",
      pack_rule font_stretch_absolute
        ?runtime_module_path:font_stretch_absolute_runtime_module_path () );
    ( Value "general-enclosed",
      pack_rule general_enclosed
        ?runtime_module_path:general_enclosed_runtime_module_path () );
    ( Value "generic-voice",
      pack_rule generic_voice
        ?runtime_module_path:generic_voice_runtime_module_path () );
    ( Value "hue-interpolation-method",
      pack_rule hue_interpolation_method
        ?runtime_module_path:hue_interpolation_method_runtime_module_path () );
    ( Value "id-selector",
      pack_rule id_selector ?runtime_module_path:id_selector_runtime_module_path
        () );
    ( Value "image-set-option",
      pack_rule image_set_option
        ?runtime_module_path:image_set_option_runtime_module_path () );
    ( Value "image-src",
      pack_rule image_src ?runtime_module_path:image_src_runtime_module_path ()
    );
    ( Value "inflexible-breadth",
      pack_rule inflexible_breadth
        ?runtime_module_path:inflexible_breadth_runtime_module_path () );
    ( Value "keyframe-block",
      pack_rule keyframe_block
        ?runtime_module_path:keyframe_block_runtime_module_path () );
    ( Value "keyframe-block-list",
      pack_rule keyframe_block_list
        ?runtime_module_path:keyframe_block_list_runtime_module_path () );
    ( Value "keyframe-selector",
      pack_rule keyframe_selector
        ?runtime_module_path:keyframe_selector_runtime_module_path () );
    ( Value "leader-type",
      pack_rule leader_type ?runtime_module_path:leader_type_runtime_module_path
        () );
    ( Value "left",
      pack_rule left ?runtime_module_path:left_runtime_module_path () );
    ( Value "line-name-list",
      pack_rule line_name_list
        ?runtime_module_path:line_name_list_runtime_module_path () );
    ( Value "linear-color-hint",
      pack_rule linear_color_hint
        ?runtime_module_path:linear_color_hint_runtime_module_path () );
    ( Value "linear-color-stop",
      pack_rule linear_color_stop
        ?runtime_module_path:linear_color_stop_runtime_module_path () );
    ( Value "mask-image",
      pack_rule mask_image ?runtime_module_path:mask_image_runtime_module_path
        () );
    ( Value "mask-layer",
      pack_rule mask_layer ?runtime_module_path:mask_layer_runtime_module_path
        () );
    ( Value "mask-position",
      pack_rule mask_position
        ?runtime_module_path:mask_position_runtime_module_path () );
    ( Value "name-repeat",
      pack_rule name_repeat ?runtime_module_path:name_repeat_runtime_module_path
        () );
    ( Value "namespace-prefix",
      pack_rule namespace_prefix
        ?runtime_module_path:namespace_prefix_runtime_module_path () );
    ( Value "ns-prefix",
      pack_rule ns_prefix ?runtime_module_path:ns_prefix_runtime_module_path ()
    );
    ...
    ( Value "number-one-or-greater",
      pack_rule number_one_or_greater
        ?runtime_module_path:number_one_or_greater_runtime_module_path () );
    ( Value "number-zero-one",
      pack_rule number_zero_one
        ?runtime_module_path:number_zero_one_runtime_module_path () );
    ( Value "one-bg-size",
      pack_rule one_bg_size ?runtime_module_path:one_bg_size_runtime_module_path
        () );
    ( Value "page-body",
      pack_rule page_body ?runtime_module_path:page_body_runtime_module_path ()
    );
    ( Value "page-margin-box",
      pack_rule page_margin_box
        ?runtime_module_path:page_margin_box_runtime_module_path () );
    ( Value "page-selector",
      pack_rule page_selector
        ?runtime_module_path:page_selector_runtime_module_path () );
    ( Value "page-selector-list",
      pack_rule page_selector_list
        ?runtime_module_path:page_selector_list_runtime_module_path () );
    ( Value "paint",
      pack_rule paint ?runtime_module_path:paint_runtime_module_path () );
    ( Value "positive-integer",
      pack_rule positive_integer
        ?runtime_module_path:positive_integer_runtime_module_path () );
    ( Value "pseudo-class-selector",
      pack_rule pseudo_class_selector
        ?runtime_module_path:pseudo_class_selector_runtime_module_path () );
    ( Value "pseudo-element-selector",
      pack_rule pseudo_element_selector
        ?runtime_module_path:pseudo_element_selector_runtime_module_path () );
    ( Value "pseudo-page",
      pack_rule pseudo_page ?runtime_module_path:pseudo_page_runtime_module_path
        () );
    ( Value "radial-size",
      pack_rule radial_size ?runtime_module_path:radial_size_runtime_module_path
        () );
    ( Value "ray-size",
      pack_rule ray_size ?runtime_module_path:ray_size_runtime_module_path () );
    ( Value "relative-selector",
      pack_rule relative_selector
        ?runtime_module_path:relative_selector_runtime_module_path () );
    ( Value "relative-selector-list",
      pack_rule relative_selector_list
        ?runtime_module_path:relative_selector_list_runtime_module_path () );
    ( Value "right",
      pack_rule right ?runtime_module_path:right_runtime_module_path () );
    ( Value "shape",
      pack_rule shape ?runtime_module_path:shape_runtime_module_path () );
    ( Value "shape-radius",
      pack_rule shape_radius
        ?runtime_module_path:shape_radius_runtime_module_path () );
    ( Value "single-transition",
      pack_rule single_transition
        ?runtime_module_path:single_transition_runtime_module_path () );
    ( Value "single-transition-no-interp",
      pack_rule single_transition_no_interp
        ?runtime_module_path:single_transition_no_interp_runtime_module_path ()
    );
    ( Value "single-transition-property-no-interp",
      pack_rule single_transition_property_no_interp
        ?runtime_module_path:
          single_transition_property_no_interp_runtime_module_path () );
    ( Value "size",
      pack_rule size ?runtime_module_path:size_runtime_module_path () );
    ( Value "subclass-selector",
      pack_rule subclass_selector
        ?runtime_module_path:subclass_selector_runtime_module_path () );
    ( Value "supports-condition",
      pack_rule supports_condition
        ?runtime_module_path:supports_condition_runtime_module_path () );
    ( Value "supports-decl",
      pack_rule supports_decl
        ?runtime_module_path:supports_decl_runtime_module_path () );
    ( Value "supports-feature",
      pack_rule supports_feature
        ?runtime_module_path:supports_feature_runtime_module_path () );
    ( Value "supports-in-parens",
      pack_rule supports_in_parens
        ?runtime_module_path:supports_in_parens_runtime_module_path () );
    ( Value "supports-selector-fn",
      pack_rule supports_selector_fn
        ?runtime_module_path:supports_selector_fn_runtime_module_path () );
    ( Value "svg-writing-mode",
      pack_rule svg_writing_mode
        ?runtime_module_path:svg_writing_mode_runtime_module_path () );
    ( Value "symbol",
      pack_rule symbol ?runtime_module_path:symbol_runtime_module_path () );
    ( Value "syntax",
      pack_rule syntax ?runtime_module_path:syntax_runtime_module_path () );
    ( Value "syntax-combinator",
      pack_rule syntax_combinator
        ?runtime_module_path:syntax_combinator_runtime_module_path () );
    ( Value "syntax-component",
      pack_rule syntax_component
        ?runtime_module_path:syntax_component_runtime_module_path () );
    ( Value "syntax-multiplier",
      pack_rule syntax_multiplier
        ?runtime_module_path:syntax_multiplier_runtime_module_path () );
    ( Value "syntax-single-component",
      pack_rule syntax_single_component
        ?runtime_module_path:syntax_single_component_runtime_module_path () );
    ( Value "syntax-string",
      pack_rule syntax_string
        ?runtime_module_path:syntax_string_runtime_module_path () );
    ( Value "syntax-type-name",
      pack_rule syntax_type_name
        ?runtime_module_path:syntax_type_name_runtime_module_path () );
    ( Value "target",
      pack_rule target ?runtime_module_path:target_runtime_module_path () );
    Value "top", pack_rule top ?runtime_module_path:top_runtime_module_path ();
    ( Value "track-group",
      pack_rule track_group ?runtime_module_path:track_group_runtime_module_path
        () );
    ( Value "track-list-v0",
      pack_rule track_list_v0
        ?runtime_module_path:track_list_v0_runtime_module_path () );
    ( Value "track-minmax",
      pack_rule track_minmax
        ?runtime_module_path:track_minmax_runtime_module_path () );
    ( Value "transition-behavior-value",
      pack_rule transition_behavior_value
        ?runtime_module_path:transition_behavior_value_runtime_module_path () );
    ( Value "transition-behavior-value-no-interp",
      pack_rule transition_behavior_value_no_interp
        ?runtime_module_path:
          transition_behavior_value_no_interp_runtime_module_path () );
    ( Value "try-tactic",
      pack_rule try_tactic ?runtime_module_path:try_tactic_runtime_module_path
        () );
    ( Value "type-or-unit",
      pack_rule type_or_unit
        ?runtime_module_path:type_or_unit_runtime_module_path () );
    ( Value "type-selector",
      pack_rule type_selector
        ?runtime_module_path:type_selector_runtime_module_path () );
    ( Value "viewport-length",
      pack_rule viewport_length
        ?runtime_module_path:viewport_length_runtime_module_path () );
    ( Value "webkit-gradient-color-stop",
      pack_rule webkit_gradient_color_stop
        ?runtime_module_path:webkit_gradient_color_stop_runtime_module_path () );
    ( Value "webkit-gradient-point",
      pack_rule webkit_gradient_point
        ?runtime_module_path:webkit_gradient_point_runtime_module_path () );
    ( Value "webkit-gradient-radius",
      pack_rule webkit_gradient_radius
        ?runtime_module_path:webkit_gradient_radius_runtime_module_path () );
    ( Value "wq-name",
      pack_rule wq_name ?runtime_module_path:wq_name_runtime_module_path () );
