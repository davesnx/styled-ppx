...
let entries : (kind * packed_rule) list =
  [
    Property "-webkit-appearance", pack_module (module Property__webkit_appearance);
    ( Property "-webkit-background-clip",
      pack_module (module Property__webkit_background_clip) );
    Property "-webkit-border-before", pack_module (module Property__webkit_border_before);
    ...
    Property "-webkit-box-reflect", pack_module (module Property__webkit_box_reflect);
    ...
    Property "-webkit-line-clamp", pack_module (module Property__webkit_line_clamp);
    ...
    Property "-webkit-mask-box-image", pack_module (module Property__webkit_mask_box_image);
    Property "-webkit-mask-clip", pack_module (module Property__webkit_mask_clip);
    Property "-webkit-mask-composite", pack_module (module Property__webkit_mask_composite);
    Property "-webkit-mask-image", pack_module (module Property__webkit_mask_image);
    Property "-webkit-mask-origin", pack_module (module Property__webkit_mask_origin);
    Property "-webkit-mask-position", pack_module (module Property__webkit_mask_position);
    ...
    Property "-webkit-mask-repeat", pack_module (module Property__webkit_mask_repeat);
    Property "-webkit-mask-repeat-x", pack_module (module Property__webkit_mask_repeat_x);
    Property "-webkit-mask-repeat-y", pack_module (module Property__webkit_mask_repeat_y);
    Property "-webkit-mask-size", pack_module (module Property__webkit_mask_size);
    ( Property "-webkit-overflow-scrolling",
      pack_module (module Property__webkit_overflow_scrolling) );
    Property "-webkit-text-security", pack_module (module Property__webkit_text_security);
    Property "-webkit-text-stroke", pack_module (module Property__webkit_text_stroke);
    ( Property "-webkit-text-stroke-width",
      pack_module (module Property__webkit_text_stroke_width) );
    Property "-webkit-touch-callout", pack_module (module Property__webkit_touch_callout);
    Property "-webkit-user-drag", pack_module (module Property__webkit_user_drag);
    Property "-webkit-user-modify", pack_module (module Property__webkit_user_modify);
    Property "-webkit-user-select", pack_module (module Property__webkit_user_select);
    Property "-webkit-box-orient", pack_module (module Property__webkit_box_orient);
    Property "-webkit-box-shadow", pack_module (module Property__webkit_box_shadow);
    Property "-webkit-font-smoothing", pack_module (module Property__webkit_font_smoothing);
