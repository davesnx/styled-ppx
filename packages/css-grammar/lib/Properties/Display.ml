...
module Property_display =
  ...
  "'block' | 'contents' | 'flex' | 'flow' | 'flow-root' | 'grid' | 'inline' | \
   ...
   'grid-lanes' | 'inline-grid-lanes' | 'table' | 'table-caption' | \
   'table-cell' | 'table-column' | 'table-column-group' | 'table-footer-group' \
   | 'table-header-group' | 'table-row' | 'table-row-group' | '-webkit-flex' | \
   '-webkit-inline-flex' | '-webkit-box' | '-webkit-inline-box' | \
