...
let entries : (kind * packed_rule) list =
  [
    ...
    Value "inset-value", pack_module (module Inset_value);
    Value "repeat-line-color", pack_module (module Repeat_line_color);
    Value "auto-repeat-line-color", pack_module (module Auto_repeat_line_color);
    Value "line-color-or-repeat", pack_module (module Line_color_or_repeat);
    Value "line-color-list", pack_module (module Line_color_list);
    Value "auto-line-color-list", pack_module (module Auto_line_color_list);
    Value "repeat-line-style", pack_module (module Repeat_line_style);
    Value "auto-repeat-line-style", pack_module (module Auto_repeat_line_style);
    Value "line-style-or-repeat", pack_module (module Line_style_or_repeat);
    Value "line-style-list", pack_module (module Line_style_list);
    Value "auto-line-style-list", pack_module (module Auto_line_style_list);
    Value "repeat-line-width", pack_module (module Repeat_line_width);
    Value "auto-repeat-line-width", pack_module (module Auto_repeat_line_width);
    Value "line-width-or-repeat", pack_module (module Line_width_or_repeat);
    Value "line-width-list", pack_module (module Line_width_list);
    Value "auto-line-width-list", pack_module (module Auto_line_width_list);
    Value "gap-rule", pack_module (module Gap_rule);
    Value "gap-repeat-rule", pack_module (module Gap_repeat_rule);
    Value "gap-auto-repeat-rule", pack_module (module Gap_auto_repeat_rule);
    Value "gap-rule-or-repeat", pack_module (module Gap_rule_or_repeat);
    Value "gap-rule-list", pack_module (module Gap_rule_list);
    Value "gap-auto-rule-list", pack_module (module Gap_auto_rule_list);
