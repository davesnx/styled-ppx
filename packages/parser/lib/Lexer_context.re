...
type lexer_state = {
  ...
  mutable declaration_value_allows_implicit_nested_terminator: bool,
  mutable declaration_value_has_content: bool,
  mutable declaration_value_top_level_items: int,
  mutable declaration_value_ident_like_prefix: bool,
