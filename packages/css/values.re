/* This file contains the values of the CSS Spec as modules with types and toString */

module Js = {
  /* Js module to abstract the platform to not rely on Belt, Js.* or
     any OCaml version standard library */
  module String = {
...
/* More generic printers for groups of values */
