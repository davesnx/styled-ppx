...
module Make : functor (CssImpl : Css_Core.CssImplementationIntf) ->
  MakeResult
    with type styleEncoding := CssImpl.styleEncoding
     and type renderer := CssImpl.renderer
...
val backdropFilter : Types.BackdropFilter.t list -> rule
  [@@ns.doc
    "\n\
...
val backgroundPosition4 :
  ...
  offsetY:(Types.Length.t[@ns.namedArgLoc]) ->
  rule
...
val padding4 :
  ...
  bottom:(Types.Length.t[@ns.namedArgLoc]) ->
  left:(Types.Length.t[@ns.namedArgLoc]) ->
  rule
...
val firstOfType : rule list -> rule
  [@@ns.doc
    "\n\
...
val focusVisible : rule list -> rule
  [@@ns.doc
    "\n\
...
val focusWithin : rule list -> rule
  [@@ns.doc
    "\n\
...
val indeterminate : rule list -> rule
  [@@ns.doc
    "\n\
...
val lang : string -> rule list -> rule
  [@@ns.doc
    "\n\
...
val not_ : string -> rule list -> rule
  [@@ns.doc
    "\n\
...
val nthChild : Nth.t -> rule list -> rule
  [@@ns.doc
    "\n\
...
val nthLastChild : Nth.t -> rule list -> rule
  [@@ns.doc
    "\n\
...
val nthLastOfType : Nth.t -> rule list -> rule
  [@@ns.doc
    "\n\
...
val nthOfType : Nth.t -> rule list -> rule
  [@@ns.doc
    "\n\
...
val firstLetter : rule list -> rule
  [@@ns.doc
    "\n\
...
val placeholder : rule list -> rule
  [@@ns.doc
    "\n\
...
val child : string -> rule list -> rule
...
val directSibling : rule list -> rule
  [@@ns.doc
    "\n\
...
val fontFace :
  ...
  ?fontWeight:
    ([< Types.FontWeight.t | Types.Var.t | Types.Cascading.t ][@ns.namedArgLoc]) ->
