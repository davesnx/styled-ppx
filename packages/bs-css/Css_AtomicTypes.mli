module Cascading :
sig
  type nonrec t = [ `initial  | `inherit_  | `unset ]
  val initial : [> t]
  val inherit_ : [> t]
  val unset : [> t]
...
module Var :
sig
  type nonrec t = [ `var of string  | `varDefault of (string * string) ]
  val var : string -> [> t]
...
module Time :
sig
  type nonrec t = [ `s of float  | `ms of float ][@@ns.doc
...
module Percentage :
sig
  type nonrec t = [ `percent of float ][@@ns.doc
...
module Url :
sig
  type nonrec t = [ `url of string ][@@ns.doc
...
sig
  type t =
    [ `ch of float  | `em of float  | `ex of float  | `rem of float
    | `vh of float  | `vw of float  | `vmin of float  | `vmax of float
    | `px of int  | `pxFloat of float  | `cm of float  | `mm of float
    | `inch of float  | `pc of float  | `pt of int  | `zero
    | `calc of ([ `add  | `sub  | `mult ] * t * t)  | `percent of float ]
...
sig
  type nonrec t =
    [ `deg of float  | `rad of float  | `grad of float  | `turn of float ]
  [@@ns.doc
...
module Position :
sig
  type nonrec t = [ `absolute  | `relative  | `static  | `fixed  | `sticky ]
  val absolute : [> t]
  val relative : [> t]
  val static : [> t]
  val fixed : [> t]
...
module Isolation :
sig type nonrec t = [ `auto  | `isolate ] val toString : t -> string end
...
module FontVariant :
sig
  type nonrec t = [ `normal  | `smallCaps ]
  val normal : [> t]
  val smallCaps : [> t]
  val toString : t -> string
end
module FontStyle :
sig
  type nonrec t = [ `normal  | `italic  | `oblique ]
  val normal : [> t]
  val italic : [> t]
  val oblique : [> t]
  val toString : t -> string
...
sig
  type nonrec t =
    [ `auto  | `fill  | `content  | `maxContent  | `minContent
    | `fitContent ]
  val fill : [> t]
  val content : [> t]
  val maxContent : [> t]
...
module Overflow :
sig
  type nonrec t = [ `hidden  | `visible  | `scroll  | `auto  | `clip ]
  val hidden : [> t]
  val visible : [> t]
  val scroll : [> t]
  val auto : [> t]
...
module Margin :
sig type nonrec t = [ `auto ] val auto : [> t] val toString : t -> string end
module GridAutoFlow :
sig
  type nonrec t = [ `column  | `row  | `columnDense  | `rowDense ]
  val toString : t -> string
end
module Gap : sig type nonrec t = [ `normal ] val toString : t -> string end
module RowGap = Gap
module ColumnGap = Gap
module ScrollBehavior :
sig type nonrec t = [ `auto  | `smooth ] val toString : t -> string end
module OverscrollBehavior :
sig type nonrec t = [ `auto  | `contain  | `none ] val toString : t -> string
end
module OverflowAnchor :
sig type nonrec t = [ `auto  | `none ] val toString : t -> string end
module ColumnWidth :
sig type nonrec t = [ `auto ] val toString : t -> string end
module CaretColor :
sig type nonrec t = [ `auto ] val toString : t -> string end
module VerticalAlign :
sig
  type nonrec t =
    [ `baseline  | `sub  | `super  | `top  | `textTop  | `middle  | `bottom
    | `textBottom ]
  val toString : t -> string
end
...
sig
  type nonrec t =
    [ `linear  | `ease  | `easeIn  | `easeOut  | `easeInOut  | `stepStart
    | `stepEnd  | `steps of (int * [ `start  | `end_ ])
    | `cubicBezier of (float * float * float * float)  | `jumpStart
    | `jumpEnd  | `jumpNone  | `jumpBoth ]
  val linear : [> t]
  val ease : [> t]
  val easeIn : [> t]
  val easeOut : [> t]
...
module RepeatValue :
sig
  type nonrec t = [ `autoFill  | `autoFit  | `num of int ]
  val toString : t -> string
end
module ListStyleType :
sig
  type nonrec t =
    [ `disc  | `circle  | `square  | `decimal  | `lowerAlpha  | `upperAlpha
    | `lowerGreek  | `lowerLatin  | `upperLatin  | `lowerRoman
    | `upperRoman  | `none ]
  val toString : t -> string
end
module ListStylePosition :
sig type nonrec t = [ `inside  | `outside ] val toString : t -> string end
[@@ns.doc
...
sig
  type nonrec t =
    [ `num of int  | `thin  | `extraLight  | `light  | `normal  | `medium
...
sig
  type nonrec t =
    ...
    | `translateX of Length.t  | `translateY of Length.t
    | `translateZ of Length.t  | `scale of (float * float)
    | `scale3d of (float * float * float)  | `scaleX of float
    | `scaleY of float  | `scaleZ of float  | `rotate of Angle.t
    | `rotate3d of (float * float * float * Angle.t)  | `rotateX of Angle.t
    | `rotateY of Angle.t  | `rotateZ of Angle.t
    | `skew of (Angle.t * Angle.t)  | `skewX of Angle.t  | `skewY of Angle.t
    | `perspective of int ]
  val translate :
    Length.t -> Length.t -> [> `translate of (Length.t * Length.t) ]
  val translate3d :
    Length.t ->
      Length.t ->
        Length.t -> [> `translate3d of (Length.t * Length.t * Length.t) ]
...
sig
  type nonrec t = [ `normal  | `reverse  | `alternate  | `alternateReverse ]
  val toString : t -> string
end
module AnimationFillMode :
sig
  type nonrec t = [ `none  | `forwards  | `backwards  | `both ]
  val toString : t -> string
end
module AnimationIterationCount :
sig type nonrec t = [ `infinite  | `count of int ] val toString : t -> string
end
module AnimationPlayState :
sig type nonrec t = [ `paused  | `running ] val toString : t -> string end
module Cursor :
sig
  type nonrec t =
    [ `auto  | `default  | `none  | `contextMenu  | `help  | `pointer
    | `progress  | `wait  | `cell  | `crosshair  | `text  | `verticalText
    | `alias  | `copy  | `move  | `noDrop  | `notAllowed  | `grab
    | `grabbing  | `allScroll  | `colResize  | `rowResize  | `nResize
    | `eResize  | `sResize  | `wResize  | `neResize  | `nwResize
    | `seResize  | `swResize  | `ewResize  | `nsResize  | `neswResize
    | `nwseResize  | `zoomIn  | `zoomOut ]
  val auto : [> t]
  val default : [> t]
  val none : [> t]
  val contextMenu : [> t]
...
sig
  type nonrec t =
    ...
    | `hsla of
        (Angle.t * Percentage.t * Percentage.t *
  ...
  val hsla :
    Angle.t ->
      Percentage.t ->
        Percentage.t -> [ `num of float  | Percentage.t] -> [> t]
  val hex : string -> [> t]
  val transparent : [> t]
  val currentColor : [> t]
  val toString : t -> string
...
sig type nonrec t = [ `auto  | `none ] val toString : t -> string end
module Perspective :
sig type nonrec t = [ `none ] val toString : t -> string end
...
module LineHeight :
sig type nonrec t = [ `normal  | `abs of float ] val toString : t -> string
end
module WordSpacing :
sig type nonrec t = [ `normal ] val toString : t -> string end
module DisplayOutside :
sig
  type nonrec t = [ `block  | `inline  | `runIn ]
  val toString : t -> string
end[@@ns.doc "\n https://developer.mozilla.org/docs/Web/CSS/display\n "]
module DisplayInside :
sig type nonrec t = [ `table  | `flex  | `grid ] val toString : t -> string
end[@@ns.doc "\n https://developer.mozilla.org/docs/Web/CSS/display\n "]
module DisplayListItem :
sig type nonrec t = [ `listItem ] val toString : t -> string end[@@ns.doc
                                                                  "\n https://developer.mozilla.org/docs/Web/CSS/display\n "]
module DisplayInternal :
sig
  type nonrec t =
    [ `tableRowGroup  | `tableHeaderGroup  | `tableFooterGroup  | `tableRow
    | `tableCell  | `tableColumnGroup  | `tableColumn  | `tableCaption ]
  val toString : t -> string
end[@@ns.doc "\n https://developer.mozilla.org/docs/Web/CSS/display\n "]
module DisplayBox :
sig type nonrec t = [ `contents  | `none ] val toString : t -> string end
[@@ns.doc "\n https://developer.mozilla.org/docs/Web/CSS/display-box\n "]
module DisplayLegacy :
sig
  type nonrec t =
    [ `inlineBlock  | `inlineFlex  | `inlineGrid  | `inlineTable ]
  val toString : t -> string
end[@@ns.doc "\n https://developer.mozilla.org/docs/Web/CSS/display\n "]
module JustifySelf :
sig
  type nonrec t = [ `auto  | `normal  | `stretch ]
  val toString : t -> string
end[@@ns.doc "\n https://developer.mozilla.org/docs/Web/CSS/justify-self\n "]
module PositionalAlignment :
sig
  type nonrec t =
    [ `center  | `start  | `end_  | `flexStart  | `flexEnd  | `selfStart
    | `selfEnd  | `left  | `right ]
  val toString : t -> string
end[@@ns.doc
...
sig
  type nonrec t = [ `legacy  | `legacyRight  | `legacyLeft  | `legacyCenter ]
  val toString : t -> string
end[@@ns.doc
     "\n https://drafts.csswg.org/css-align-3/#propdef-justify-items\n "]
module TextAlign :
sig
  type nonrec t = [ `start  | `left  | `right  | `center  | `justify ]
  val toString : t -> string
end[@@ns.doc "\n https://developer.mozilla.org/docs/Web/CSS/text-align\n "]
module WordBreak :
sig
  type nonrec t = [ `normal  | `breakAll  | `keepAll ]
  val toString : t -> string
...
module AlignItems :
sig type nonrec t = [ `normal  | `stretch ] val toString : t -> string end
...
module AlignContent :
sig
  type nonrec t = [ `center  | `start  | `end_  | `flexStart  | `flexEnd ]
  val toString : t -> string
end[@@ns.doc
     "\n https://developer.mozilla.org/docs/Web/CSS/align-content\n "]
module ObjectFit :
sig
  type nonrec t = [ `fill  | `contain  | `cover  | `none  | `scaleDown ]
  val toString : t -> string
...
module Float :
sig
  type nonrec t = [ `left  | `right  | `none  | `inlineStart  | `inlineEnd ]
  val toString : t -> string
end[@@ns.doc "\n https://developer.mozilla.org/docs/Web/CSS/float\n "]
module Visibility :
sig
  type nonrec t = [ `visible  | `hidden  | `collapse ]
  val toString : t -> string
end[@@ns.doc "\n https://developer.mozilla.org/docs/Web/CSS/visibility\n "]
module TableLayout :
sig type nonrec t = [ `auto  | `fixed ] val toString : t -> string end
[@@ns.doc "\n https://developer.mozilla.org/docs/Web/CSS/table-layout\n "]
module BorderCollapse :
sig type nonrec t = [ `collapse  | `separate ] val toString : t -> string end
[@@ns.doc "\n https://developer.mozilla.org/docs/Web/CSS/border-collapse\n "]
module FlexWrap :
sig
  type nonrec t = [ `nowrap  | `wrap  | `wrapReverse ]
  val toString : t -> string
end[@@ns.doc "\n https://developer.mozilla.org/docs/Web/CSS/flex-wrap\n "]
module FlexDirection :
sig
  type nonrec t = [ `row  | `rowReverse  | `column  | `columnReverse ]
  val toString : t -> string
end[@@ns.doc
     "\n https://developer.mozilla.org/docs/Web/CSS/flex-direction\n "]
module BoxSizing :
sig type nonrec t = [ `contentBox  | `borderBox ] val toString : t -> string
end[@@ns.doc "\n https://developer.mozilla.org/docs/Web/CSS/box-sizing\n "]
module ColumnCount :
sig type nonrec t = [ `auto  | `count of int ] val toString : t -> string end
[@@ns.doc "\n https://developer.mozilla.org/docs/Web/CSS/box-sizing\n "]
module UserSelect :
sig
  type nonrec t = [ `none  | `auto  | `text  | `contain  | `all ]
  val toString : t -> string
end[@@ns.doc "\n https://developer.mozilla.org/docs/Web/CSS/user-select\n "]
module TextTransform :
sig
  type nonrec t = [ `none  | `capitalize  | `uppercase  | `lowercase ]
  val toString : t -> string
end
module GridTemplateAreas :
sig
  type nonrec t = [ `none  | `areas of string array ]
...
sig
  type nonrec t =
    [ `auto  | `ident of string  | `num of int
...
sig
  type nonrec t =
    ...
    | `invert of [ `num of int  | `percent of float ]  | `none
...
sig
  module X :
  sig
    type nonrec t = [ `left  | `right  | `center ]
    val toString : t -> string
  end
  module Y :
  sig
    type nonrec t = [ `top  | `bottom  | `center ]
    val toString : t -> string
  end
  type nonrec t = [ X.t | Y.t]
  val toString : t -> string
end[@@ns.doc
...
sig
  type nonrec twoValue = [ `repeat  | `space  | `round  | `noRepeat ]
  type nonrec t = [ `repeatX  | `repeatY  | twoValue]
...
module TextOverflow :
sig
  type nonrec t = [ `clip  | `ellipsis  | `string of string ]
  val toString : t -> string
end[@@ns.doc
...
sig
  type nonrec t = [ `solid  | `double  | `dotted  | `dashed  | `wavy ]
  val toString : t -> string
end[@@ns.doc
     "\n https://developer.mozilla.org/docs/Web/CSS/text-decoration-style\n "]
module TextDecorationThickness :
sig type nonrec t = [ `fromFont  | `auto ] val toString : t -> string end
[@@ns.doc
  "\n https://developer.mozilla.org/en-US/docs/Web/CSS/text-decoration-thickness\n "]
module Width :
sig
  type nonrec t = [ `auto  | `fitContent  | `maxContent  | `minContent ]
  val toString : t -> string
end[@@ns.doc "\n https://developer.mozilla.org/docs/Web/CSS/width\n "]
module MaxWidth :
sig type nonrec t = [ `none ] val toString : t -> string end[@@ns.doc
...
module OverflowWrap :
sig
  type nonrec t = [ `normal  | `breakWord  | `anywhere ]
  val toString : t -> string
end[@@ns.doc
...
sig
  type nonrec t =
    [ `marginBox  | `borderBox  | `paddingBox  | `contentBox  | `fillBox
    | `strokeBox  | `viewBox ]
  val marginBox : [> t]
  val borderBox : [> t]
  val paddingBox : [> t]
...
sig type nonrec t = [ `visible  | `hidden ] val toString : t -> string end
[@@ns.doc
  "\n https://developer.mozilla.org/docs/Web/CSS/backface-visibility\n "]
module Flex :
sig type nonrec t = [ `auto  | `initial  | `none ] val toString : t -> string
end[@@ns.doc "\n https://developer.mozilla.org/docs/Web/CSS/flex\n "]
module TransformStyle :
sig type nonrec t = [ `preserve3d  | `flat ] val toString : t -> string end
[@@ns.doc "\n https://developer.mozilla.org/docs/Web/CSS/transform-style\n "]
module TransformBox :
sig
  type nonrec t =
    [ `contentBox  | `borderBox  | `fillBox  | `strokeBox  | `viewBox ]
  val toString : t -> string
end[@@ns.doc
...
sig
  type nonrec t =
    [ `custom of string  | `serif  | `sansSerif  | `cursive  | `fantasy
    | `monospace  | `systemUi  | `emoji  | `math  | `fangsong ]
  val toString : t -> string
end[@@ns.doc "\n https://developer.mozilla.org/docs/Web/CSS/font-family\n "]
module FontDisplay :
sig
  type nonrec t = [ `auto  | `block  | `swap  | `fallback  | `optional ]
  val toString : t -> string
end[@@ns.doc
     "\n * https://developer.mozilla.org/fr/docs/Web/CSS/@font-face/font-display\n "]
module CounterStyleType :
sig type nonrec t = ListStyleType.t val toString : t -> string end
[@@ns.doc
  "\n * https://developer.mozilla.org/en-US/docs/Web/CSS/counters\n "]
module Counter :
sig
  type nonrec style = [ CounterStyleType.t | `unset ]
...
sig
  ...
  val counters :
    ?style:((style)[@ns.namedArgLoc ]) ->
      ?separator:((string)[@ns.namedArgLoc ]) -> string -> t
  val toString : t -> string
end[@@ns.doc
     "\n * https://developer.mozilla.org/en-US/docs/Web/CSS/counters\n "]
module CounterIncrement :
sig
  type nonrec t = [ `none  | `increment of (string * int) ]
...
module CounterReset :
sig
  type nonrec t = [ `none  | `reset of (string * int) ]
...
module CounterSet :
sig
  type nonrec t = [ `none  | `set of (string * int) ]
...
sig
  type nonrec t =
    [ `none  | `normal  | `openQuote  | `closeQuote  | `noOpenQuote
    | `noCloseQuote  | `attr of string  | `text of string ]
  val toString : t -> string
end[@@ns.doc
...
sig
  module Fill :
  sig
    type nonrec t = [ `none  | `contextFill  | `contextStroke ]
    val contextFill : [> t]
    val contextStroke : [> t]
    val toString : t -> string
  end
...
sig
  type nonrec t =
    [ `auto  | `none  | `panX  | `panY  | `panLeft  | `panRight  | `panUp
    | `panDown  | `pinchZoom  | `manipulation ]
  val toString : t -> string
end[@@ns.doc
