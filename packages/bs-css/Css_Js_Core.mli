...
module Make :
functor (C : Css_Core.CssImplementationIntf) ->
  (MakeResult with type  styleEncoding :=  C.styleEncoding and type
     renderer :=  C.renderer)
...
val backdropFilter : Types.BackdropFilter.t array -> rule[@@ns.doc
...
val backgroundPositions :
  ...
  | `hv of
      ([ Types.BackgroundPosition.X.t | Types.Length.t] *
        [ Types.BackgroundPosition.Y.t | Types.Length.t])
       | Types.Length.t
  | Types.Var.t | Types.Cascading.t] array -> rule
...
val borderRadius4 :
  topLeft:((Types.Length.t)[@ns.namedArgLoc ]) ->
    topRight:((Types.Length.t)[@ns.namedArgLoc ]) ->
      bottomLeft:((Types.Length.t)[@ns.namedArgLoc ]) ->
        bottomRight:((Types.Length.t)[@ns.namedArgLoc ]) -> rule
...
val contentRules :
  [< Types.Content.t | Types.Counter.t | Types.Counters.t
  | 'gradient Types.Gradient.t | Types.Url.t] array -> rule
...
val marginBottom :
  [< Types.Length.t | Types.Margin.t | Types.Var.t | Types.Cascading.t] ->
    rule
val maxHeight :
  [< Types.Height.t | Types.MaxHeight.t | Types.Percentage.t | Types.Length.t
  | Types.Var.t | Types.Cascading.t] -> rule[@@ns.doc
                                              "\n The max-height CSS property sets the maximum height of an element.\n It prevents the used value of the height property from becoming larger than the value specified for max-height.\n "]
val maxWidth :
  [< Types.Width.t | Types.MaxWidth.t | Types.Percentage.t | Types.Length.t
  | Types.Var.t | Types.Cascading.t] -> rule[@@ns.doc
                                              "\n The max-width CSS property sets the maximum width of an element.\n It prevents the used value of the width property from becoming larger than the value specified by max-width.\n "]
val minHeight :
  [< Types.Height.t | Types.MinHeight.t | Types.Percentage.t | Types.Length.t
  | Types.Var.t | Types.Cascading.t] -> rule[@@ns.doc
                                              "\n The min-height CSS property sets the minimum height of an element.\n It prevents the used value of the height property from becoming smaller than the value specified for min-height.\n "]
val minWidth :
  [< Types.Width.t | Types.MinWidth.t | Types.Percentage.t | Types.Length.t
  | Types.Var.t | Types.Cascading.t] -> rule[@@ns.doc
...
val disabled : rule array -> rule[@@ns.doc
...
val empty : rule array -> rule[@@ns.doc
...
val enabled : rule array -> rule[@@ns.doc
...
val host : ?selector:((string)[@ns.namedArgLoc ]) -> rule array -> rule
[@@ns.doc
...
val hover : rule array -> rule[@@ns.doc
...
val not_ : string -> rule array -> rule[@@ns.doc
...
val nthChild : Nth.t -> rule array -> rule[@@ns.doc
                                            "\n The :nth-child() CSS pseudo-class matches elements based on their position in a group of siblings.\n "]
val nthLastChild : Nth.t -> rule array -> rule[@@ns.doc
                                                "\n The :nth-last-child() CSS pseudo-class matches elements based on their position among a group of siblings,\n counting from the end.\n "]
val nthLastOfType : Nth.t -> rule array -> rule[@@ns.doc
...
val outOfRange : rule array -> rule[@@ns.doc
...
val visited : rule array -> rule[@@ns.doc
...
val firstLine : rule array -> rule[@@ns.doc
...
val child : string -> rule array -> rule[@@ns.doc
                                          "\n Combinators selectors\n "]
[@@ns.doc
  "\n The > combinator selects nodes that are direct children of the first element.\n "]
val children : rule array -> rule[@@ns.doc
                                   "\n The > * combinator selects all nodes that are direct children of the first element.\n "]
val directSibling : rule array -> rule[@@ns.doc
...
val siblings : rule array -> rule[@@ns.doc
...
val fontFace :
  fontFamily:((string)[@ns.namedArgLoc ]) ->
    src:(([< `localUrl of string  | Types.Url.t] array)[@ns.namedArgLoc ]) ->
