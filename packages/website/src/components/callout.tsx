/* Vendored from nextra v3 (packages/nextra/src/client/components/callout.tsx
   at nextra@3.3.1): v4's Callout ships Tailwind-v4 `x:` classes incompatible
   with this custom theme's Tailwind v3 pipeline. */
import cn from "clsx";
