...
Aside from all of this, there were a few efforts on bringing type-safety on top of CSS with [bs-css](https://github.com/giraud/bs-css) or [bs-glamour](). Even thought I liked that approach, it had two big drawbacks. The need for learning a new DSL on top of CSS was tedious and the runtime is huge.
