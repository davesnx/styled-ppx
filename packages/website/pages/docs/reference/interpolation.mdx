...
Interpolation means using any identifier as a value inside CSS. "any identifier" means ReScript variables or module accessors (https://rescript-lang.org/try?code=LYewJgrgNgpgBAFQBY2PAvHA3gKDnWAFzgHMAnGATzkwGEBnegKXoDoUAPACgCIAhAKJ8AInwAcPAJQ4AvjiA). Useful for reusing variables, handling themes or conditionally apply styles based on props at run-time.
