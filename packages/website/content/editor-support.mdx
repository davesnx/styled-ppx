...
One of the downsides of embedding a language (CSS) into another language (<Ml>OCaml</Ml><Re>Reason</Re>) is the limited editor support. Because of that, we provide an editor extension that brings syntax highlighting for the CSS inside the styled-ppx notation.
