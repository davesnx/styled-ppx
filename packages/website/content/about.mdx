...
Since 0.62.0 this vision is complete: all CSS is [statically extracted](/how-it-works) at compile time into atomic, content-addressed rules — your styles ship as a plain `.css` asset with **zero runtime**, something the JavaScript-based equivalents can only approximate.
