...
let randomProperty = CssJs.unsafe("-webkit-invented-property", "10px");
...
Here the safety will rely on your usage of `CssJs.unsafe{:rescript}` `CssJs.unsafe{:reason}` correctly.
