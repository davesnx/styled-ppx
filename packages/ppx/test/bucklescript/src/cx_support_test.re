...
let testData = [
  ...
  (
    [%cx "opacity: 0.9"],
    CssJs.style(. [|CssJs.opacity(0.9)|])
  ),
  (
    [%cx "visibility: visible"],
    CssJs.style(. [|CssJs.unsafe("visibility", "visible")|])
  ),
  (
    [%cx "hyphens: manual"],
  ...
  (
    [%cx "stroke: none"],
    CssJs.style(. [|CssJs.unsafe("stroke", "none")|])
  ),
  (
    [%cx "direction: ltr"],
  ...
  (
    [%cx "clear: none"],
    CssJs.style(. [|CssJs.unsafe("clear", "none")|])
  ),
  (
  ...
  (
    ...
    CssJs.style(. [|CssJs.flexDirection(`row), CssJs.flexWrap(`wrap)|])
  ),
  (
    [%cx "flex: 1 2 content"],
  ...
  (
    [%cx "flex: unset"],
    CssJs.style(. [|CssJs.unsafe("flex", "unset")|])
  ),
  (
    [%cx "width: auto"],
    CssJs.style(. [|CssJs.width(`auto)|])
  ),
  /*
  (
    [%cx "width: 0"],
  ...
  */
  (
    [%cx "height: 5px"],
    CssJs.style(. [|CssJs.height(`pxFloat(5.))|])
  ),
  (
    [%cx "min-width: 5%"],
    CssJs.style(. [|CssJs.minWidth(`percent(5.))|])
  ),
  (
    [%cx "min-height: 5em"],
    CssJs.style(. [|CssJs.minHeight(`em(5.))|])
  ),
  (
    [%cx "max-width: none"],
    CssJs.style(. [|CssJs.maxWidth(`none)|])
  ),
  (
    [%cx "max-height: 3vh"],
    CssJs.style(. [|CssJs.maxHeight(`vh(3.))|])
  ),
  (
    [%cx "box-sizing: border-box"],
    CssJs.style(. [|CssJs.boxSizing(`borderBox)|])
  ...
  (
    [%cx "opacity: 0.5"],
    CssJs.style(. [|CssJs.opacity(0.5)|])
  ),
  (
    [%cx "opacity: 60%"],
    CssJs.style(. [|CssJs.opacity(0.6)|])
  ),
  (
    [%cx "object-fit: fill"],
    CssJs.style(. [|CssJs.objectFit(`fill)|])
  ),
  (
  ...
  (
    ...
    CssJs.style(. [|CssJs.textTransform(`capitalize)|])
  ),
  (
  ...
  (
    ...
    CssJs.style(. [|CssJs.wordSpacing(`normal)|])
  ),
  (
    [%cx "word-spacing: 5px"],
    CssJs.style(. [|CssJs.wordSpacing(`pxFloat(5.))|])
  ),
  (
    [%cx "letter-spacing: normal"],
    CssJs.style(. [|CssJs.letterSpacing(`normal)|])
  ),
  (
    [%cx "letter-spacing: 5px"],
    CssJs.style(. [|CssJs.letterSpacing(`pxFloat(5.))|])
  ),
  (
    [%cx "text-indent: 5%"],
    CssJs.style(. [|CssJs.textIndent(`percent(5.))|])
  ),
  (
    [%cx "background: blue;"],
    CssJs.style(. [|CssJs.unsafe("background", "blue")|])
  ),
  (
    [%cx "text-transform: uppercase;"],
    CssJs.style(. [|CssJs.textTransform(`uppercase)|])
  ),
  (
    [%cx "line-height: 1.4;"],
    CssJs.style(. [|CssJs.unsafe("lineHeight", "1.4")|])
  ),
  (
    [%cx "line-height: 100%;"],
    CssJs.style(. [|CssJs.unsafe("lineHeight", "100%")|])
  ),
  (
    [%cx "grid-gap: 20px;"],
