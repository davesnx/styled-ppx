    ...
    properties: {
      ...
      "border-radius": {
        ...
        tests: [
          ...
          "10px / 20px",
          "2px 4px 8px 16px",
          "2px 4px 8px 16px / 2px 4px 8px 16px",
        ],
      },
      "border-image-source": {
        links: {
  ...
  "css-transforms-2": {
    ...
    properties: {
      ...
      rotate: {
        ...
        tests: ["none"]
          .concat(["", "x", "y", "z", "-1 0 2"].and(["45deg"]))
          .concat(["45deg"].and(["x", "y", "z", "-1 0 2"])),
      },
      "transform-style": {
        links: {
  ...
  "css-masking-1": {
    ...
    properties: {
      ...
      "mask-repeat": {
        ...
        tests: ["repeat-x", "repeat-y"].concat(
