...
If this test fail means that the module is not in sync with the ppx
  ...
  [@css "@property --elevation1-1yjawpc_1{syntax:\"*\";inherits:false;}"];
  [@css "@property --elevation1-1yjawpc_2{syntax:\"*\";inherits:false;}"];
  [@css "@property --elevation1-1yjawpc_3{syntax:\"*\";inherits:false;}"];
  [@css "@property --color-2e0nuk_1{syntax:\"*\";inherits:false;}"];
  [@css "@property --color-2e0nuk_2{syntax:\"*\";inherits:false;}"];
  [@css "@property --color-2e0nuk_3{syntax:\"*\";inherits:false;}"];
  [@css "@property --color-bbusdu_1{syntax:\"*\";inherits:false;}"];
  [@css "@property --color-bbusdu_2{syntax:\"*\";inherits:false;}"];
  [@css "@property --color-bbusdu_3{syntax:\"*\";inherits:false;}"];
  [@css "@property --color-bbusdu_4{syntax:\"*\";inherits:false;}"];
  [@css "@property --boxDark-1imew2g{syntax:\"*\";inherits:false;}"];
  ...
  [@css ".css-1n1u5up{background-repeat:repeat-x,repeat-y}"];
  ...
  [@css
    ".css-1be8z28{-webkit-background-clip:text,border-area;background-clip:text,border-area}"
  ];
  ...
  [@css
    ".css-1ad99i3{box-shadow:inset 1px 2px 3px 4px black,1px 2px 3px 4px black}"
  ];
  [@css ".css-1hk08hh{box-shadow:1px 1px,inset 2px 2px red}"];
  [@css ".css-r5g0y5{box-shadow:0 0 5px,inset 0 0 10px black}"];
  [@css
    ".css-f5n3c1{box-shadow:-1px 1px 0px 0px var(--elevation1-1yjawpc_1),1px 1px 0px 0px var(--elevation1-1yjawpc_2),0px -1px 0px 0px var(--elevation1-1yjawpc_3)}"
  ];
  ...
  [@css ".css-1a28g8t{background-position-x:left,left}"];
  [@css ".css-t6ixdl{background-position-x:left,right}"];
  [@css ".css-rcw6p{background-position-x:right,left}"];
  [@css ".css-12w0v04{background-position-x:left,0%}"];
  [@css ".css-1io5dgr{background-position-x:10%,20%,40%}"];
  [@css ".css-f8ehso{background-position-x:0px}"];
  [@css ".css-n3vpvo{background-position-x:30px}"];
  [@css ".css-1x0rit9{background-position-x:0%,10%,20%,30%}"];
  [@css ".css-1vec9ov{background-position-x:left,left,left,left,left}"];
  ...
  [@css ".css-c635yy{background-position-y:top,top}"];
  [@css ".css-9rzdug{background-position-y:top,bottom}"];
  [@css ".css-1zt907{background-position-y:bottom,top}"];
  [@css ".css-1ftoi2g{background-position-y:top,0%}"];
  [@css ".css-14yatl1{background-position-y:10%,20%,40%}"];
  [@css ".css-1gbcs51{background-position-y:0px}"];
  [@css ".css-1it2wtl{background-position-y:30px}"];
  [@css ".css-1w0fj8t{background-position-y:0%,10%,20%,30%}"];
  [@css ".css-1i1m277{background-position-y:top,top,top,top,top}"];
  ...
  [@css ".css-10htzpq{background-image:linear-gradient(45deg,blue,red)}"];
  [@css
    ".css-1vsztdk{background-image:linear-gradient(90deg,blue 10%,red 20%)}"
  ];
  [@css ".css-zh5nij{background-image:linear-gradient(90deg,blue 10%,red)}"];
  [@css ".css-13w2i29{background-image:linear-gradient(90deg,blue,10%,red)}"];
  [@css ".css-1rmtn3r{background-image:linear-gradient(white,black)}"];
  [@css ".css-sjithf{background-image:linear-gradient(to right,white,black)}"];
  [@css ".css-lyp9of{background-image:linear-gradient(45deg,white,black)}"];
  [@css ".css-727uej{background-image:linear-gradient(white 50%,black)}"];
  [@css ".css-1012fjp{background-image:linear-gradient(white,#f06,black)}"];
  [@css
    ".css-1ms4aqi{background-image:linear-gradient(red -50px,white calc(-25px + 50%),blue 100%)}"
  ];
  [@css
    ".css-19m9cqu{background-image:linear-gradient(45deg,blue,red),linear-gradient(red -50px,white calc(-25px + 50%),blue 100%),linear-gradient(45deg,blue,red)}"
  ];
  [@css
    ".css-j8a9fi{background-image:linear-gradient(45deg,var(--color-2e0nuk_1) 25%,transparent 0%,transparent 50%,var(--color-2e0nuk_2) 0%,var(--color-2e0nuk_3) 75%,transparent 0%,transparent 100%)}"
  ];
  [@css
    ".css-b0xpq7{background-image:repeating-linear-gradient(45deg,var(--color-bbusdu_1) 0px,var(--color-bbusdu_2) 4px,var(--color-bbusdu_3) 5px,var(--color-bbusdu_4) 9px)}"
  ];
  [@css
    ".css-11br7tt{background-image:linear-gradient(45deg,var(--boxDark-1imew2g) 25%,transparent 25%),linear-gradient(red -50px,white calc(-25px + 50%),blue 100%),linear-gradient(45deg,blue,red)}"
  ];
  [@css ".css-1v3b635{background-image:radial-gradient(white,black)}"];
  [@css ".css-18ehskp{background-image:radial-gradient(circle,white,black)}"];
  [@css ".css-14javto{background-image:radial-gradient(ellipse,white,black)}"];
  [@css
    ".css-gfjww2{background-image:radial-gradient(circle closest-corner,white,black)}"
  ];
  [@css
    ".css-1huwcgo{background-image:radial-gradient(farthest-side,white,black)}"
  ];
  [@css
    ".css-1woa42x{background-image:radial-gradient(circle farthest-side,white,black)}"
  ];
  [@css ".css-d6u498{background-image:radial-gradient(50%,white,black)}"];
  [@css ".css-1ljqpnn{background-image:radial-gradient(60% 60%,white,black)}"];
  [@css ".css-148893t{list-style-image:linear-gradient(white,black)}"];
  [@css ".css-1bokwvr{list-style-image:linear-gradient(to right,white,black)}"];
  [@css ".css-qt1e6w{list-style-image:linear-gradient(45deg,white,black)}"];
  [@css ".css-1yxpg4a{list-style-image:linear-gradient(white 50%,black)}"];
  [@css ".css-z6wblo{list-style-image:linear-gradient(white 5px,black)}"];
  [@css ".css-16see7a{list-style-image:linear-gradient(white,#f06,black)}"];
  [@css ".css-lqeu6s{list-style-image:linear-gradient(currentColor,black)}"];
  [@css
    ".css-1vqy27k{list-style-image:linear-gradient(red -50px,white calc(-25px + 50%),blue 100%)}"
  ];
  [@css ".css-1shdb3l{list-style-image:radial-gradient(white,black)}"];
  [@css ".css-vx7qjw{list-style-image:radial-gradient(circle,white,black)}"];
  [@css ".css-48nifo{list-style-image:radial-gradient(ellipse,white,black)}"];
  [@css
    ".css-t1fsog{list-style-image:radial-gradient(closest-corner,white,black)}"
  ];
  [@css
    ".css-45c0fr{list-style-image:radial-gradient(circle closest-corner,white,black)}"
  ];
  [@css
    ".css-1e75c1l{list-style-image:radial-gradient(farthest-side,white,black)}"
  ];
  [@css
    ".css-slcmto{list-style-image:radial-gradient(circle farthest-side,white,black)}"
  ];
  [@css ".css-1j79a5x{list-style-image:radial-gradient(50%,white,black)}"];
  [@css ".css-1cgigle{list-style-image:radial-gradient(60% 60%,white,black)}"];
  ...
  [@css ".css-179we4s{background-position:0 0,center}"];
  ...
  [@css
    "@keyframes keyframe-jddl6k{0%{background-position:0 0}100%{background-position:1rem 0}}"
  ];
  module Color = {
    module Background = {
  ...
  CSS.make("css-1ad99i3", []);
  CSS.make("css-1hk08hh", []);
  CSS.make("css-r5g0y5", []);
  CSS.make(
    "css-f5n3c1",
    [
      (
        "--elevation1-1yjawpc_1",
        CSS.Types.Color.toString(Color.Shadow.elevation1),
      ),
      (
        "--elevation1-1yjawpc_2",
        CSS.Types.Color.toString(Color.Shadow.elevation1),
      ),
      (
        "--elevation1-1yjawpc_3",
        CSS.Types.Color.toString(Color.Shadow.elevation1),
      ),
    ],
  );
  ...
  CSS.make("css-hxcezg", []);
  CSS.make("css-1a28g8t", []);
  CSS.make("css-t6ixdl", []);
  CSS.make("css-rcw6p", []);
  CSS.make("css-12w0v04", []);
  CSS.make("css-1io5dgr", []);
  CSS.make("css-f8ehso", []);
  CSS.make("css-n3vpvo", []);
  CSS.make("css-1x0rit9", []);
  CSS.make("css-1vec9ov", []);
  ...
  CSS.make("css-9rzdug", []);
  CSS.make("css-1zt907", []);
  CSS.make("css-1ftoi2g", []);
  CSS.make("css-14yatl1", []);
  CSS.make("css-1gbcs51", []);
  CSS.make("css-1it2wtl", []);
  CSS.make("css-1w0fj8t", []);
  CSS.make("css-1i1m277", []);
  ...
  CSS.make("css-10htzpq", []);
  CSS.make("css-1vsztdk", []);
  CSS.make("css-zh5nij", []);
  CSS.make("css-13w2i29", []);
  CSS.make("css-1rmtn3r", []);
  CSS.make("css-sjithf", []);
  CSS.make("css-lyp9of", []);
  CSS.make("css-727uej", []);
  CSS.make("css-1012fjp", []);
  CSS.make("css-1ms4aqi", []);
  CSS.make("css-19m9cqu", []);
  let color = `hex("333");
  CSS.make(
    "css-j8a9fi",
    [
      ("--color-2e0nuk_1", CSS.Types.Color.toString(color)),
      ("--color-2e0nuk_2", CSS.Types.Color.toString(color)),
      ("--color-2e0nuk_3", CSS.Types.Color.toString(color)),
    ],
  );
  CSS.make(
    "css-b0xpq7",
    [
      ("--color-bbusdu_1", CSS.Types.Color.toString(color)),
      ("--color-bbusdu_2", CSS.Types.Color.toString(color)),
      ("--color-bbusdu_3", CSS.Types.Color.toString(color)),
      ("--color-bbusdu_4", CSS.Types.Color.toString(color)),
    ],
  );
  ...
  CSS.make(
    "css-11br7tt",
    [
      ("--boxDark-1imew2g", CSS.Types.Color.toString(Color.Background.boxDark)),
    ],
  );
  
  CSS.make("css-1v3b635", []);
  CSS.make("css-18ehskp", []);
  CSS.make("css-14javto", []);
  CSS.make("css-gfjww2", []);
  CSS.make("css-1huwcgo", []);
  CSS.make("css-1woa42x", []);
  CSS.make("css-d6u498", []);
  CSS.make("css-1ljqpnn", []);
  
  CSS.make("css-148893t", []);
  CSS.make("css-1bokwvr", []);
  CSS.make("css-qt1e6w", []);
  CSS.make("css-1yxpg4a", []);
  CSS.make("css-z6wblo", []);
  CSS.make("css-16see7a", []);
  CSS.make("css-lqeu6s", []);
  CSS.make("css-1vqy27k", []);
  CSS.make("css-1shdb3l", []);
  CSS.make("css-vx7qjw", []);
  CSS.make("css-48nifo", []);
  CSS.make("css-t1fsog", []);
  CSS.make("css-45c0fr", []);
  CSS.make("css-1e75c1l", []);
  CSS.make("css-slcmto", []);
  CSS.make("css-1j79a5x", []);
  CSS.make("css-1cgigle", []);
  ...
  let _loadingKeyframes = CSS.Types.AnimationName.make("keyframe-jddl6k");
