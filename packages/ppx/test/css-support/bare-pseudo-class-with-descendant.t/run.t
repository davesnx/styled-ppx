...
deep nesting, and mixed compound/descendant inner chains.
  ...
  let _amp_pseudo_with_class_descendant =
    CSS.make(
      ~label="_amp_pseudo_with_class_descendant",
      "cid-1mtruzt css-1i2mold",
      [],
    );
  
  let _amp_pseudo_with_type_descendant =
    CSS.make(
      ~label="_amp_pseudo_with_type_descendant",
      "cid-1l96rxg css-1pw74wv",
      [],
    );
  
  let _amp_pseudo_with_explicit_ampersand_descendant =
    CSS.make(
      ~label="_amp_pseudo_with_explicit_ampersand_descendant",
      "cid-saeaxt css-5tdg3s",
      [],
    );
  
  let _amp_pseudo_with_compound_inner =
    CSS.make(
      ~label="_amp_pseudo_with_compound_inner",
      "cid-1gv0q8s css-1pzj0cc",
      [],
    );
  
  let _amp_pseudo_with_pseudo_element_inner =
    CSS.make(
      ~label="_amp_pseudo_with_pseudo_element_inner",
      "cid-1ogtbuw css-1cghiyt",
      [],
    );
