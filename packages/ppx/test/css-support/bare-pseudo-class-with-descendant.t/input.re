/* Regression coverage for bare-leading-pseudo handling in `[%css]`.
...
let _amp_pseudo_with_class_descendant = [%css
  {|
  &:hover {
    .child { color: red; }
  }
...
let _amp_pseudo_with_type_descendant = [%css
  {|
  &:hover {
    span { color: blue; }
  }
...
let _amp_pseudo_with_explicit_ampersand_descendant = [%css
  {|
  &:hover {
    & .child { color: green; }
  }
...
let _amp_pseudo_with_compound_inner = [%css
  {|
  &:hover {
    &:focus { color: yellow; }
  }
...
let _amp_pseudo_with_pseudo_element_inner = [%css
  {|
  &:hover {
    &::after { color: orange; }
  }
...
let _amp_pseudo_three_levels = [%css
  {|
  &:hover {
    .child {
...
let _amp_pseudo_five_levels = [%css
  {|
  &:hover {
    .a {
      .b {
...
let _amp_pseudo_mixed_inner = [%css
  {|
  &:hover {
    .a {
      &:focus {
