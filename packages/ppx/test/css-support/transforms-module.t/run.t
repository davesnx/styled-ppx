...
If this test fail means that the module is not in sync with the ppx
  ...
  CSS.rotateProperty(`deg(45.));
  CSS.rotateProperty(`axis((`x, `deg(45.))));
  CSS.rotateProperty(`axis((`y, `deg(45.))));
  CSS.rotateProperty(`axis((`z, `deg(45.))));
  CSS.rotateProperty(`vector(((-1.), 0., 2., `deg(45.))));
  CSS.rotateProperty(`axis((`x, `deg(45.))));
  CSS.rotateProperty(`axis((`y, `deg(45.))));
  CSS.rotateProperty(`axis((`z, `deg(45.))));
  CSS.rotateProperty(`vector(((-1.), 0., 2., `deg(45.))));
