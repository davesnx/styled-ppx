...
If this test fail means that the module is not in sync with the ppx
  ...
  [@css
    ".css-sjla48{-webkit-filter:drop-shadow(0 1px 0 var(--var-sj55zd_1)) drop-shadow(0 1px 0 var(--var-sj55zd_2)) drop-shadow(0 1px 0 var(--var-sj55zd_3)) drop-shadow(0 32px 48px rgba(0, 0, 0, 0.075)) drop-shadow(0 8px 32px rgba(0, 0, 0, 0.03));filter:drop-shadow(0 1px 0 var(--var-sj55zd_1)) drop-shadow(0 1px 0 var(--var-sj55zd_2)) drop-shadow(0 1px 0 var(--var-sj55zd_3)) drop-shadow(0 32px 48px rgba(0, 0, 0, 0.075)) drop-shadow(0 8px 32px rgba(0, 0, 0, 0.03));}"
  ];
