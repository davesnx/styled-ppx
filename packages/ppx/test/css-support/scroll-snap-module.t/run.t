...
If this test fail means that the module is not in sync with the ppx
  ...
  CSS.scrollSnapAlign(`none);
  CSS.scrollSnapAlign(`start);
  CSS.scrollSnapAlign(`end_);
  CSS.scrollSnapAlign(`center);
  CSS.scrollSnapAlign2(`none, `start);
  CSS.scrollSnapAlign2(`end_, `center);
  CSS.scrollSnapAlign2(`center, `start);
  CSS.scrollSnapAlign2(`end_, `none);
  CSS.scrollSnapAlign2(`center, `center);
  CSS.scrollSnapStop(`normal);
  CSS.scrollSnapStop(`always);
  CSS.scrollSnapType(`none);
  CSS.scrollSnapType(`value({js|x mandatory|js}));
  CSS.scrollSnapType(`value({js|y mandatory|js}));
  CSS.scrollSnapType(`value({js|block mandatory|js}));
  CSS.scrollSnapType(`value({js|inline mandatory|js}));
  CSS.scrollSnapType(`value({js|both mandatory|js}));
  CSS.scrollSnapType(`value({js|x proximity|js}));
  CSS.scrollSnapType(`value({js|y proximity|js}));
  CSS.scrollSnapType(`value({js|block proximity|js}));
  CSS.scrollSnapType(`value({js|inline proximity|js}));
  CSS.scrollSnapType(`value({js|both proximity|js}));
