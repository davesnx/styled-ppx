...
location and a synthetic dep-tracking `let`.
  ...
  [@@@css "._a_gnp5r39ddnj.\000M.marker\000{background:blue;}"]
  [@@@css.bindings
    [("N.container", "_id_1ov2ckq", "_a_393u2l _a_gnp5r39ddnj")]]
  [@@@css.refs [("M.marker", "n.ml", 6, 6, 14)]]
  let _ = M.marker
  let container =
    CSS.make "label:container _id_1ov2ckq _a_393u2l _a_gnp5r39ddnj" []
...
of its own; the resolved selector carries only its identity class.
  ...
  ._a_gnp5r39ddnj._id_12qpfnx{background:blue;}
  }
