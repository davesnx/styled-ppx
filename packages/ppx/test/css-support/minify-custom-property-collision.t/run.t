...
name.
  ...
  @property --backgroundColor-ov3le6{syntax:"*";inherits:false;}@property --backgroundColor-7yjmr3{syntax:"*";inherits:false;}.csv-160vrad{background-color:var(--backgroundColor-ov3le6);}.csv-10a6meq:hover{background-color:var(--backgroundColor-7yjmr3);}
