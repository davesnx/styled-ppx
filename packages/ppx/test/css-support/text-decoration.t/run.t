...
If this test fail means that the module is not in sync with the ppx
  ...
  [@css ".css-h4jklt{text-shadow:1px 1px,2px 2px red}"];
  [@css ".css-1kdn0uk{text-shadow:1px 2px 3px black,0 0 5px white}"];
  ...
  [@css
    ".css-ebs8vu{text-decoration-skip:leading-spaces trailing-spaces edges box-decoration}"
  ];
