...
If this test fail means that the module is not in sync with the ppx
  ...
  [@css
    ".a-4l001tlwt{-webkit-column-rule-color:rgba(0,0,0,0.5);column-rule-color:rgba(0,0,0,0.5);}"
  ];
  [@css ".a-4l0016q4n{-webkit-column-rule-color:#F06;column-rule-color:#F06;}"];
  [@css
    ".a-4l001el08{-webkit-column-rule-color:#FF0066;column-rule-color:#FF0066;}"
  ];
  [@css
    ".a-4l001f49a{-webkit-column-rule-color:hsl(0,0%,0%);column-rule-color:hsl(0,0%,0%);}"
  ];
  [@css
    ".a-4l001row3{-webkit-column-rule-color:hsl(0,0%,0%,0.5);column-rule-color:hsl(0,0%,0%,0.5);}"
  ];
  [@css
    ".a-4l001ru4n{-webkit-column-rule-color:transparent;column-rule-color:transparent;}"
  ];
  [@css
    ".a-4l00103e1{-webkit-column-rule-color:currentColor;column-rule-color:currentColor;}"
  ];
  ...
  [@css
    ".a-4l0016vui{-webkit-column-rule-color:rgb(0% 20% 70%);column-rule-color:rgb(0% 20% 70%);}"
  ];
  [@css
    ".a-4l0013dyf{-webkit-column-rule-color:rgb(0 64 185);column-rule-color:rgb(0 64 185);}"
  ];
  [@css
    ".a-4l001qvl6{-webkit-column-rule-color:hsl(0 0% 0%);column-rule-color:hsl(0 0% 0%);}"
  ];
  [@css
    ".a-4l0018yii{-webkit-column-rule-color:rgba(0% 20% 70% / 50%);column-rule-color:rgba(0% 20% 70% / 50%);}"
  ];
  [@css
    ".a-4l001t9pq{-webkit-column-rule-color:rgba(0% 20% 70% / 0.5);column-rule-color:rgba(0% 20% 70% / 0.5);}"
  ];
  [@css
    ".a-4l001wwr9{-webkit-column-rule-color:rgba(0 64 185 / 50%);column-rule-color:rgba(0 64 185 / 50%);}"
  ];
  [@css
    ".a-4l001c8ch{-webkit-column-rule-color:rgba(0 64 185 / 0.5);column-rule-color:rgba(0 64 185 / 0.5);}"
  ];
  [@css
    ".a-4l001uu68{-webkit-column-rule-color:hsla(0 0% 0% /0.5);column-rule-color:hsla(0 0% 0% /0.5);}"
  ];
  [@css
    ".a-4l0014t4f{-webkit-column-rule-color:rgb(0% 20% 70% / 50%);column-rule-color:rgb(0% 20% 70% / 50%);}"
  ];
  [@css
    ".a-4l001xjvr{-webkit-column-rule-color:rgb(0% 20% 70% / 0.5);column-rule-color:rgb(0% 20% 70% / 0.5);}"
  ];
  [@css
    ".a-4l001mwf4{-webkit-column-rule-color:rgb(0 64 185 / 50%);column-rule-color:rgb(0 64 185 / 50%);}"
  ];
  [@css
    ".a-4l001t3by{-webkit-column-rule-color:rgb(0 64 185 / 0.5);column-rule-color:rgb(0 64 185 / 0.5);}"
  ];
  [@css
    ".a-4l001f3h2{-webkit-column-rule-color:hsl(0 0% 0% / 0.5);column-rule-color:hsl(0 0% 0% / 0.5);}"
  ];
  [@css
    ".a-4l001psoy{-webkit-column-rule-color:#000F;column-rule-color:#000F;}"
  ];
  [@css
    ".a-4l00196r0{-webkit-column-rule-color:#000000FF;column-rule-color:#000000FF;}"
  ];
  [@css
    ".a-4l001t3it{-webkit-column-rule-color:rebeccapurple;column-rule-color:rebeccapurple;}"
  ];
  ...
  [@css
    ".a-4l001t29u{-webkit-column-rule-color:color-mix(in srgb, teal 65%, olive);column-rule-color:color-mix(in srgb, teal 65%, olive);}"
  ];
  [@css
    ".a-4l0013exx{-webkit-column-rule-color:color-mix(in srgb, rgb(255, 0, 0, 0.2) 65%, olive);column-rule-color:color-mix(in srgb, rgb(255, 0, 0, 0.2) 65%, olive);}"
  ];
  [@css
    ".a-4l001njzz{-webkit-column-rule-color:color-mix(in srgb, currentColor, rgba(0, 0, 0, 0.5) 65%);column-rule-color:color-mix(in srgb, currentColor, rgba(0, 0, 0, 0.5) 65%);}"
  ];
  [@css
    ".a-4l001mvwj{-webkit-column-rule-color:color-mix(in srgb, currentColor 10%, rgba(0, 0, 0, 0.5) 65%);column-rule-color:color-mix(in srgb, currentColor 10%, rgba(0, 0, 0, 0.5) 65%);}"
  ];
  [@css
    ".a-4l001mgb0{-webkit-column-rule-color:color-mix(in lch, teal 65%, olive);column-rule-color:color-mix(in lch, teal 65%, olive);}"
  ];
  [@css
    ".a-4l001iyg8{-webkit-column-rule-color:color-mix(in hsl, teal 65%, olive);column-rule-color:color-mix(in hsl, teal 65%, olive);}"
  ];
  [@css
    ".a-4l001a2h1{-webkit-column-rule-color:color-mix(in hwb, teal 65%, olive);column-rule-color:color-mix(in hwb, teal 65%, olive);}"
  ];
  [@css
    ".a-4l001641x{-webkit-column-rule-color:color-mix(in xyz, teal 65%, olive);column-rule-color:color-mix(in xyz, teal 65%, olive);}"
  ];
  [@css
    ".a-4l001gkgb{-webkit-column-rule-color:color-mix(in lab, teal 65%, olive);column-rule-color:color-mix(in lab, teal 65%, olive);}"
  ];
  ...
  CSS.make("a-4l001tlwt", []);
  CSS.make("a-4l0016q4n", []);
  CSS.make("a-4l001el08", []);
  CSS.make("a-4l001f49a", []);
  CSS.make("a-4l001row3", []);
  CSS.make("a-4l001ru4n", []);
  CSS.make("a-4l00103e1", []);
  ...
  CSS.make("a-4l0016vui", []);
  CSS.make("a-4l0013dyf", []);
  CSS.make("a-4l001qvl6", []);
  CSS.make("a-4l0018yii", []);
  CSS.make("a-4l001t9pq", []);
  CSS.make("a-4l001wwr9", []);
  CSS.make("a-4l001c8ch", []);
  CSS.make("a-4l001uu68", []);
  CSS.make("a-4l0014t4f", []);
  CSS.make("a-4l001xjvr", []);
  CSS.make("a-4l001mwf4", []);
  CSS.make("a-4l001t3by", []);
  CSS.make("a-4l001f3h2", []);
  CSS.make("a-4l001psoy", []);
  CSS.make("a-4l00196r0", []);
  CSS.make("a-4l001t3it", []);
  ...
  CSS.make("a-4l001t29u", []);
  CSS.make("a-4l0013exx", []);
  CSS.make("a-4l001njzz", []);
  CSS.make("a-4l001mvwj", []);
  CSS.make("a-4l001mgb0", []);
  CSS.make("a-4l001iyg8", []);
  CSS.make("a-4l001a2h1", []);
  CSS.make("a-4l001641x", []);
  CSS.make("a-4l001gkgb", []);
