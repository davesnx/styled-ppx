...
If this test fail means that the module is not in sync with the ppx
  ...
  [@css ".css-13we8lr{color:color-mix(in srgb,teal 65%,olive)}"];
  [@css ".css-1fkvjm2{color:color-mix(in srgb,rgb(255,0,0,0.2) 65%,olive)}"];
  [@css
    ".css-oxcfv5{color:color-mix(in srgb,currentColor,rgba(0,0,0,0.5) 65%)}"
  ];
  [@css
    ".css-14zxin2{color:color-mix(in srgb,currentColor 10%,rgba(0,0,0,0.5) 65%)}"
  ];
  [@css ".css-mcozbc{color:color-mix(in lch,teal 65%,olive)}"];
  [@css ".css-1a9tgkq{color:color-mix(in hsl,teal 65%,olive)}"];
  [@css ".css-bxucn9{color:color-mix(in hwb,teal 65%,olive)}"];
  [@css ".css-1j5uis{color:color-mix(in xyz,teal 65%,olive)}"];
  [@css ".css-tel4gv{color:color-mix(in lab,teal 65%,olive)}"];
  [@css
    ".css-1bffqko{color:color-mix(in lch longer hue,hsl(200deg 50% 80%),coral)}"
  ];
  [@css ".css-1lcymdb{background-color:color-mix(in srgb,teal 65%,olive)}"];
  [@css
    ".css-1se4g8u{background-color:color-mix(in srgb,rgb(255,0,0,0.2) 65%,olive)}"
  ];
  [@css
    ".css-1e7bjkd{background-color:color-mix(in srgb,currentColor,rgba(0,0,0,0.5) 65%)}"
  ];
  [@css
    ".css-m5nyrj{background-color:color-mix(in srgb,currentColor 10%,rgba(0,0,0,0.5) 65%)}"
  ];
  [@css ".css-1s00eiq{background-color:color-mix(in lch,teal 65%,olive)}"];
  [@css ".css-1etdz16{background-color:color-mix(in hsl,teal 65%,olive)}"];
  [@css ".css-124e117{background-color:color-mix(in hwb,teal 65%,olive)}"];
  [@css ".css-8vilq8{background-color:color-mix(in xyz,teal 65%,olive)}"];
  [@css ".css-4frz3s{background-color:color-mix(in lab,teal 65%,olive)}"];
  [@css ".css-prziae{border-color:color-mix(in srgb,teal 65%,olive)}"];
  [@css
    ".css-1upoghw{border-color:color-mix(in srgb,rgb(255,0,0,0.2) 65%,olive)}"
  ];
  [@css
    ".css-8ux9g6{border-color:color-mix(in srgb,currentColor,rgba(0,0,0,0.5) 65%)}"
  ];
  [@css
    ".css-160r9kh{border-color:color-mix(in srgb,currentColor 10%,rgba(0,0,0,0.5) 65%)}"
  ];
  [@css ".css-q3z0r5{border-color:color-mix(in lch,teal 65%,olive)}"];
  [@css ".css-6c4f2a{border-color:color-mix(in hsl,teal 65%,olive)}"];
  [@css ".css-158shcw{border-color:color-mix(in hwb,teal 65%,olive)}"];
  [@css ".css-11pl903{border-color:color-mix(in xyz,teal 65%,olive)}"];
  [@css ".css-5ukns2{border-color:color-mix(in lab,teal 65%,olive)}"];
  [@css ".css-kvwpuk{text-decoration-color:color-mix(in srgb,teal 65%,olive)}"];
  [@css
    ".css-1f76ip3{text-decoration-color:color-mix(in srgb,rgb(255,0,0,0.2) 65%,olive)}"
  ];
  [@css
    ".css-1hiinp7{text-decoration-color:color-mix(in srgb,currentColor,rgba(0,0,0,0.5) 65%)}"
  ];
  [@css
    ".css-1020g5c{text-decoration-color:color-mix(in srgb,currentColor 10%,rgba(0,0,0,0.5) 65%)}"
  ];
  [@css ".css-ligrpp{text-decoration-color:color-mix(in lch,teal 65%,olive)}"];
  [@css ".css-11dq1oz{text-decoration-color:color-mix(in hsl,teal 65%,olive)}"];
  [@css ".css-43w0vh{text-decoration-color:color-mix(in hwb,teal 65%,olive)}"];
  [@css ".css-8vu9rs{text-decoration-color:color-mix(in xyz,teal 65%,olive)}"];
  [@css ".css-av674g{text-decoration-color:color-mix(in lab,teal 65%,olive)}"];
  [@css
    ".css-ivc3j1{-webkit-column-rule-color:color-mix(in srgb,teal 65%,olive);column-rule-color:color-mix(in srgb,teal 65%,olive)}"
  ];
  [@css
    ".css-c7cbnd{-webkit-column-rule-color:color-mix(in srgb,rgb(255,0,0,0.2) 65%,olive);column-rule-color:color-mix(in srgb,rgb(255,0,0,0.2) 65%,olive)}"
  ];
  [@css
    ".css-1ylrtze{-webkit-column-rule-color:color-mix(in srgb,currentColor,rgba(0,0,0,0.5) 65%);column-rule-color:color-mix(in srgb,currentColor,rgba(0,0,0,0.5) 65%)}"
  ];
  [@css
    ".css-1bc6ghs{-webkit-column-rule-color:color-mix(in srgb,currentColor 10%,rgba(0,0,0,0.5) 65%);column-rule-color:color-mix(in srgb,currentColor 10%,rgba(0,0,0,0.5) 65%)}"
  ];
  [@css
    ".css-1al0ufj{-webkit-column-rule-color:color-mix(in lch,teal 65%,olive);column-rule-color:color-mix(in lch,teal 65%,olive)}"
  ];
  [@css
    ".css-rc23i{-webkit-column-rule-color:color-mix(in hsl,teal 65%,olive);column-rule-color:color-mix(in hsl,teal 65%,olive)}"
  ];
  [@css
    ".css-xgxtjy{-webkit-column-rule-color:color-mix(in hwb,teal 65%,olive);column-rule-color:color-mix(in hwb,teal 65%,olive)}"
  ];
  [@css
    ".css-1cb5jp{-webkit-column-rule-color:color-mix(in xyz,teal 65%,olive);column-rule-color:color-mix(in xyz,teal 65%,olive)}"
  ];
  [@css
    ".css-1skmpe9{-webkit-column-rule-color:color-mix(in lab,teal 65%,olive);column-rule-color:color-mix(in lab,teal 65%,olive)}"
  ];
  [@css ".css-ho0ahk{color:rgba(0,0,0,calc(1))}"];
  [@css ".css-1nhcpkk{color:rgba(0,0,0,calc(10 - 1))}"];
  ...
  CSS.make("css-13we8lr", []);
  CSS.make("css-1fkvjm2", []);
  CSS.make("css-oxcfv5", []);
  CSS.make("css-14zxin2", []);
  CSS.make("css-mcozbc", []);
  CSS.make("css-1a9tgkq", []);
  CSS.make("css-bxucn9", []);
  CSS.make("css-1j5uis", []);
  CSS.make("css-tel4gv", []);
  CSS.make("css-1bffqko", []);
  
  CSS.make("css-1lcymdb", []);
  CSS.make("css-1se4g8u", []);
  CSS.make("css-1e7bjkd", []);
  CSS.make("css-m5nyrj", []);
  CSS.make("css-1s00eiq", []);
  CSS.make("css-1etdz16", []);
  CSS.make("css-124e117", []);
  CSS.make("css-8vilq8", []);
  CSS.make("css-4frz3s", []);
  
  CSS.make("css-prziae", []);
  CSS.make("css-1upoghw", []);
  CSS.make("css-8ux9g6", []);
  CSS.make("css-160r9kh", []);
  CSS.make("css-q3z0r5", []);
  CSS.make("css-6c4f2a", []);
  CSS.make("css-158shcw", []);
  CSS.make("css-11pl903", []);
  CSS.make("css-5ukns2", []);
  
  CSS.make("css-kvwpuk", []);
  CSS.make("css-1f76ip3", []);
  CSS.make("css-1hiinp7", []);
  CSS.make("css-1020g5c", []);
  CSS.make("css-ligrpp", []);
  CSS.make("css-11dq1oz", []);
  CSS.make("css-43w0vh", []);
  CSS.make("css-8vu9rs", []);
  CSS.make("css-av674g", []);
  ...
  CSS.make("css-ivc3j1", []);
  CSS.make("css-c7cbnd", []);
  CSS.make("css-1ylrtze", []);
  CSS.make("css-1bc6ghs", []);
  CSS.make("css-1al0ufj", []);
  CSS.make("css-rc23i", []);
  CSS.make("css-xgxtjy", []);
  CSS.make("css-1cb5jp", []);
  CSS.make("css-1skmpe9", []);
  
  CSS.make("css-ho0ahk", []);
  CSS.make("css-1nhcpkk", []);
