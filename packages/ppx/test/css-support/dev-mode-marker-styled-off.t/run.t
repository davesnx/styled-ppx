Dev markers are on by default; `--env production` turns them off for
[%styled.<tag>] components too, same as it does for [%css] bindings.
  ...
  module Box = {
    ...
    let styles = CSS.make("id-zugc0d a-4ekvmb", []);
