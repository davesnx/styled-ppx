...
same-module `localFlag` is already resolved to its class.
  ...
  $ grep "css-" n.ml | head -3
    ".css-1xw0xmu-container.css-0-localFlag.\000M.marker\000{color:blue}"]
    [("N.localFlag", "css-0-localFlag");
    ("N.container", "css-1xw0xmu-container")]]
...
same-module reference would produce.
  ...
  .css-1xw0xmu-container.css-0-localFlag.css-0-marker{color:blue}
