...
same-module `localFlag` is already resolved to its class.
  ...
  [@@@css ".a-djuldm.id-1026km9.\000M.marker\000{color:blue;}"]
    ("N.container", "id-1ov2ckq", "a-djuldm")]]
  let container = CSS.make "label:container id-1ov2ckq a-djuldm" []
...
same-module reference would produce.
  ...
  .a-djuldm.id-1026km9.id-12qpfnx{color:blue;}
