...
same-module `localFlag` is already resolved to its class.
  ...
  [@@@css ".css-djuldm-container.cid-1026km9.\000M.marker\000{color:blue;}"]
    ("N.container", "cid-1ov2ckq", "css-djuldm-container")]]
  let container = CSS.make "cid-1ov2ckq css-djuldm-container" []
...
same-module reference would produce.
  ...
  .css-djuldm-container.cid-1026km9.cid-12qpfnx{color:blue;}
