...
distinct longident.
  ...
  [@css ".css-1hyfx7x{display:none;}"];
  [@css ".css-pznzdi.\000M.isOpen\000{display:block;}"];
  [@css ".css-1d03ie.\000M.isHovered\000{background:rgba(0, 0, 0, 0.1);}"];
  [@css.bindings
    [("N.modal", "cid-1g7stmc", "css-1hyfx7x css-pznzdi css-1d03ie")]
  ];
  [@css.refs
  ...
  .css-pznzdi.cid-1fhciug{display:block;}
  .css-1d03ie.cid-145hsfw{background:rgba(0, 0, 0, 0.1);}
