CssJs.unsafe("backgroundRepeat", "space");
CssJs.unsafe("backgroundRepeat", "round");
CssJs.unsafe("backgroundRepeat", "repeat repeat");
CssJs.unsafe("backgroundRepeat", "space repeat");
CssJs.unsafe("backgroundRepeat", "round repeat");
CssJs.unsafe("backgroundRepeat", "no-repeat repeat");
CssJs.unsafe("backgroundRepeat", "repeat space");
CssJs.unsafe("backgroundRepeat", "space space");
CssJs.unsafe("backgroundRepeat", "round space");
CssJs.unsafe("backgroundRepeat", "no-repeat space");
CssJs.unsafe("backgroundRepeat", "repeat round");
CssJs.unsafe("backgroundRepeat", "space round");
CssJs.unsafe("backgroundRepeat", "round round");
CssJs.unsafe("backgroundRepeat", "no-repeat round");
CssJs.unsafe("backgroundRepeat", "repeat no-repeat");
CssJs.unsafe("backgroundRepeat", "space no-repeat");
CssJs.unsafe("backgroundRepeat", "round no-repeat");
CssJs.unsafe("backgroundRepeat", "no-repeat no-repeat");
CssJs.unsafe("backgroundAttachment", "local");
CssJs.unsafe("backgroundPosition", "bottom 10px right 20px");
CssJs.unsafe("backgroundPosition", "bottom 10px right");
CssJs.unsafe("backgroundPosition", "top right 10px");
CssJs.unsafe("backgroundClip", "border-box");
CssJs.unsafe("backgroundClip", "padding-box");
CssJs.unsafe("backgroundClip", "content-box");
CssJs.unsafe("backgroundOrigin", "border-box");
CssJs.unsafe("backgroundOrigin", "padding-box");
CssJs.unsafe("backgroundOrigin", "content-box");
CssJs.unsafe("backgroundSize", "auto");
CssJs.unsafe("backgroundSize", "cover");
CssJs.unsafe("backgroundSize", "contain");
...
CssJs.unsafe("backgroundSize", "50em 50%");
CssJs.unsafe("background", "url(foo.png), url(bar.svg)");
CssJs.unsafe("background", "top left / 50% 60%");
CssJs.unsafe("background", "border-box");
CssJs.unsafe("background", "border-box padding-box");
CssJs.unsafe(
  "background",
...
CssJs.unsafe("width", "min-content");
CssJs.unsafe("width", "fit-content(10%)");
CssJs.unsafe("minWidth", "max-content");
CssJs.unsafe("minWidth", "min-content");
CssJs.unsafe("minWidth", "fit-content(10%)");
CssJs.unsafe("maxWidth", "max-content");
CssJs.unsafe("maxWidth", "min-content");
CssJs.unsafe("maxWidth", "fit-content(10%)");
CssJs.unsafe("height", "max-content");
CssJs.unsafe("height", "min-content");
CssJs.unsafe("height", "fit-content(10%)");
CssJs.unsafe("minHeight", "max-content");
CssJs.unsafe("minHeight", "min-content");
CssJs.unsafe("minHeight", "fit-content(10%)");
CssJs.unsafe("maxHeight", "max-content");
CssJs.unsafe("maxHeight", "min-content");
...
CssJs.width((`add, `percent(50.), `pxFloat(4.)));
CssJs.width((`add, `pxFloat(20.), `pxFloat(10.)));
CssJs.width((`add, `vh(100.), (`add, `rem(2.), `pxFloat(120.))));
CssJs.width((
  `add,
  `vh(100.),
  (
    ...
    (
      `add,
      `rem(2.),
      (`add, `rem(2.), (`add, `rem(2.), `pxFloat(120.))),
    ),
  ),
));
