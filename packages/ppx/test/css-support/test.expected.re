...
CssJs.unsafe({js|content|js}, {js|url(./img/star.png) / "New!"|js});
...
CssJs.unsafe({js|gridRowStart|js}, {js|span 1|js});
...
CssJs.unsafe({js|gridColumnStart|js}, {js|span 1|js});
...
CssJs.unsafe({js|gridRowEnd|js}, {js|span 1|js});
...
CssJs.unsafe({js|gridColumnEnd|js}, {js|span 1|js});
...
CssJs.unsafe({js|display|js}, {js|ruby|js});
CssJs.unsafe({js|display|js}, {js|ruby-base|js});
CssJs.unsafe({js|display|js}, {js|ruby-text|js});
CssJs.unsafe({js|display|js}, {js|ruby-base-container|js});
CssJs.unsafe({js|display|js}, {js|ruby-text-container|js});
...
CssJs.unsafe({js|contain|js}, {js|style|js});
CssJs.unsafe({js|contain|js}, {js|size style|js});
CssJs.unsafe({js|contain|js}, {js|size layout style|js});
CssJs.unsafe({js|contain|js}, {js|size layout style paint|js});
