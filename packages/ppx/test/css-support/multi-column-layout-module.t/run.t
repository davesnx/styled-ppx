...
If this test fail means that the module is not in sync with the ppx
  ...
  [@css ".a-et0010lyg{-webkit-column-rule-color:red;column-rule-color:red;}"];
  [@css ".a-et002wiag{-webkit-column-rule-style:none;column-rule-style:none;}"];
  [@css
    ".a-et0022g8z{-webkit-column-rule-style:solid;column-rule-style:solid;}"
  ];
  [@css
    ".a-et002szib{-webkit-column-rule-style:dotted;column-rule-style:dotted;}"
  ];
  [@css ".a-et0048iyd{-webkit-column-rule-width:1px;column-rule-width:1px;}"];
  [@css
    ".a-et007y1fb{-webkit-column-rule:transparent;column-rule:transparent;}"
  ];
  [@css
    ".a-et007h5u6{-webkit-column-rule:1px solid black;column-rule:1px solid black;}"
  ];
  ...
  CSS.make("a-4oyak2", []);
  CSS.make("a-4o29w9", []);
  CSS.make("a-et0010lyg", []);
  CSS.make("a-et002wiag", []);
  CSS.make("a-et0022g8z", []);
  CSS.make("a-et002szib", []);
  CSS.make("a-et0048iyd", []);
  CSS.make("a-et007y1fb", []);
  CSS.make("a-et007h5u6", []);
  CSS.make("a-4mzc18", []);
  CSS.make("a-4me1k2", []);
  CSS.make("a-4kub2p", []);
  CSS.make("a-4ko7d8", []);
