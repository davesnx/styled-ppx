...
`[%css]` can reference the component module names.
  ...
  .a-yr9qag .id-1l8coch{margin:0;}
  .a-10q7t6m .id-1oex1yr{display:block;}
  ...
  [@css ".a-yr9qag .id-1l8coch{margin:0;}"];
  [@css ".a-10q7t6m .id-1oex1yr{display:block;}"];
  [@css.bindings
    [
      ("Output.Box", "id-1l8coch", "a-tokvmb in-149d9vx"),
      ("Output.Button", "id-1oex1yr", "in-kusjgz a-hpgf8j"),
      ("Output.card", "id-16nw107", "a-yr9qag a-10q7t6m"),
    ]
  ];
  let tone = CSS.red;
  module Box = {
    ...
    let styles =
      CSS.make(
        "label:Box id-1l8coch a-tokvmb in-149d9vx",
  ...
  module Button = {
    ...
    let styles = (~color: CSS.Types.Color.t, _) =>
      CSS.make(
        "label:Button id-1oex1yr in-kusjgz a-hpgf8j",
  ...
  let card = CSS.make("label:card id-16nw107 a-yr9qag a-10q7t6m", []);
