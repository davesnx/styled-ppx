...
module SelectorsMediaQueries = {
  ...
  let styles =
    CssJs.style(. [|
      ...
      CssJs.media(.
        {js||js} ++ "(" ++ "min-width" ++ ": " ++ "600px" ++ ") ",
        [|CssJs.unsafe({js|background|js}, {js|blue|js})|],
      ),
      CssJs.selector(.
        {js|&:hover|js},
        [|CssJs.unsafe({js|background|js}, {js|green|js})|],
      ),
      CssJs.selector(.
        {js|& > p|js},
