...
<<<<<<< HEAD:packages/ppx/test/snapshot/pp.expected

module ArrayStatic = {
=======
let var = "#333333";
module StringInterpolation = {
>>>>>>> 217d766374ceb4dad280fc912324202d156dc1ae:packages/ppx/test/snapshot/test.expected.re
  [@bs.deriving abstract]
  type makeProps = {
    [@bs.optional]
    ref: ReactDOM.domRef,
...
<<<<<<< HEAD:packages/ppx/test/snapshot/pp.expected
  ...
  let styles =
    Css.style([
      Css.color(var),
      Css.unsafe("color", "trust-me"),
      Css.unsafe("display", "block"),
    ]);
  let make = (props: makeProps) => {
    let stylesObject = {"className": styles};
    let newProps = Js.Obj.assign(stylesObject, Obj.magic(props));
...
let className = Css.style([Css.unsafe("display", "block")]);
let classNameWithMultiLine = Css.style([Css.unsafe("display", "block")]);
