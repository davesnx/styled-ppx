  ...
  module SelectorWithInterpolation =
    struct
      type props =
        ...
        onAbort: React.Event.Media.t -> unit [@ns.optional ];
        onAnimationEnd: React.Event.Animation.t -> unit [@ns.optional ];
        onAnimationIteration: React.Event.Animation.t -> unit [@ns.optional ];
        onAnimationStart: React.Event.Animation.t -> unit [@ns.optional ];
        onBlur: React.Event.Focus.t -> unit [@ns.optional ];
        onCanPlay: React.Event.Media.t -> unit [@ns.optional ];
        onCanPlayThrough: React.Event.Media.t -> unit [@ns.optional ];
        onChange: React.Event.Form.t -> unit [@ns.optional ];
        onClick: React.Event.Mouse.t -> unit [@ns.optional ];
        onCompositionEnd: React.Event.Composition.t -> unit [@ns.optional ];
        onCompositionStart: React.Event.Composition.t -> unit [@ns.optional ];
        onCompositionUpdate: React.Event.Composition.t -> unit [@ns.optional ];
        onContextMenu: React.Event.Mouse.t -> unit [@ns.optional ];
        onCopy: React.Event.Clipboard.t -> unit [@ns.optional ];
        onCut: React.Event.Clipboard.t -> unit [@ns.optional ];
        onDoubleClick: React.Event.Mouse.t -> unit [@ns.optional ];
        onDrag: React.Event.Mouse.t -> unit [@ns.optional ];
        onDragEnd: React.Event.Mouse.t -> unit [@ns.optional ];
        onDragEnter: React.Event.Mouse.t -> unit [@ns.optional ];
        onDragExit: React.Event.Mouse.t -> unit [@ns.optional ];
        onDragLeave: React.Event.Mouse.t -> unit [@ns.optional ];
        onDragOver: React.Event.Mouse.t -> unit [@ns.optional ];
        onDragStart: React.Event.Mouse.t -> unit [@ns.optional ];
        onDrop: React.Event.Mouse.t -> unit [@ns.optional ];
        onDurationChange: React.Event.Media.t -> unit [@ns.optional ];
        onEmptied: React.Event.Media.t -> unit [@ns.optional ];
        onEncrypetd: React.Event.Media.t -> unit [@ns.optional ];
        onEnded: React.Event.Media.t -> unit [@ns.optional ];
        onError: React.Event.Media.t -> unit [@ns.optional ];
        onFocus: React.Event.Focus.t -> unit [@ns.optional ];
        onInput: React.Event.Form.t -> unit [@ns.optional ];
        onKeyDown: React.Event.Keyboard.t -> unit [@ns.optional ];
        onKeyPress: React.Event.Keyboard.t -> unit [@ns.optional ];
        onKeyUp: React.Event.Keyboard.t -> unit [@ns.optional ];
        onLoadedData: React.Event.Media.t -> unit [@ns.optional ];
        onLoadedMetadata: React.Event.Media.t -> unit [@ns.optional ];
        onLoadStart: React.Event.Media.t -> unit [@ns.optional ];
        onMouseDown: React.Event.Mouse.t -> unit [@ns.optional ];
        onMouseEnter: React.Event.Mouse.t -> unit [@ns.optional ];
        onMouseLeave: React.Event.Mouse.t -> unit [@ns.optional ];
        onMouseMove: React.Event.Mouse.t -> unit [@ns.optional ];
        onMouseOut: React.Event.Mouse.t -> unit [@ns.optional ];
        onMouseOver: React.Event.Mouse.t -> unit [@ns.optional ];
        onMouseUp: React.Event.Mouse.t -> unit [@ns.optional ];
        onPaste: React.Event.Clipboard.t -> unit [@ns.optional ];
        onPause: React.Event.Media.t -> unit [@ns.optional ];
        onPlay: React.Event.Media.t -> unit [@ns.optional ];
        onPlaying: React.Event.Media.t -> unit [@ns.optional ];
        onProgress: React.Event.Media.t -> unit [@ns.optional ];
        onRateChange: React.Event.Media.t -> unit [@ns.optional ];
        onScroll: React.Event.UI.t -> unit [@ns.optional ];
        onSeeked: React.Event.Media.t -> unit [@ns.optional ];
        onSeeking: React.Event.Media.t -> unit [@ns.optional ];
        onSelect: React.Event.Selection.t -> unit [@ns.optional ];
        onStalled: React.Event.Media.t -> unit [@ns.optional ];
        onSubmit: React.Event.Form.t -> unit [@ns.optional ];
        onSuspend: React.Event.Media.t -> unit [@ns.optional ];
        onTimeUpdate: React.Event.Media.t -> unit [@ns.optional ];
        onTouchCancel: React.Event.Touch.t -> unit [@ns.optional ];
        onTouchEnd: React.Event.Touch.t -> unit [@ns.optional ];
        onTouchMove: React.Event.Touch.t -> unit [@ns.optional ];
        onTouchStart: React.Event.Touch.t -> unit [@ns.optional ];
        onTransitionEnd: React.Event.Transition.t -> unit [@ns.optional ];
        onVolumeChange: React.Event.Media.t -> unit [@ns.optional ];
        onWaiting: React.Event.Media.t -> unit [@ns.optional ];
        onWheel: React.Event.Wheel.t -> unit [@ns.optional ]}
