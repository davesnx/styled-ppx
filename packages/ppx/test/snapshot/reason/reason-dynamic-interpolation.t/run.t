  ...
  [@css ".csv-u97bjx{color:var(--var-17zksex);}"];
  [@css ".css-13o7eu2{display:block;}"];
  [@css.bindings
    [("Output.DynamicComponent", "cid-1hmg1vc", "csv-u97bjx css-13o7eu2")]
  ];
  module DynamicComponent = {
    ...
    external makeStylesObject:
      ...
      Js.t({..});
    [@mel.get]
    external classNameGet: makeProps(_) => option(string) = "className";
    [@mel.get]
    external innerRefGet: makeProps(_) => option(ReactDOM.domRef) = "innerRef";
    [@mel.get] external as_Get: makeProps(_) => option(string) = "as";
    [@mel.get] external varGet: makeProps(_) => 'var = "var";
    ...
    let styles = (~var, _) =>
      CSS.make(
        "label:DynamicComponent cid-1hmg1vc csv-u97bjx css-13o7eu2",
