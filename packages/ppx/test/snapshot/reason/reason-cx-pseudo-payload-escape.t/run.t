...
`&` (e.g. `:is(& div)`) prove containment and are still accepted.
  ...
  File "input_has.ml", line 6, characters 17-30:
  ...
  File "input_not.ml", line 4, characters 17-27:
  ...
  $ cat output.ml
  [@@@css ":is(._a_276yq4ejfl7 div){color:var(--c-qdrabr);}"]
  [@@@css.bindings [("Input_is_ok.ok", "_id_1e0vjjz", "_a_276yq4ejfl7")]]
  let c = "red"
  let ok =
    CSS.make "label:ok _id_1e0vjjz _a_276yq4ejfl7"
