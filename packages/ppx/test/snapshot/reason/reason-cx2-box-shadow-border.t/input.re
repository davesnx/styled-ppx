...
let simpleShadow = [%css "box-shadow: 0px 2px 4px 0px rgba(0, 0, 0, 0.1);"];

/* Test 2: Multiple box-shadows */
let multipleShadows = [%css
  {|
...
let noShadow = [%css "box-shadow: none;"];

/* Test 5: Complex box-shadow with spread */
let spreadShadow = [%css
...
let simpleBorder = [%css "border: 1px solid black;"];

/* Test 7: Border with color */
let borderWithColor = [%css "border: 2px dashed #ff0000;"];

/* Test 8: Border with transparent */
let borderTransparent = [%css "border: 1px solid transparent;"];

/* Test 9: Border none */
let noBorder = [%css "border: none;"];
