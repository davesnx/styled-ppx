  ...
  [@css "a:hover{color:var(--var-vx0fk9);}"];
  ...
  [@css "form input[type=\"submit\"]:hover{background:var(--var-ki23tf);}"];
    ...
    let to_string = () =>
      (
        (
          (
            (
              ((":root{" ++ "--var-vx0fk9:") ++ CSS.Types.Color.toString(accent))
              ++ ";"
            )
            ++ "--var-ki23tf:"
          )
