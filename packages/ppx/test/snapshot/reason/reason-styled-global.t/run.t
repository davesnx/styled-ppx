  ...
  ignore(
    CSS.global([|
      CSS.selectorMany(
        [|{js|html|js}|],
        [|CSS.lineHeight(`abs(1.15)), CSS.unsafe({js|textSizeAdjust|js}, {js|100%|js})|],
      ),
      CSS.selectorMany([|{js|body|js}|], [|CSS.margin(`zero)|]),
      CSS.selectorMany([|{js|main|js}|], [|CSS.display(`block)|]),
      CSS.selectorMany([|{js|h1|js}|], [|CSS.fontSize(`em(2.)), CSS.margin2(~v=`em(0.67), ~h=`zero)|]),
      CSS.selectorMany([|{js|hr|js}|], [|CSS.boxSizing(`contentBox), CSS.height(`zero), CSS.overflow(`visible)|]),
      CSS.selectorMany([|{js|pre|js}|], [|CSS.fontFamilies([|`monospace, `monospace|]), CSS.fontSize(`em(1.))|]),
      ...
      CSS.selectorMany([|{js|b|js}, {js|strong|js}|], [|CSS.fontWeight(`bolder)|]),
      CSS.selectorMany(
        [|{js|code|js}, {js|kbd|js}, {js|samp|js}|],
        [|CSS.fontFamilies([|`monospace, `monospace|]), CSS.fontSize(`em(1.))|],
      ),
      ...
      CSS.selectorMany(
        [|{js|button|js}, {js|input|js}, {js|optgroup|js}, {js|select|js}, {js|textarea|js}|],
        [|
      ...
      CSS.selectorMany([|{js|button|js}, {js|input|js}|], [|CSS.overflow(`visible)|]),
      CSS.selectorMany([|{js|button|js}, {js|select|js}|], [|CSS.textTransform(`none)|]),
      CSS.selectorMany(
        [|{js|button|js}, {js|[type="button"]|js}, {js|[type="reset"]|js}, {js|[type="submit"]|js}|],
      ...
      CSS.selectorMany([|{js|fieldset|js}|], [|CSS.padding3(~top=`em(0.35), ~h=`em(0.75), ~bottom=`em(0.625))|]),
      CSS.selectorMany(
        [|{js|legend|js}|],
        [|
      ...
      CSS.selectorMany([|{js|progress|js}|], [|CSS.verticalAlign(`baseline)|]),
      ...
      CSS.selectorMany(
        [|{js|[type="number"]::-webkit-inner-spin-button|js}, {js|[type="number"]::-webkit-outer-spin-button|js}|],
        [|CSS.height(`auto)|],
      ),
      CSS.selectorMany(
        [|{js|[type="search"]|js}|],
        [|CSS.unsafe({js|WebkitAppearance|js}, {js|textfield|js}), CSS.outlineOffset(`pxFloat(-2.))|],
      ),
      CSS.selectorMany(
      ...
      CSS.selectorMany(
        ...
        [|CSS.unsafe({js|WebkitAppearance|js}, {js|button|js}), CSS.unsafe({js|font|js}, {js|inherit|js})|],
      ),
      ...
      CSS.selectorMany([|{js|:root|js}|], [|CSS.unsafe({js|--shiki-color-text|js}, {js|oklch(37.53% 0 0)|js})|]),
    |]),
  );
