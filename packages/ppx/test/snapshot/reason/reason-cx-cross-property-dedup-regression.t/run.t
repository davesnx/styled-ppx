...
CSS runtime types. See input.re for the full rationale.
  ...
  [@css ".csv-1mfmiq8{margin-left:var(--lengthVar-12br693);}"];
  [@css ".csv-1mfmiq8{padding-left:var(--lengthVar-8edltm);}"];
  [@css.bindings [("Output.layout", "cid-1b5eq77", "csv-1mfmiq8")]];
  let lengthVar = CSS.px(10);
  let layout =
    CSS.make(
      "label:layout cid-1b5eq77 csv-1mfmiq8",
      [
