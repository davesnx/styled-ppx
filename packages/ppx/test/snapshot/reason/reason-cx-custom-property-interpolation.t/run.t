...
verbatim - no Cascading.toString wrap.
  ...
  [@css.bindings
    [
      ("Output.row", "cid-z61k1z", "css-14o54yy-row"),
      ("Output.theme", "cid-r5u180", "css-10nqctf-theme"),
      ("Output.dyn", "cid-soz37v", "css-zwwqpt-dyn"),
    ]
  ];
  let colorStr = CSS.Types.Color.toString(`hex("3A57FC"));
  let plainStr = "10px";
  let row =
    CSS.make("cid-z61k1z css-14o54yy-row", [("--colorStr-t58soe", colorStr)]);
  let theme =
    CSS.make(
      "cid-r5u180 css-10nqctf-theme",
      [("--colorStr-11d7je1", colorStr), ("--plainStr-1cgr13y", plainStr)],
    );
  let dyn = value =>
    CSS.make("cid-soz37v css-zwwqpt-dyn", [("--value-13tu4ef", value)]);
