  ...
  [@css
    ".css-1oz3n15-StringInterpolation{background-color:var(--var-11zsw44);}"
  ];
  [@css ".css-1oz3n15-StringInterpolation{border-color:var(--var-1e15k1a);}"];
    ...
    let styles =
      CSS.make(
        ...
        [
          ...
          ("--var-11zsw44", CSS.Types.Color.toString(black)),
          ("--var-1e15k1a", CSS.Types.Color.toString(Theme.Border.black)),
        ],
      );
