  ...
  module SelectorsMediaQueries = {
    ...
    let styles =
      CSS.style([|
        ...
        CSS.media({js|(min-width: 600px)|js}, [|CSS.backgroundColor(CSS.blue)|]),
        CSS.selectorMany([|{js|&:hover|js}|], [|CSS.backgroundColor(CSS.green)|]),
        CSS.selectorMany([|{js|& > p|js}|], [|CSS.color(CSS.pink), CSS.fontSize(`pxFloat(24.))|]),
      |]);
