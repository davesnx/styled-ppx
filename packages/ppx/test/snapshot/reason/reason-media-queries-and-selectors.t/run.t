  ...
  [@css "@media (min-width: 600px) {.a-izob039qt2j{background:blue;}}"];
  [@css ".a-qyw7u39xfxf:hover{background:green;}"];
  [@css ".a-og90v4ew9gh > p{color:pink;}"];
  [@css ".a-og90v6500wbeaj > p{font-size:24px;}"];
  [@css.bindings
    [
      (
        "Output.SelectorsMediaQueries",
        "id-36wyir",
        "a-izob039qt2j a-qyw7u39xfxf a-og90v4ew9gh a-og90v6500wbeaj",
      ),
    ]
  ];
  module SelectorsMediaQueries = {
    ...
    let styles =
      CSS.make(
        "label:SelectorsMediaQueries id-36wyir a-izob039qt2j a-qyw7u39xfxf a-og90v4ew9gh a-og90v6500wbeaj",
        [],
      );
