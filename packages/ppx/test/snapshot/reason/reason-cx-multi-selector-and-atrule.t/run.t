...
selector chain into the at-rule's contents instead of dropping it.
  ...
  let multiTop =
    CSS.make ~label:"multiTop" "cid-za05oi css-rmy2q8 css-alyv6j" []
  let multiNested =
    CSS.make ~label:"multiNested" "cid-gymm1w css-xuam0t css-1400cim" []
  let cartesian =
    CSS.make ~label:"cartesian"
      "cid-18oo9dc css-1v5vtx3 css-1hhu78w css-1ehtzuk css-1nvjsnn" []
  let multiMixed =
    CSS.make ~label:"multiMixed"
      "cid-kzpsx9 css-rmy2q8 css-alyv6j css-bij269 css-1k1r9ux" []
  ...
  let mediaWithNested =
    CSS.make ~label:"mediaWithNested"
      "cid-sseoij css-1c0hjb1 css-1x7bng1 css-pjtxwe" []
