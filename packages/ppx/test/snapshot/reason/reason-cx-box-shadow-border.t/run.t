...
Pin the runtime bindings so the rule⟺CSS.make binding pairing is covered too.
  ...
  let simpleShadow =
    CSS.make ~label:"simpleShadow" "cid-1ckmdi6 css-12b85tv" []
  let multipleShadows =
  ...
  let borderStyles =
    CSS.make ~label:"borderStyles"
      "cid-16nbulq css-iqmzmu css-dw79q1 css-9o79gh css-41wvke" []
  let borderSeparate =
    CSS.make ~label:"borderSeparate"
      "cid-122xr42 css-djq43j css-xp8w2v css-1jzkaed" []
  let borderWithRadius =
    CSS.make ~label:"borderWithRadius" "cid-1j83vme css-1k7257i css-rl6otz" []
  let shadowAndBorder =
    CSS.make ~label:"shadowAndBorder"
      "cid-3k5k4w css-1465761 css-19uwm2g css-1yfkn84" []
  let cardStyle =
    CSS.make ~label:"cardStyle"
      "cid-1je20li css-y239qm css-11ixi5p css-1ebezfo" []
  let buttonBase =
    CSS.make ~label:"buttonBase"
      "cid-9kxo31 css-1bxstvc css-1vuar9w css-rl6otz" []
