...
If this test fail means that the module is not in sync with the ppx
  ...
  [@css ".css-riaouu{-webkit-mask-image:var(--var-1few37s);mask-image:var(--var-1few37s);}"];
  [@css ".css-1wjck5z{-webkit-mask-position:center center;mask-position:center center;}"];
  ...
  [@css ".css-vzi4el{-webkit-animation-duration:150ms;animation-duration:150ms;}"];
