...
If this test fail means that the module is not in sync with the ppx
  ...
  CSS.make(
    "css-1nb6mu1",
    [("--var-6wokt0", CSS.Types.Shadow.toString(backgroundString))],
  );
  ...
  CSS.make("css-1y508fb", [("--var-11dnnxw", CSS.Types.Fill.toString(c))]);
  ...
  CSS.make(
    "css-al3chi",
    [("--var-16dsc2j", CSS.Types.Stroke.toString(Color.text))],
  );
  CSS.make("css-rzi3gd", []);
  ...
  CSS.make(
    "css-rqkro3",
    [("--var-414vlv", CSS.Types.NonStandardOverflow.toString(lola))],
  );
  CSS.make("css-e8c2i8", []);
  CSS.make(
    "css-14sj983",
