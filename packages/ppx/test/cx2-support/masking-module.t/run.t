...
If this test fail means that the module is not in sync with the ppx
  ...
  [@css ".css-8mcpnl{-webkit-clip-path:url(\"#clip\");clip-path:url(\"#clip\");}"];
  [@css ".css-182dshe{-webkit-clip-path:inset(50%);clip-path:inset(50%);}"];
  [@css ".css-1mglbca{-webkit-clip-path:path(\"M 20 20 H 80 V 30\");clip-path:path(\"M 20 20 H 80 V 30\");}"];
  [@css ".css-1wl8b54{-webkit-clip-path:polygon(50% 100%, 0 0, 100% 0);clip-path:polygon(50% 100%, 0 0, 100% 0);}"];
  [@css ".css-23yasd{-webkit-clip-path:polygon(evenodd, 0% 0%, 50% 50%, 0% 100%);clip-path:polygon(evenodd, 0% 0%, 50% 50%, 0% 100%);}"];
  [@css ".css-tyz3kz{-webkit-clip-path:polygon(nonzero, 0% 0%, 50% 50%, 0% 100%);clip-path:polygon(nonzero, 0% 0%, 50% 50%, 0% 100%);}"];
  ...
  [@css ".css-191xpd6{-webkit-mask-image:linear-gradient(45deg, #333, #000);mask-image:linear-gradient(45deg, #333, #000);}"];
  [@css ".css-dulaft{-webkit-mask-image:url(\"image.png\");mask-image:url(\"image.png\");}"];
  ...
  [@css ".css-cksx21{-webkit-mask-repeat:repeat repeat;mask-repeat:repeat repeat;}"];
  [@css ".css-1lt0fa9{-webkit-mask-repeat:space repeat;mask-repeat:space repeat;}"];
  [@css ".css-13mjxaa{-webkit-mask-repeat:round repeat;mask-repeat:round repeat;}"];
  [@css ".css-1dt3pxt{-webkit-mask-repeat:no-repeat repeat;mask-repeat:no-repeat repeat;}"];
  [@css ".css-1lgn6bx{-webkit-mask-repeat:repeat space;mask-repeat:repeat space;}"];
  ...
  [@css ".css-dmpthf{-webkit-mask-repeat:no-repeat space;mask-repeat:no-repeat space;}"];
  [@css ".css-gl8b1s{-webkit-mask-repeat:repeat round;mask-repeat:repeat round;}"];
  ...
  [@css ".css-c51vap{-webkit-mask-repeat:no-repeat round;mask-repeat:no-repeat round;}"];
  [@css ".css-sqpu1u{-webkit-mask-repeat:repeat no-repeat;mask-repeat:repeat no-repeat;}"];
  [@css ".css-1kaa087{-webkit-mask-repeat:space no-repeat;mask-repeat:space no-repeat;}"];
  [@css ".css-1gxt6kf{-webkit-mask-repeat:round no-repeat;mask-repeat:round no-repeat;}"];
  [@css ".css-19obql5{-webkit-mask-repeat:no-repeat no-repeat;mask-repeat:no-repeat no-repeat;}"];
  ...
  [@css ".css-uam1vo{-webkit-mask-position:bottom 10px right 20px;mask-position:bottom 10px right 20px;}"];
  [@css ".css-1z2gp6{-webkit-mask-position:1rem 1rem, center;mask-position:1rem 1rem, center;}"];
  ...
  [@css ".css-10phvhq{-webkit-mask-composite:intersect;mask-composite:intersect;}"];
  ...
  [@css ".css-1f1dmg{-webkit-mask:url(\"image.png\") luminance;mask:url(\"image.png\") luminance;}"];
  [@css ".css-co80ky{-webkit-mask:url(\"image.png\") luminance top space;mask:url(\"image.png\") luminance top space;}"];
