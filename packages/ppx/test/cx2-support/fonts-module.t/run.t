...
If this test fail means that the module is not in sync with the ppx
  ...
  CSS.make("css-rvdc3c", [("--var-rwkopp", CSS.Types.FontFamily.toString(fonts))]);
  CSS.make("css-1tld6m7", []);
  CSS.make("css-1tzlrlf", [("--var-1kuyir6", CSS.Types.FontFamily.toString(font))]);
  CSS.make("css-s6qja", []);
  CSS.make("css-vunoql", [("--var-1kuyir6", CSS.Types.FontFamily.toString(font))]);
  CSS.make("css-z3hct", []);
