...
let eq_ast = (ast1, ast2) => {
  ...
  and eq_style_rule = (r1, r2) => {
    let (pr1, _) = r1.Style_rule.prelude;
    let (pr2, _) = r2.Style_rule.prelude;
    eq_list(pr1, pr2, eq_component_value)
  ...
  and eq_stylesheet = ((st1, _), (st2, _)) => eq_list(st1, st2, eq_rule);

  eq_stylesheet(ast1, ast2);
};

describe("CSS Parser", ({test, _}) =>
  test("should strip comments", ({expect, _}) => {
    let css = {|
        {
          /* This is a comment */
    ...
    let ast = render_declaration_list(css);
    let expected_ast = (
      [
        Rule.Style_rule({
          ...
          block: (
            [
              Declaration_list.Declaration({
                ...
                value: (
                  [(Component_value.Ident("red"), Location.none)],
                  Location.none,
                ),
    ...
    expect.equal(~equals=eq_ast, ast, expected_ast):
  })
);
...
/* open Css_types;
   ...
   let parse_stylesheet = css =>
     try (Css_lexer.parse_string(css, Css_parser.stylesheet)) {
     | [@implicit_arity] Css_lexer.LexingError(pos, _) =>
       failwith("Lexing error at: " ++ Css_lexer.position_to_string(pos))
     | [@implicit_arity] Css_lexer.ParseError(token, start, finish) =>
       failwith(
         Printf.sprintf(
           "Parsing error: Unexpected token=%s start=%s end=%s",
                 ...
                 Declaration_list.Declaration({
                   ...
                   value: (
                     [
                       (
                         [@implicit_arity]
                         Component_value.Float_dimension("1", "cm", Length),
                         Location.none,
                       ),
                     ],
                     Location.none,
     ...
     let expected_ast = (
       [
         Rule.At_rule({
           ...
           prelude: (
             [(Component_value.String("utf-8"), Location.none)],
             Location.none,
           ),
       ...
       [
         Rule.At_rule({
           ...
           prelude: (
             [
               (
                 Component_value.Uri("http://www.w3.org/1999/xhtml"),
                 Location.none,
               ),
             ],
             Location.none,
             ...
             [
               ...
               (
                 Component_value.Paren_block([
                   ...
                   (
                     [@implicit_arity]
                     Component_value.Float_dimension("900", "px", Length),
                     Location.none,
                   ),
                 ]),
                 Location.none,
           ...
           block:
             ...
             Brace_block.Stylesheet(
               [
                 Rule.Style_rule({
                   Style_rule.prelude: (
                     [(Component_value.Ident("article"), Location.none)],
                     Location.none,
                   ),
                   block: (
                     [
                       Declaration_list.Declaration({
                         ...
                         value: (
                           [
                             (
                               [@implicit_arity]
                               Component_value.Float_dimension(
                                 "1",
                                 "rem",
                                 Length,
                               ),
       ...
       [
         Rule.At_rule({
           ...
           prelude: (
             [
               (
                 Component_value.Uri("\"https://www.example.com/\""),
                 Location.none,
               ),
             ],
             Location.none,
           ...
           block:
             ...
             Brace_block.Stylesheet(
               [
                 Rule.Style_rule({
                   Style_rule.prelude: (
                     [(Component_value.Ident("h1"), Location.none)],
                     Location.none,
                   ),
                   block: (
                     [
                       Declaration_list.Declaration({
                         Declaration.name: ("color", Location.none),
                         value: (
                           [(Component_value.Ident("green"), Location.none)],
                           Location.none,
                         ),
                         important: (false, Location.none),
                         loc: Location.none,
             ...
             Brace_block.Declaration_list(
               [
                 Declaration_list.Declaration({
                   ...
                   value: (
                     [(Component_value.String("Open Sans"), Location.none)],
                     Location.none,
                   ),
                   important: (false, Location.none),
                   loc: Location.none,
                     ...
                     [
                       ...
                       (
                         ...
                         Component_value.Function(
                           ...
                           (
                             [(Component_value.String("woff2"), Location.none)],
                             Location.none,
                           ),
                         ),
                         Location.none,
                       ...
                       (
                         ...
                         Component_value.Function(
                           ("format", Location.none),
                           (
                             [(Component_value.String("woff"), Location.none)],
                             Location.none,
                           ),
                         ),
                         Location.none,
           ...
           block:
             ...
             Brace_block.Stylesheet(
               [
                 Rule.Style_rule({
                   Style_rule.prelude: (
                     [(Component_value.Ident("from"), Location.none)],
                     Location.none,
                   ),
                   block: (
                     [
                       Declaration_list.Declaration({
                         ...
                         value: (
                           [
                             (Component_value.Percentage("100"), Location.none),
                           ],
                           Location.none,
                         ),
                         important: (false, Location.none),
                       ...
                       Declaration_list.Declaration({
                         ...
                         value: (
                           [
                             (Component_value.Percentage("300"), Location.none),
                           ],
                           Location.none,
                         ),
                         important: (false, Location.none),
                 ...
                 Rule.Style_rule({
                   Style_rule.prelude: (
                     [(Component_value.Ident("to"), Location.none)],
                     Location.none,
                   ),
                   block: (
                     [
                       Declaration_list.Declaration({
                         Declaration.name: ("margin-left", Location.none),
                         value: (
                           [(Component_value.Percentage("0"), Location.none)],
                           Location.none,
                         ),
                         important: (false, Location.none),
                         loc: Location.none,
             ...
             Brace_block.Declaration_list(
               [
                 Declaration_list.Declaration({
                   Declaration.name: ("width", Location.none),
                   value: (
                     [(Component_value.Ident("device-width"), Location.none)],
                     Location.none,
                   ),
                   important: (false, Location.none),
                   loc: Location.none,
     ...
     let expected_ast = (
       [
         Rule.At_rule({
           ...
           prelude: (
             [(Component_value.Ident("thumbs"), Location.none)],
             Location.none,
           ),
           block:
             [@implicit_arity]
             Brace_block.Declaration_list(
               [
                 Declaration_list.Declaration({
                   ...
                   value: (
                     [(Component_value.Ident("cyclic"), Location.none)],
                     Location.none,
                   ),
                   important: (false, Location.none),
                   loc: Location.none,
                 ...
                 Declaration_list.Declaration({
                   ...
                   value: (
                     [(Component_value.String("\\1F44D"), Location.none)],
                     Location.none,
                   ),
                   important: (false, Location.none),
                   loc: Location.none,
                 ...
                 Declaration_list.Declaration({
                   ...
                   value: (
                     [(Component_value.String(" "), Location.none)],
                     Location.none,
                   ),
                   important: (false, Location.none),
                   loc: Location.none,
                     ...
                     Brace_block.Declaration_list(
                       [
                         Declaration_list.Declaration({
                           ...
                           value: (
                             [(Component_value.Number("12"), Location.none)],
                             Location.none,
                           ),
                           important: (false, Location.none),
                           loc: Location.none,
